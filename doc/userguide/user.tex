...
\end{verbatim}
(or the equivalent for whatever shell you are using; \texttt{setenv} is
used in \texttt{tcsh} and \texttt{csh}.)  Then to run an MPI program,
albeit only on one machine, you can do:
\begin{verbatim}
    mpd &
...
called MPD.  MPD provides a number of extensions to the Standard.
