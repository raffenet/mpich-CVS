...
This describes the format of key=value elements in a stream.

stream := element frame_char | element separ_char stream

element := key delim_char value
...
quoted := quote_char array of escaped characters quote_char

chars := ascii characters

escapted chars := ascii characters with escape_char quote_char and escape_char escape_char
