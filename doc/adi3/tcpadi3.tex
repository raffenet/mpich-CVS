...
{
    CH3_Progress_poke
    request = MPID_CH3U_Request_FPOAU( source, tag, context_id, &found )
    if (found)  {
...
\begin{verbatim}
    request = MPID_CH3U_Request_FPOAU( &packet->msg_match, &found )
    if (found) {
...
\begin{verbatim}
MPID_CH3U_Request_FPOAU( int source, int tag, int context_id, int *found )
...
\code{MPID_CH3U_Request_FPOAU}, except that it checks first in the posted
...
\begin{verbatim}
MPID_CH3U_Request_FUOAP( MPID_Message_match *, int *found )
...
\begin{verbatim}
MPID_CH3U_DeQueue_unexp( int handle )
...
\begin{verbatim}
MPID_CH3U_DeQueue_posted( int handle )
