...
%\usepackage{/usr/local/sowing-1.1.6/share/refman}
%\usepackage{/usr/local/src/sowing-1.1.6/docs/doctext/tpage}
%\usepackage{refman}
%\usepackage{tpage}
\usepackage{code}
\usepackage{url} 
...
same as the size of the occupying the buffer).  The SRBuf flag in the
...
\section{Pseudo-code for some of the \protect\code{MPID\_} routines}
...
\section{Implementing \protect\code{mpiexec}}
\label{sec:mpiexec}
