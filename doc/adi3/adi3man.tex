...
The core of MPID consists of the following routines:
...
\item[MPID Rhcv]This is used for messages; it is roughly an
...
definition of the store and forward ``building block'' routines.
...
Dynamic processes.  What is the ADI interface?  What relationship does it
