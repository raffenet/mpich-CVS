...
\item[\code{MPID_Flags_waitsome}, \code{MPID_Flags_testsome}]These are used to
  complete \code{MPID_Rhcv} 
...
\item[\code{MPID_Comm_Spawn_Multiple}]Spawns new processes.  An implementation
