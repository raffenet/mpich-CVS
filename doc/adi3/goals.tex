...
the necessary progress.  However, to illustrate the advantages of this
approach, consider a different version where there are two sockets
...
are (will be) provided in the ADI-3 reference manual.
