...
\newenvironment{tcp}{\begin{quote}\textbf{Twosided:}\\}{\end{quote}}
\newenvironment{shmem}{\begin{quote}\textbf{SharedMem:}\\}{\end{quote}}
\newenvironment{via}{\begin{quote}\textbf{RemoteMem:}\\}{\end{quote}}
