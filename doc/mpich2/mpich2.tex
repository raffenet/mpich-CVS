...
because that could (if \code{MPI_Aint} is longer than \code{int}) making a
copy of an array argument.
...
The buffered send should first use \mpidfunc{MPID_tBsend} to attempt
...
Deprectated.  Call \mpifunc{MPI_COMM_SET_ERRHANDLER}.
