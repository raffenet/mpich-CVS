...
\item In the heterogeneous case, we may want two different
    ...
    most communicators may use reader-makes-right (RMR) \cite{rmr?}
...
(temporary figure)
  ...
  ack  ------------>
\end{verbatim}
\caption{Two sendrecv scenarios}
\end{figure}
...
need an \mpidfunc{MPID_Startall}.
...
that indicates whether a copy is necessary or not.
