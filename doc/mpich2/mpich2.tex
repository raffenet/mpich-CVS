...
\code{MPID_Object_add_ref} etc.) instead of lock/unlock.  
...
\code{MPID_Object_add_ref} or \code{MPID_Object_release_ref}). 
...
This first calls \mpidfunc{MPID_Object_release_ref}.  If
...
\subsubsection{\mpifunc{MPI_COMM_GROUP}}
  ...
  \mpidfunc{MPID_Object_add_ref} to do this. 
