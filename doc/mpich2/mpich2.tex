...
The first executable statement starts the timer (and in general,
  ...
  The simplify instrumentation of the code, the macro
...
\code{destory}.  The names \code{new} and \code{delete} are used by
...
programs won't include common symbols as defining the use of a name(!)
...
\cfgoption{--enable-msgtrack}.  The values may be
\begin{description}
\item[n]The size of the buffer (e.g., \code{--enable-msgtrack=100}).
\end{description}
