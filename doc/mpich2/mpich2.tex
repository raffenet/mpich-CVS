...
\item Check that the \mpids{MPI_Datatype}{lrank_to_lpid} arrays
...
mpich/src/util/bsendutil2.c in MPICH-1.  Note that while the buffer is
...
\mpiconst{MPI_Op} needs to have reference counts.  How do we handle the
predefined types?  
...
(Who applies the displacement unit?)
