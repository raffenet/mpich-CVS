...
% %
% % Algorithm
% \newenvironment{algorithm}{\begingroup\obeylines\obeyspaces\makeuscore\noindent\makespaceactive}{\endgroup}
...
assumption.  Note from Bill: Under Linux, \code{long double} is 12 bytes.
...
thread for all window objects that allow locks\index{thread overhead!passive
  RMA}. 
