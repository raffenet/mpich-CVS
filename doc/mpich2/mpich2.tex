...
\subsubsection{\mpifunc{MPI_WIN_LOCK}}
...
\subsubsection{\mpifunc{MPI_WIN_UNLOCK}}
...
\code{MPI_ERRHANDLER_FREE}\\
\code{MPI_ERRHANDLER_GET}\\
\code{MPI_ERRHANDLER_SET}\\
