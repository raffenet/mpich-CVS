...
\begin{description}
\item[\code{MPI_Comm}]     (0000) \mpidconst{MPID_COMM}
\item[\code{MPI_Group}]    (0001) \mpidconst{MPID_GROUP}
\item[\code{MPI_Datatype}] (0010) \mpidconst{MPID_DATATYPE}
\item[\code{MPI_File}]     (0011) \mpidconst{MPID_FILE}
\item[\code{MPI_Errhandler}](0100) \mpidconst{MPID_ERRHANDLER}
\item[\code{MPI_Op}]       (0101) \mpidconst{MPID_OP}
\item[\code{MPI_Info}]     (0110) \mpidconst{MPID_INFO}
\item[\code{MPI_Win}]      (0111) \mpidconst{MPID_WIN}
\item[keyval]              (1000) \mpidconst{MPID_KEYVAL}
\end{description}
