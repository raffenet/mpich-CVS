...
\begin{cmt}
  The \code{method::poll} function needs provide to some indication of whether
...
\begin{cmt}
  I had been assuming that the \code{method::poll} function would return an
...
function would insur that the method did not attempt to post unexpected
