...
messages.  In MPICH a status object has the type \code{MPI_Status}.  Unlike
most of the other MPI objects, \code{MPI_Status} is not a handle, and elements
...
above stated requirements.  The first function, \code{method::get_description},
