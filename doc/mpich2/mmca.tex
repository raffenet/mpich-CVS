...
A \emph{communication method} is a means for passing messages between two
...
the number of MPI requests that were completed during the call to \code{poll}.
...
progress engine to provide feedback to calling routines such as \code{MPI_TEST}
and \code{MPI_WAIT}.  This feedback about the number of requests serviced
