...
%
% CARs (and operation and data descriptors) - abstract entity to describe ops
%
...
% [BRT] Ideally, the general architecture of the multi-method implementation
% would have been presented in an earlier section.  This would allow this
% section to focus on present the first order details concerning communication
% requests, methods, polling, etc.

% [BRT] It seems that this section would flow better if concepts were briefly
% introduced top-down and the described bottom-up...

% [BRT] We should include the network devices and network software interfaces
% in this picture.
...
% schedules CPU resources across methods, optimizing tuning on-the-fly
