...
\begin{verbatim}
    cd  /tmp/you/mpich2-1.0.3
    /home/you/libraries/mpich2-1.0.3/configure \
...
\texttt{mpich2-1.0.3/src/pm/mpd/README}.
...
% the directory \texttt{mpich2-1.0.3/examples}.  
...
\texttt{mpich2-1.0.3/examples} directory.  If the current directory is the top
...
\item[--enable-sharedlibs]Build MPICH2 with shared libraries. You must
  select an Operating System and Compiler combination.  For example, 
  \texttt{--enable-sharedlibs=osx-gcc} or
  \texttt{--enable-sharedlibs=linux-gcc}.  
...
the environment variable MPICH\_PORT\_RANGE (note MPICH instead of MPD)
...
\texttt{mpd}.  This is done through a Unix socket in /tmp rather than
