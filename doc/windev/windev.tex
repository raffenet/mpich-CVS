...
\begin{enumerate}
	...
	\item Launch jumpshot using the java command. 
		(eg: \begin{verbatim} java -jar "c:\Program Files\MPICH2\bin\jumpshot.jar" \end{verbatim})
...
\item Log the events of the logged states: \texttt{MPE\_Log\_event} are called twice
