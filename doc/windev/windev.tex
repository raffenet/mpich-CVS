...
\texttt{MPE\_Init\_log} and \texttt{MPE\_Finish\_log} must be used before and after all
...
share/examples\_logging. For futher information on linking, see the section ``Convenient Compiler Wrappers.''
