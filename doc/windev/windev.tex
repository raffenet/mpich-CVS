...
create the .h file from the .h.in file.  Simply copy an existing section in winconfigure.wsf
and rename the file names.

New .h.in files are not added frequently but what does happen more frequently is the macros
defined in those files are changed.  These definitions, usually in the form HAVE\_FOO or USE\_FOO,
need to be added to the AddDefinitions function in winconfigure.wsf.  Simply add new cases to the
big case statement as needed.  winconfigure.wsf warns you of definitions that are not in the case
statement.
