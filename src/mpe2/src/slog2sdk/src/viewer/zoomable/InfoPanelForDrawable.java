...
public class InfoPanelForDrawable extends JPanel
{
                                 ...
                                 final Drawable  dobj )
    {
        ...
        if (    drawable instanceof Shadow 
            ...
            label_type = new CategoryLabel( drawable.getCategory() );
            top_panel.add( STRUT );
            top_panel.add( label_type );
            top_panel.add( GLUE );
        ...
        if ( drawable instanceof Shadow )
            textbuf.setShadowText( (Shadow) drawable );
    ...
    private class TextAreaBuffer
    {
        ...
        public void setShadowText( final Shadow    shade )
        {
            ...
            int               idx;
            int               print_status;
            if ( shade.getCategory().getTopology().isState() ) {
            ...
            else { // if ( shade.getCategory().getTopology().isArrow() )
                strbuf.append( "\n*** Inclusive Duration Ratios:" );
                print_status = CategoryWeight.PRINT_INCL_RATIO;
            }
