...
#define MPID_CONTEXT_OFFSET_INTRA_PT2PT 0
#define MPID_CONTEXT_OFFSET_INTRA_COLL  1
#define MPID_CONTEXT_OFFSET_INTRA_FILE  2
#define MPID_CONTEXT_OFFSET_INTRA_WIN   3
#define MPID_CONTEXT_OFFSET_INTER_PT2PT 0
#define MPID_CONTEXT_OFFSET_INTER_COLLA 1
#define MPID_CONTEXT_OFFSET_INTER_COLLB 2
#define MPID_CONTEXT_OFFSET_INTER_COLL  3
