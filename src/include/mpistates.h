/* This file maps each MPI function name to a state def value for
   ...
   numbers.
*/
#define MPID_STATE_MPI_SEND 0
#define MPID_STATE_MPI_RECV 0
#define MPID_STATE_MPI_GET_COUNT 0
#define MPID_STATE_MPI_BSEND 0
#define MPID_STATE_MPI_SSEND 0
#define MPID_STATE_MPI_RSEND 0
#define MPID_STATE_MPI_BUFFER_ATTACH 0
#define MPID_STATE_MPI_BUFFER_DETACH 0
#define MPID_STATE_MPI_ISEND 0
#define MPID_STATE_MPI_IBSEND 0
#define MPID_STATE_MPI_ISSEND 0
#define MPID_STATE_MPI_IRSEND 0
#define MPID_STATE_MPI_IRECV 0
#define MPID_STATE_MPI_WAIT 0
#define MPID_STATE_MPI_TEST 0
#define MPID_STATE_MPI_REQUEST_FREE 0
#define MPID_STATE_MPI_WAITANY 0
#define MPID_STATE_MPI_TESTANY 0
#define MPID_STATE_MPI_WAITALL 0
#define MPID_STATE_MPI_TESTALL 0
#define MPID_STATE_MPI_WAITSOME 0
#define MPID_STATE_MPI_TESTSOME 0
#define MPID_STATE_MPI_IPROBE 0
#define MPID_STATE_MPI_PROBE 0
#define MPID_STATE_MPI_CANCEL 0
#define MPID_STATE_MPI_TEST_CANCELLED 0
#define MPID_STATE_MPI_SEND_INIT 0
#define MPID_STATE_MPI_BSEND_INIT 0
#define MPID_STATE_MPI_SSEND_INIT 0
#define MPID_STATE_MPI_RSEND_INIT 0
#define MPID_STATE_MPI_RECV_INIT 0
#define MPID_STATE_MPI_START 0
#define MPID_STATE_MPI_STARTALL 0
#define MPID_STATE_MPI_SENDRECV 0
#define MPID_STATE_MPI_SENDRECV_REPLACE 0
