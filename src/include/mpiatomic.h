...
/* XXX DJG TODO uncomment the following line and replace nemesis queues with this queue iface
...
/* The current implementation stores N elements of data in buf in the
   ...
   (addresses increase numerically from top to bottom)
...
#if defined(ATOMIC_FETCH_AND_INCR_IS_EMULATED)
#  warning fetch_and_incr is emulated on this platform
#endif
