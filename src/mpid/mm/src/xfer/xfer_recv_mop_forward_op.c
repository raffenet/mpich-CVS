...
{
    MPID_STATE_DECL(MPID_STATE_XFER_RECV_MOP_FORWARD_OP);
    MPID_FUNC_ENTER(MPID_STATE_XFER_RECV_MOP_FORWARD_OP);
    MPID_FUNC_EXIT(MPID_STATE_XFER_RECV_MOP_FORWARD_OP);
    return MPI_SUCCESS;
}
