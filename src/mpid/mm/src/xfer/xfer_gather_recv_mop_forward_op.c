...
#undef FUNCNAME
#define FUNCNAME xfer_gather_recv_mop_forward_op
...
{
    static const char FCNAME[] = "xfer_gather_recv_mop_forward_op";

    MPID_MPI_FUNC_ENTER(MPID_STATE_XFER_GATHER_RECV_MOP_FORWARD_OP);

    MPID_MPI_FUNC_EXIT(MPID_STATE_XFER_GATHER_RECV_MOP_FORWARD_OP);
    return MPI_SUCCESS;
}
