...
\section{MPI_Send}
This is what happens when MPI_Send is called.
\begin{verbatim}
MPI_Send
MPID_Send
MPID_Isend
...
\section{MPID_Progress_wait - MPI_Send}
...
\section{Completion queue - MPI_Send}
...
\section{MPI_Recv}
This is what happens when MPI_Recv is called.
\begin{verbatim}
MPI_Recv
MPID_Recv
MPID_Irecv
...
\section{MPID_Progress_wait - MPI_Recv}
