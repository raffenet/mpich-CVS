...
#if !defined(MPID_DEV_TYPE_INDEXED_HOOK)
#define MPID_DEV_TYPE_INDEXED_HOOK(a, b, c, d, e, f, mpi_errno_p_)      \
{                                                                       \
		      ...
		      MPI_Datatype *newtype)
{
    ...
    MPID_DEV_TYPE_INDEXED_HOOK(count, blocklength_array, displacement_array,
