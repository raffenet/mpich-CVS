...
{ \
    ...
    shm_post_read(vc->shm.shm, &vc->shm.req->shm.pkt, sizeof(MPIDI_CH3_Pkt_t), NULL); \
...
static inline void handle_written(MPIDI_VC * vc)
{
	...
	*/
	...
	nb = shm_writev(vc->shm.shm, req->ch3.iov + req->shm.iov_offset, req->ch3.iov_count - req->shm.iov_offset);
