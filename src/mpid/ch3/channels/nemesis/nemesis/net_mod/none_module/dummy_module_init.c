...
int
dummy_module_get_business_card (char **bc_val_p, int *val_max_sz_p)
{
    return 0;
}

int
dummy_module_connect_to_root (const char *business_card, const int lpid)
{
    return 0;
}

int
dummy_module_vc_init (MPIDI_VC_t *vc)
{
    return 0;
}
