...
int  MPID_nem_gm_module_init (MPID_nem_queue_ptr_t proc_recv_queue, 
...
void MPID_nem_gm_module_poll(MPID_nem_poll_dir_t in_or_out);
void MPID_nem_gm_module_send (MPIDI_VC_t *vc, MPID_nem_cell_ptr_t cell, int datalen);
int  MPID_nem_gm_module_get_business_card (char **bc_val_p, int *val_max_sz_p);
int  MPID_nem_gm_module_connect_to_root (const char *business_card, const int lpid);
