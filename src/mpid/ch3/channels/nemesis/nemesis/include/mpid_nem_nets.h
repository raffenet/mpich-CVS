...
extern int  (* MPID_nem_net_module_init) (MPID_nem_queue_ptr_t,
...
extern void (* MPID_nem_net_module_poll) (int);
extern void (* MPID_nem_net_module_send) (int, MPID_nem_cell_ptr_t , int);
