...
typedef enum mpig_cm_xio_vc_states
{
    ...
    MPIG_CM_XIO_VC_STATE_UNCONNECTED = (MPIG_CM_XIO_VC_STATE_CLASS_UNCONNECTED << MPIG_CM_XIO_VC_STATE_CLASS_SHIFT),
    ...
    /* states for connecting temporary VC */
    ...
    /* states for accepting temporary VC */
    ...
    MPIG_CM_XIO_VC_STATE_CONNECTED_SENT_CLOSE_REQ,
    ...
    MPIG_CM_XIO_VC_STATE_DISCONNECTING_SENDING_ACK,
    MPIG_CM_XIO_VC_STATE_DISCONNECTING_RECEIVING_ACK,
