...
#define MPIG_VMPI_REQUEST_NULL (((const mpig_vmpi_request_t * const) &mpig_vmpi_request_null)
...
extern void * mpig_vmpi_in_place;
#define MPIG_VMPI_IN_PLACE ((void * const) mpig_vmpi_in_place)
...
#define MPIG_VMPI_STATUS_IGNORE ((mpig_vmpi_status_t * const) mpig_vmpi_status_ignore)
extern mpig_vmpi_status_t * mpig_vmpi_statuses_ignore;
#define MPIG_VMPI_STATUSES_IGNORE ((mpig_vmpi_status_t * const) mpig_vmpi_statuses_ignore)
...
#define MPIG_VMPI_COMM_NULL ((const mpig_vmpi_comm_t * const) &mpig_vmpi_comm_null)
extern mpig_vmpi_comm_t mpig_vmpi_comm_world;
#define MPIG_VMPI_COMM_WORLD ((const mpig_vmpi_comm_t * const) &mpig_vmpi_comm_world)
extern mpig_vmpi_comm_t mpig_vmpi_comm_self;
#define MPIG_VMPI_COMM_SELF ((const mpig_vmpi_comm_t * const) &mpig_vmpi_comm_self)

/* predefined datatypes */
#define MPIG_VMPI_DATATYPE_INITIALIZER {{0}};
extern mpig_vmpi_datatype_t mpig_vmpi_dt_null;
#define MPIG_VMPI_DATATYPE_NULL ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_null)
/* c basic datatypes */
extern mpig_vmpi_datatype_t mpig_vmpi_dt_byte;
#define MPIG_VMPI_BYTE ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_byte)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_char;
#define MPIG_VMPI_CHAR ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_char)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_signed_char;
#define MPIG_VMPI_SIGNED_CHAR ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_signed_char)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_unsigned_char;
#define MPIG_VMPI_UNSIGNED_CHAR ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_unsigned_char)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_wchar;
#define MPIG_VMPI_WCHAR ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_wchar)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_short;
#define MPIG_VMPI_SHORT ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_short)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_unsigned_short;
#define MPIG_VMPI_UNSIGNED_SHORT ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_unsigned_short)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_int;
#define MPIG_VMPI_INT ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_int)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_unsigned;
#define MPIG_VMPI_UNSIGNED ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_unsigned)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_long;
#define MPIG_VMPI_LONG ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_long)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_unsigned_long;
#define MPIG_VMPI_UNSIGNED_LONG ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_unsigned_long)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_long_long;
#define MPIG_VMPI_LONG_LONG ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_long_long)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_long_long_int;
#define MPIG_VMPI_LONG_LONG_INT ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_long_long_int)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_unsigned_long_long;
#define MPIG_VMPI_UNSIGNED_LONG_LONG ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_unsigned_long_long)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_float;
#define MPIG_VMPI_FLOAT ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_float)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_double;
#define MPIG_VMPI_DOUBLE ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_double)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_long_double;
#define MPIG_VMPI_LONG_DOUBLE ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_long_double)
...
#define MPIG_VMPI_SHORT_INT ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_short_int)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_2int;
#define MPIG_VMPI_2INT ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_2int)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_long_int;
#define MPIG_VMPI_LONG_INT ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_long_int)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_float_int;
#define MPIG_VMPI_FLOAT_INT ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_float_int)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_double_int;
#define MPIG_VMPI_DOUBLE_INT ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_double_int)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_long_double_int;
#define MPIG_VMPI_LONG_DOUBLE_INT ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_long_double_int)
/* fortran basic datatypes */
extern mpig_vmpi_datatype_t mpig_vmpi_dt_logical;
#define MPIG_VMPI_LOGICAL ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_logical)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_character;
#define MPIG_VMPI_CHARACTER ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_character)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_integer;
#define MPIG_VMPI_INTEGER ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_integer)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_real;
#define MPIG_VMPI_REAL ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_real)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_double_precision;
#define MPIG_VMPI_DOUBLE_PRECISION ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_double_precision)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_complex;
#define MPIG_VMPI_COMPLEX ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_complex)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_double_complex;
#define MPIG_VMPI_DOUBLE_COMPLEX ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_double_complex)
...
#define MPIG_VMPI_2INTEGER ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_2integer)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_2complex;
#define MPIG_VMPI_2COMPLEX ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_2complex)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_2real;
#define MPIG_VMPI_2REAL ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_2real)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_2double_complex;
#define MPIG_VMPI_2DOUBLE_COMPLEX ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_2double_complex)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_2double_precision;
#define MPIG_VMPI_2DOUBLE_PRECISION ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_2double_precision)
/* fortran size specific datatypes */
extern mpig_vmpi_datatype_t mpig_vmpi_dt_integer1;
#define MPIG_VMPI_INTEGER1 ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_integer1)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_integer2;
#define MPIG_VMPI_INTEGER2 ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_integer2)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_integer4;
#define MPIG_VMPI_INTEGER4 ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_integer4)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_integer8;
#define MPIG_VMPI_INTEGER8 ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_integer8)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_integer16;
#define MPIG_VMPI_INTEGER16 ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_integer16)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_real4;
#define MPIG_VMPI_REAL4 ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_real4)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_real8;
#define MPIG_VMPI_REAL8 ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_real8)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_real16;
#define MPIG_VMPI_REAL16 ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_real16)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_complex8;
#define MPIG_VMPI_COMPLEX8 ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_complex8)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_complex16;
#define MPIG_VMPI_COMPLEX16 ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_complex16)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_complex32;
#define MPIG_VMPI_COMPLEX32 ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_complex32)
/* type representing a packed user buffer */
extern mpig_vmpi_datatype_t mpig_vmpi_dt_packed;
#define MPIG_VMPI_PACKED ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_packed)
/* pseudo datatypes used to manipulate the extent */
extern mpig_vmpi_datatype_t mpig_vmpi_dt_lb;
#define MPIG_VMPI_LB ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_lb)
extern mpig_vmpi_datatype_t mpig_vmpi_dt_ub;
#define MPIG_VMPI_UB ((const mpig_vmpi_datatype_t * const) &mpig_vmpi_dt_ub)

/* collective operations (for MPI_Reduce, etc.) */
#define MPIG_VMPI_OP_INITIALIZER {{0}};
extern mpig_vmpi_op_t mpig_vmpi_op_null;
#define MPIG_VMPI_OP_NULL ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_null)
extern mpig_vmpi_op_t mpig_vmpi_op_max;
#define MPIG_VMPI_MAX ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_max)
extern mpig_vmpi_op_t mpig_vmpi_op_min;
#define MPIG_VMPI_MIN ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_min)
extern mpig_vmpi_op_t mpig_vmpi_op_sum;
#define MPIG_VMPI_SUM ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_sum)
extern mpig_vmpi_op_t mpig_vmpi_op_prod;
#define MPIG_VMPI_PROD ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_prod)
extern mpig_vmpi_op_t mpig_vmpi_op_land;
#define MPIG_VMPI_LAND ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_land)
extern mpig_vmpi_op_t mpig_vmpi_op_band;
#define MPIG_VMPI_BAND ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_band)
extern mpig_vmpi_op_t mpig_vmpi_op_lor;
#define MPIG_VMPI_LOR ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_lor)
extern mpig_vmpi_op_t mpig_vmpi_op_bor;
#define MPIG_VMPI_BOR ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_bor)
extern mpig_vmpi_op_t mpig_vmpi_op_lxor;
#define MPIG_VMPI_LXOR ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_lxor)
extern mpig_vmpi_op_t mpig_vmpi_op_bxor;
#define MPIG_VMPI_BXOR ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_bxor)
extern mpig_vmpi_op_t mpig_vmpi_op_minloc;
#define MPIG_VMPI_MINLOC ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_minloc)
extern mpig_vmpi_op_t mpig_vmpi_op_maxloc;
#define MPIG_VMPI_MAXLOC ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_maxloc)
extern mpig_vmpi_op_t mpig_vmpi_op_replace;
#define MPIG_VMPI_REPLACE ((const mpig_vmpi_op_t * const) &mpig_vmpi_op_replace)

/* error classes */
#define MPIG_VMPI_SUCCESS ((const int) 0)  /* the MPI standard defines MPI_SUCCESS to always be zero */
...
int mpig_vmpi_abort(const mpig_vmpi_comm_t * comm, int exit_code);
