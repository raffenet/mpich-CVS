    ...
    MPI_Datatype *type )
{
    ...
    case MPI_COMPLEX: {
        ...
        for ( i=0; i<len; i++ ) {
            ...
            a[i].re = c.re* restrict b[i].re - c.im* restrict b[i].im;
            a[i].im = c.im* restrict b[i].re + c.re* restrict b[i].im;
        }
        break;
    }
    ...
    default:
        ...
        printf("MPI_PROD operation not supported for this datatype\n");
