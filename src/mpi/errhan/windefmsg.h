...
static const char short_gen338[] = "**sock_nop_accept";
static const char long_gen338[]  = "accept called without having received an op_accept";
static const char short_gen339[] = "**sock_post_close";
static const char long_gen339[]  = "posting a close of the socket failed";
static const char short_gen340[] = "**socket";
static const char long_gen340[]  = "WSASocket failed";
static const char short_gen341[] = "**sock|badbuf";
static const char long_gen341[]  = "the supplied buffer contains invalid memory";
static const char short_gen342[] = "**sock|badhandle";
static const char long_gen342[]  = "sock contains an invalid handle";
static const char short_gen343[] = "**sock|badhdbuf";
static const char long_gen343[]  = "a memory fault occurred while accessing the host description string";
static const char short_gen344[] = "**sock|badhdlen";
static const char long_gen344[]  = "host description string to small to store description";
static const char short_gen345[] = "**sock|badhdmax";
static const char long_gen345[]  = "the length of the host description string must be non-negative";
static const char short_gen346[] = "**sock|badiovn";
static const char long_gen346[]  = "size of iov is invalid";
static const char short_gen347[] = "**sock|badlen";
static const char long_gen347[]  = "bad length parameter(s)";
static const char short_gen348[] = "**sock|badport";
static const char long_gen348[]  = "port number is out of range";
static const char short_gen349[] = "**sock|badsock";
static const char long_gen349[]  = "supplied sock is corrupt";
static const char short_gen350[] = "**sock|closed";
static const char long_gen350[]  = "sock has been closed locally";
static const char short_gen351[] = "**sock|closing";
static const char long_gen351[]  = "sock is in the process of being closed locally";
static const char short_gen352[] = "**sock|connclosed";
static const char long_gen352[]  = "connection closed by peer";
static const char short_gen353[] = "**sock|connfailed";
static const char long_gen353[]  = "connection failure";
static const char short_gen354[] = "**sock|connrefused";
static const char long_gen354[]  = "connection refused";
static const char short_gen355[] = "**sock|getport";
static const char long_gen355[]  = "failed to obtain port number of the listener";
static const char short_gen356[] = "**sock|hostres";
static const char long_gen356[]  = "unable to resolve host name to an address";
static const char short_gen357[] = "**sock|nosock";
static const char long_gen357[]  = "no new sock was available to accept";
static const char short_gen358[] = "**sock|notconnected";
static const char long_gen358[]  = "sock is not connected";
static const char short_gen359[] = "**sock|oserror";
static const char long_gen359[]  = "unknown operating system error";
static const char short_gen360[] = "**sock|osnomem";
static const char long_gen360[]  = "operating system routine failed due to lack of memory";
static const char short_gen361[] = "**sock|poll|accept";
static const char long_gen361[]  = "accept failed to acquire a new socket";
static const char short_gen362[] = "**sock|poll|bind";
static const char long_gen362[]  = "unable to bind socket to port";
static const char short_gen363[] = "**sock|poll|eqfail";
static const char long_gen363[]  = "fatal error: failed to enqueue an event; event was lost";
static const char short_gen364[] = "**sock|poll|eqmalloc";
static const char long_gen364[]  = "MPIU_Malloc failed to allocate memory for an event queue structure";
static const char short_gen365[] = "**sock|poll|listen";
static const char long_gen365[]  = "listen() failed";
static const char short_gen366[] = "**sock|poll|nodelay";
static const char long_gen366[]  = "unable to set TCP no delay attribute on socket";
static const char short_gen367[] = "**sock|poll|nonblock";
static const char long_gen367[]  = "unable to set socket to nonblocking";
static const char short_gen368[] = "**sock|poll|pipe";
static const char long_gen368[]  = "unable to allocate pipe to wakeup a blocking poll()";
static const char short_gen369[] = "**sock|poll|pipenonblock";
static const char long_gen369[]  = "unable to set wakeup pipe to nonblocking";
static const char short_gen370[] = "**sock|poll|reuseaddr";
static const char long_gen370[]  = "unable to set reuseaddr attribute on socket";
static const char short_gen371[] = "**sock|poll|socket";
static const char long_gen371[]  = "unable to obtain new socket";
static const char short_gen372[] = "**sock|poll|unhandledstate";
static const char long_gen372[]  = "encountered an unhandled";
static const char short_gen373[] = "**sock|reads";
static const char long_gen373[]  = "attempt to perform multiple simultaneous reads";
static const char short_gen374[] = "**sock|setalloc";
static const char long_gen374[]  = "unable to allocate a new sock set object";
static const char short_gen375[] = "**sock|sockalloc";
static const char long_gen375[]  = "unable to allocate a new sock object";
static const char short_gen376[] = "**sock|uninit";
static const char long_gen376[]  = "Sock library has not been initialized";
static const char short_gen377[] = "**sock|writes";
static const char long_gen377[]  = "attempt to perform multiple simultaneous writes";
static const char short_gen378[] = "**spawn";
static const char long_gen378[]  = "Error in spawn call";
static const char short_gen379[] = "**ssmwrite";
static const char long_gen379[]  = "sock/shared memory write failed";
static const char short_gen380[] = "**ssmwritev";
static const char long_gen380[]  = "sock/shared memory writev failed";
static const char short_gen381[] = "**stride";
static const char long_gen381[]  = "Range does not terminate";
static const char short_gen382[] = "**stridezero";
static const char long_gen382[]  = "Zero stride is invalid";
static const char short_gen383[] = "**strncpy";
static const char long_gen383[]  = "insufficient buffer length to complete strncpy";
static const char short_gen384[] = "**success";
static const char long_gen384[]  = "No MPI error";
static const char short_gen385[] = "**tag";
static const char long_gen385[]  = "Invalid tag";
static const char short_gen386[] = "**test_sock_wait";
static const char long_gen386[]  = "sock_wait failed";
static const char short_gen387[] = "**toomanycomm";
static const char long_gen387[]  = "Too many communicators";
static const char short_gen388[] = "**topology";
static const char long_gen388[]  = "Invalid topology";
static const char short_gen389[] = "**topotoolarge";
static const char long_gen389[]  = "Topology size is greater than communicator size";
static const char short_gen390[] = "**truncate";
static const char long_gen390[]  = "Message truncated";
static const char short_gen391[] = "**typenamelen";
static const char long_gen391[]  = " Specified datatype name is too long";
static const char short_gen392[] = "**unknown";
static const char long_gen392[]  = "Unknown error.  Please file a bug report.";
static const char short_gen393[] = "**unsupporteddatarep";
static const char long_gen393[]  = "Only native data representation currently supported";
static const char short_gen394[] = "**vc_state";
static const char long_gen394[]  = "invalid vc state";
static const char short_gen395[] = "**win";
static const char long_gen395[]  = "Invalid MPI_Win";
static const char short_gen396[] = "**winwait";
static const char long_gen396[]  = "WaitForSingleObject failed";
static const char short_gen397[] = "**write_progress";
static const char long_gen397[]  = "Write progress failed";
static const char short_gen398[] = "**wsasock";
static const char long_gen398[]  = "WSAStartup failed";

static const int generic_msgs_len = 399;
...
static const char short_spc128[] = "**shmq_index %d %d";
static const char long_spc128[]  = "invalid shm queue index (%d > %d)";
static const char short_spc129[] = "**snprintf %d";
static const char long_spc129[]  = "snprintf returned %d";
static const char short_spc130[] = "**sock_byname %d";
static const char long_spc130[]  = "gethostbyname failed (errno %d)";
static const char short_spc131[] = "**sock_connect %d";
static const char long_spc131[]  = "connect failed (errno %d)";
static const char short_spc132[] = "**sock_create %d";
static const char long_spc132[]  = "unable to create a socket (errno %d)";
static const char short_spc133[] = "**sock_gethost %d";
static const char long_spc133[]  = "gethostname failed (errno %d)";
static const char short_spc134[] = "**socket %d";
static const char long_spc134[]  = "WSASocket failed (errno %d)";
static const char short_spc135[] = "**sock|badbuf %d %d";
static const char long_spc135[]  = "the supplied buffer contains invalid memory (set=%d,sock=%d)";
static const char short_spc136[] = "**sock|badiovn %d %d %d";
static const char long_spc136[]  = "size of iov is invalid (set=%d,sock=%d,iov_n=%d)";
static const char short_spc137[] = "**sock|badlen %d %d %d %d";
static const char long_spc137[]  = "bad length parameter(s) (set=%d,sock=%d,min=%d,max=%d)";
static const char short_spc138[] = "**sock|badport %d";
static const char long_spc138[]  = "port number is out of range (sock=%d)";
static const char short_spc139[] = "**sock|closing %d %d";
static const char long_spc139[]  = "sock is in the process of being closed locally (set=%d,sock=%d)";
static const char short_spc140[] = "**sock|connclosed %d %d";
static const char long_spc140[]  = "connection closed by peer (set=%d,sock=%d)";
static const char short_spc141[] = "**sock|connfailed %d %d";
static const char long_spc141[]  = "connection failure (set=%d,sock=%d)";
static const char short_spc142[] = "**sock|notconnected %d %d";
static const char long_spc142[]  = "sock is not connected (set=%d,sock=%d)";
static const char short_spc143[] = "**sock|osnomem %d %d";
static const char long_spc143[]  = "operating system routine failed due to lack of memory (set=%d,sock=%d)";
static const char short_spc144[] = "**sock|poll|accept %d";
static const char long_spc144[]  = "accept failed to acquire a new socket (errno=%d)";
static const char short_spc145[] = "**sock|poll|badhandle %d %d %d";
static const char long_spc145[]  = "sock contains an invalid handle (set=%d,sock=%d,fd=%d)";
static const char short_spc146[] = "**sock|poll|bind %d %d";
static const char long_spc146[]  = "unable to bind socket to port (port=%d,errno=%d)";
static const char short_spc147[] = "**sock|poll|connfailed %d %d %d";
static const char long_spc147[]  = "connection failure (set=%d,sock=%d,errno=%d)";
static const char short_spc148[] = "**sock|poll|connfailed %d";
static const char long_spc148[]  = "connection failure (errno=%d)";
static const char short_spc149[] = "**sock|poll|connrefused %d %d %s";
static const char long_spc149[]  = "connection refused (set=%d,sock=%d,host=%s)";
static const char short_spc150[] = "**sock|poll|eqfail %d %d %d";
static const char long_spc150[]  = "fatal error: failed to enqueue an event; event was lost (set=%d,sock=%d,op=%d)";
static const char short_spc151[] = "**sock|poll|eqfail %d";
static const char long_spc151[]  = "fatal error: failed to enqueue an event; event was lost (op=%d)";
static const char short_spc152[] = "**sock|poll|getport %d";
static const char long_spc152[]  = "failed to obtain port number of listener (errno=%d)";
static const char short_spc153[] = "**sock|poll|hostres %d %d %s";
static const char long_spc153[]  = "unable to resolve host name to an address (set=%d,sock=%d,host=%s)";
static const char short_spc154[] = "**sock|poll|listen %d";
static const char long_spc154[]  = "listen() failed (errno=%d)";
static const char short_spc155[] = "**sock|poll|nodelay %d";
static const char long_spc155[]  = "unable to set TCP no delay attribute on socket (errno=%d)";
static const char short_spc156[] = "**sock|poll|nonblock %d";
static const char long_spc156[]  = "unable to set socket to nonblocking (errno=%d)";
static const char short_spc157[] = "**sock|poll|oserror %d %d %d";
static const char long_spc157[]  = "unknown operating system error (set=%d,sock=%d,errno=%d)";
static const char short_spc158[] = "**sock|poll|oserror %d";
static const char long_spc158[]  = "unknown operating system error (errno=%d)";
static const char short_spc159[] = "**sock|poll|pipe %d";
static const char long_spc159[]  = "unable to allocate pipe to wakeup a blocking poll() (errno=%d)";
static const char short_spc160[] = "**sock|poll|pipenonblock %d";
static const char long_spc160[]  = "unable to set wakeup pipe to nonblocking (errno=%d)";
static const char short_spc161[] = "**sock|poll|reuseaddr %d";
static const char long_spc161[]  = "unable to set reuseaddr attribute on socket (errno=%d)";
static const char short_spc162[] = "**sock|poll|socket %d";
static const char long_spc162[]  = "unable to obtain new socket (errno=%d)";
static const char short_spc163[] = "**sock|poll|unhandledstate %d %s";
static const char long_spc163[]  = "encountered an unhandled state (%d) while processing %s";
static const char short_spc164[] = "**sock|reads %d %d";
static const char long_spc164[]  = "attempt to perform multiple simultaneous reads (set=%d,sock=%d)";
static const char short_spc165[] = "**sock|writes %d %d";
static const char long_spc165[]  = "attempt to perform multiple simultaneous writes (set=%d,sock=%d)";
static const char short_spc166[] = "**stride %d %d %d";
static const char long_spc166[]  = "Range (start = %d, end = %d, stride = %d) does not terminate";
static const char short_spc167[] = "**tag %d";
static const char long_spc167[]  = "Invalid tag, value is %d";
static const char short_spc168[] = "**topotoolarge %d %d";
static const char long_spc168[]  = "Topology size %d is larger than communicator size (%d)";
static const char short_spc169[] = "**truncate %d %d %d %d";
static const char long_spc169[]  = "Message from rank %d and tag %d truncated %d bytes received but buffer size is %d";
static const char short_spc170[] = "**truncate %d %d";
static const char long_spc170[]  = "Message truncated; %d bytes received but buffer size is %d";
static const char short_spc171[] = "**typenamelen %d";
static const char long_spc171[]  = " Specified datatype name is too long (%d characters)";
static const char short_spc172[] = "**vc_state %d";
static const char long_spc172[]  = "invalid vc state (%d)";
static const char short_spc173[] = "**wsasock %d";
static const char long_spc173[]  = "WSAStartup failed (errno %d)";

static const int specific_msgs_len = 174;
...
384,41,103,111,385,94,300,315,149,261,
388,108,10,392,390,266,184,183,182,308,
123,124,130,102,105,128,129,122,160,161,
167,166,190,241,9,257,134,133,285,136,
137,317,378,106,135,395,27,222,216,311,
314,313,312,20};
#endif
