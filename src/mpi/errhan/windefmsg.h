...
static const char short_gen437[] = "**post_write";
static const char long_gen437[]  = "Unable to post a write";
static const char short_gen438[] = "**postpkt";
static const char long_gen438[]  = "Unable to post a read for the next packet header";
static const char short_gen439[] = "**process_group";
static const char long_gen439[]  = "Process group initialization failed";
static const char short_gen440[] = "**progress";
static const char long_gen440[]  = "progress engine failure";
static const char short_gen441[] = "**progress_finalize";
static const char long_gen441[]  = "finalization of the progress engine failed";
static const char short_gen442[] = "**progress_handle_sock_op";
static const char long_gen442[]  = "handle_sock_op failed";
static const char short_gen443[] = "**progress_init";
static const char long_gen443[]  = "unable to initialize the progress engine";
static const char short_gen444[] = "**progress_sock_wait";
static const char long_gen444[]  = "sock_wait failed";
static const char short_gen445[] = "**progress_test";
static const char long_gen445[]  = "progress_test engine failure";
static const char short_gen446[] = "**rangedup";
static const char long_gen446[]  = "The range array specifies duplicate entries";
static const char short_gen447[] = "**rangeendinvalid";
static const char long_gen447[]  = "Some element of a range array is either negative or too large";
static const char short_gen448[] = "**rangestartinvalid";
static const char long_gen448[]  = "Some element of a range array is either negative or too large";
static const char short_gen449[] = "**rank";
static const char long_gen449[]  = "Invalid rank";
static const char short_gen450[] = "**rankarray";
static const char long_gen450[]  = "Invalid rank in rank array";
static const char short_gen451[] = "**rankdup";
static const char long_gen451[]  = "Duplicate ranks in rank array ";
static const char short_gen452[] = "**ranklocal";
static const char long_gen452[]  = "Error specifying local_leader ";
static const char short_gen453[] = "**rankremote";
static const char long_gen453[]  = "Error specifying remote_leader ";
static const char short_gen454[] = "**rdma_finalize";
static const char long_gen454[]  = "Channel rdma finalization failed";
static const char short_gen455[] = "**rdma_init";
static const char long_gen455[]  = "Channel rdma initialization failed";
static const char short_gen456[] = "**read_progress";
static const char long_gen456[]  = "Unable to make read progress";
static const char short_gen457[] = "**recvbuf_inplace";
static const char long_gen457[]  = "recvbuf cannot be MPI_IN_PLACE";
static const char short_gen458[] = "**request";
static const char long_gen458[]  = "Invalid MPI_Request";
static const char short_gen459[] = "**requestnotpersist";
static const char long_gen459[]  = "Request is not persistent in MPI_Start or MPI_Startall.";
static const char short_gen460[] = "**requestpersistactive";
static const char long_gen460[]  = "Persistent request passed to MPI_Start or MPI_Startall is already active.";
static const char short_gen461[] = "**rmaconflict";
static const char long_gen461[]  = "Conflicting accesses to window ";
static const char short_gen462[] = "**rmadisp";
static const char long_gen462[]  = "Invalid displacement argument in RMA call ";
static const char short_gen463[] = "**rmasize";
static const char long_gen463[]  = "Invalid size argument in RMA call";
static const char short_gen464[] = "**rmasync";
static const char long_gen464[]  = "Wrong synchronization of RMA calls ";
static const char short_gen465[] = "**root";
static const char long_gen465[]  = "Invalid root";
static const char short_gen466[] = "**rsendnomatch";
static const char long_gen466[]  = "Ready send had no matching receive ";
static const char short_gen467[] = "**sendbuf_inplace";
static const char long_gen467[]  = "sendbuf cannot be MPI_IN_PLACE";
static const char short_gen468[] = "**servicename";
static const char long_gen468[]  = "Attempt to lookup an unknown service name ";
static const char short_gen469[] = "**shm_op";
static const char long_gen469[]  = "invalid shm operation";
static const char short_gen470[] = "**shm_open";
static const char long_gen470[]  = "unable to open a shared memory object";
static const char short_gen471[] = "**shm_read_progress";
static const char long_gen471[]  = "shared memory read progress failed";
static const char short_gen472[] = "**shm_unlink";
static const char long_gen472[]  = "failed to unlink shared memory";
static const char short_gen473[] = "**shm_wait";
static const char long_gen473[]  = "wait function failed";
static const char short_gen474[] = "**shmat";
static const char long_gen474[]  = "shmat failed";
static const char short_gen475[] = "**shmconnect_getmem";
static const char long_gen475[]  = "failed to allocate shared memory for a write queue";
static const char short_gen476[] = "**shmctl";
static const char long_gen476[]  = "failed to mark the sysv segment for removal";
static const char short_gen477[] = "**shmget";
static const char long_gen477[]  = "shmget failed";
static const char short_gen478[] = "**shmgetmem";
static const char long_gen478[]  = "Unable to allocate shared memory";
static const char short_gen479[] = "**shmhost";
static const char long_gen479[]  = "process not on the same host";
static const char short_gen480[] = "**shmq";
static const char long_gen480[]  = "invalid shm queue pointer";
static const char short_gen481[] = "**shmq_index";
static const char long_gen481[]  = "invalid shm queue index";
static const char short_gen482[] = "**shmsize";
static const char long_gen482[]  = "Shared memory subsystem unable to allocate a block of the requested size";
static const char short_gen483[] = "**shmwrite";
static const char long_gen483[]  = "shared memory write failed";
static const char short_gen484[] = "**snprintf";
static const char long_gen484[]  = "snprintf returned an invalid number";
static const char short_gen485[] = "**sock_accept";
static const char long_gen485[]  = "Unable to accept a socket connection";
static const char short_gen486[] = "**sock_byname";
static const char long_gen486[]  = "gethostbyname failed";
static const char short_gen487[] = "**sock_closed";
static const char long_gen487[]  = "socket closed";
static const char short_gen488[] = "**sock_connect";
static const char long_gen488[]  = "connect failed";
static const char short_gen489[] = "**sock_create";
static const char long_gen489[]  = "unable to create a socket";
static const char short_gen490[] = "**sock_gethost";
static const char long_gen490[]  = "gethostname failed";
static const char short_gen491[] = "**sock_init";
static const char long_gen491[]  = "unable to initialize the sock library";
static const char short_gen492[] = "**sock_nop_accept";
static const char long_gen492[]  = "accept called without having received an op_accept";
static const char short_gen493[] = "**sock_post_close";
static const char long_gen493[]  = "posting a close of the socket failed";
static const char short_gen494[] = "**sock_write";
static const char long_gen494[]  = "Unable to write to a socket";
static const char short_gen495[] = "**sock_writev";
static const char long_gen495[]  = "Unable to write an iovec to a socket";
static const char short_gen496[] = "**socket";
static const char long_gen496[]  = "WSASocket failed";
static const char short_gen497[] = "**sock|badbuf";
static const char long_gen497[]  = "the supplied buffer contains invalid memory";
static const char short_gen498[] = "**sock|badhandle";
static const char long_gen498[]  = "sock contains an invalid handle";
static const char short_gen499[] = "**sock|badhdbuf";
static const char long_gen499[]  = "a memory fault occurred while accessing the host description string";
static const char short_gen500[] = "**sock|badhdlen";
static const char long_gen500[]  = "host description string to small to store description";
static const char short_gen501[] = "**sock|badhdmax";
static const char long_gen501[]  = "the length of the host description string must be non-negative";
static const char short_gen502[] = "**sock|badiovn";
static const char long_gen502[]  = "size of iov is invalid";
static const char short_gen503[] = "**sock|badlen";
static const char long_gen503[]  = "bad length parameter(s)";
static const char short_gen504[] = "**sock|badport";
static const char long_gen504[]  = "port number is out of range";
static const char short_gen505[] = "**sock|badsock";
static const char long_gen505[]  = "supplied sock is corrupt";
static const char short_gen506[] = "**sock|closed";
static const char long_gen506[]  = "sock has been closed locally";
static const char short_gen507[] = "**sock|closing";
static const char long_gen507[]  = "sock is in the process of being closed locally";
static const char short_gen508[] = "**sock|connclosed";
static const char long_gen508[]  = "connection closed by peer";
static const char short_gen509[] = "**sock|connfailed";
static const char long_gen509[]  = "connection failure";
static const char short_gen510[] = "**sock|connrefused";
static const char long_gen510[]  = "connection refused";
static const char short_gen511[] = "**sock|getport";
static const char long_gen511[]  = "failed to obtain port number of the listener";
static const char short_gen512[] = "**sock|hostres";
static const char long_gen512[]  = "unable to resolve host name to an address";
static const char short_gen513[] = "**sock|nosock";
static const char long_gen513[]  = "no new sock was available to accept";
static const char short_gen514[] = "**sock|notconnected";
static const char long_gen514[]  = "sock is not connected";
static const char short_gen515[] = "**sock|oserror";
static const char long_gen515[]  = "unknown operating system error";
static const char short_gen516[] = "**sock|osnomem";
static const char long_gen516[]  = "operating system routine failed due to lack of memory";
static const char short_gen517[] = "**sock|poll|accept";
static const char long_gen517[]  = "accept failed to acquire a new socket";
static const char short_gen518[] = "**sock|poll|bind";
static const char long_gen518[]  = "unable to bind socket to port";
static const char short_gen519[] = "**sock|poll|eqfail";
static const char long_gen519[]  = "fatal error: failed to enqueue an event; event was lost";
static const char short_gen520[] = "**sock|poll|eqmalloc";
static const char long_gen520[]  = "MPIU_Malloc failed to allocate memory for an event queue structure";
static const char short_gen521[] = "**sock|poll|listen";
static const char long_gen521[]  = "listen() failed";
static const char short_gen522[] = "**sock|poll|nodelay";
static const char long_gen522[]  = "unable to set TCP no delay attribute on socket";
static const char short_gen523[] = "**sock|poll|nonblock";
static const char long_gen523[]  = "unable to set socket to nonblocking";
static const char short_gen524[] = "**sock|poll|pipe";
static const char long_gen524[]  = "unable to allocate pipe to wakeup a blocking poll()";
static const char short_gen525[] = "**sock|poll|pipenonblock";
static const char long_gen525[]  = "unable to set wakeup pipe to nonblocking";
static const char short_gen526[] = "**sock|poll|reuseaddr";
static const char long_gen526[]  = "unable to set reuseaddr attribute on socket";
static const char short_gen527[] = "**sock|poll|socket";
static const char long_gen527[]  = "unable to obtain new socket";
static const char short_gen528[] = "**sock|poll|unhandledstate";
static const char long_gen528[]  = "encountered an unhandled";
static const char short_gen529[] = "**sock|reads";
static const char long_gen529[]  = "attempt to perform multiple simultaneous reads";
static const char short_gen530[] = "**sock|setalloc";
static const char long_gen530[]  = "unable to allocate a new sock set object";
static const char short_gen531[] = "**sock|sockalloc";
static const char long_gen531[]  = "unable to allocate a new sock object";
static const char short_gen532[] = "**sock|uninit";
static const char long_gen532[]  = "Sock library has not been initialized";
static const char short_gen533[] = "**sock|writes";
static const char long_gen533[]  = "attempt to perform multiple simultaneous writes";
static const char short_gen534[] = "**spawn";
static const char long_gen534[]  = "Error in spawn call";
static const char short_gen535[] = "**ssmwrite";
static const char long_gen535[]  = "sock/shared memory write failed";
static const char short_gen536[] = "**ssmwritev";
static const char long_gen536[]  = "sock/shared memory writev failed";
static const char short_gen537[] = "**stride";
static const char long_gen537[]  = "Range does not terminate";
static const char short_gen538[] = "**stridezero";
static const char long_gen538[]  = "Zero stride is invalid";
static const char short_gen539[] = "**strncpy";
static const char long_gen539[]  = "insufficient buffer length to complete strncpy";
static const char short_gen540[] = "**success";
static const char long_gen540[]  = "No MPI error";
static const char short_gen541[] = "**tag";
static const char long_gen541[]  = "Invalid tag";
static const char short_gen542[] = "**test_sock_wait";
static const char long_gen542[]  = "sock_wait failed";
static const char short_gen543[] = "**toomanycomm";
static const char long_gen543[]  = "Too many communicators";
static const char short_gen544[] = "**topology";
static const char long_gen544[]  = "Invalid topology";
static const char short_gen545[] = "**topotoolarge";
static const char long_gen545[]  = "Topology size is greater than communicator size";
static const char short_gen546[] = "**truncate";
static const char long_gen546[]  = "Message truncated";
static const char short_gen547[] = "**typematchnoclass";
static const char long_gen547[]  = "The value of typeclass is not one of MPI_TYPECLASS_REAL, MPI_TYPECLASS_INTEGER, or MPI_TYPECLASS_COMPLEX";
static const char short_gen548[] = "**typematchsize";
static const char long_gen548[]  = "No MPI datatype available for the given typeclass and size";
static const char short_gen549[] = "**typenamelen";
static const char long_gen549[]  = " Specified datatype name is too long";
static const char short_gen550[] = "**unknown";
static const char long_gen550[]  = "Unknown error.  Please file a bug report.";
static const char short_gen551[] = "**unsupporteddatarep";
static const char long_gen551[]  = "Only native data representation currently supported";
static const char short_gen552[] = "**vc_state";
static const char long_gen552[]  = "invalid vc state";
static const char short_gen553[] = "**win";
static const char long_gen553[]  = "Invalid MPI_Win";
static const char short_gen554[] = "**winwait";
static const char long_gen554[]  = "WaitForSingleObject failed";
static const char short_gen555[] = "**write_progress";
static const char long_gen555[]  = "Write progress failed";
static const char short_gen556[] = "**wsasock";
static const char long_gen556[]  = "WSAStartup failed";

static const int generic_msgs_len = 557;
...
static const char long_spc76[]  = "MPI_Add_error_string(code=%d, str=\"%s\") failed";
static const char short_spc77[] = "**mpi_allgather %p %d %D %p %d %D %C";
static const char long_spc77[]  = "MPI_Allgather(sbuf=%p, scount=%d, %D, rbuf=%p, rcount=%d, %D, %C) failed";
static const char short_spc78[] = "**mpi_allgatherv %p %d %D %p %p %p %D %C";
static const char long_spc78[]  = "MPI_Allgatherv(sbuf=%p, scount=%d, %D, rbuf=%p, rcounts=%p, displs=%p, %D, %C) failed";
static const char short_spc79[] = "**mpi_allreduce %p %p %d %D %O %C";
static const char long_spc79[]  = "MPI_Allreduce(sbuf=%p, rbuf=%p, count=%d, %D, %O, %C) failed";
static const char short_spc80[] = "**mpi_alltoall %p %d %D %p %d %D %C";
static const char long_spc80[]  = "MPI_Alltoall(sbuf=%p, scount=%d, %D, rbuf=%p, rcount=%d, %D, %C) failed";
static const char short_spc81[] = "**mpi_alltoallv %p %p %p %D %p %p %p %D %C";
static const char long_spc81[]  = "MPI_Alltoallv(sbuf=%p, scnts=%p, sdispls=%p, %D, rbuf=%p, rcnts=%p, rdispls=%p, %D, %C) failed";
static const char short_spc82[] = "**mpi_alltoallw %p %p %p %p %p %p %p %p %C";
static const char long_spc82[]  = "MPI_Alltoallw(sbuf=%p, scnts=%p, sdispls=%p, stypes=%p, rbuf=%p, rcnts=%p, rdispls=%p, rtypes=%p, %C) failed";
...
static const char long_spc87[]  = "MPI_Bcast(buf=%p, count=%d, %D, root=%d, %C) failed";
static const char short_spc88[] = "**mpi_bsend %p %d %D %d %d %C";
static const char long_spc88[]  = "MPI_Bsend(buf=%p, count=%d, %D, dest=%d, tag=%d, %C) failed";
static const char short_spc89[] = "**mpi_bsend_init %p %d %D %d %d %C %p";
static const char long_spc89[]  = "MPI_Bsend_init(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc90[] = "**mpi_buffer_attach %p %d";
static const char long_spc90[]  = "MPI_Buffer_attach(buf=%p, size=%d) failed";
static const char short_spc91[] = "**mpi_buffer_detach %p %p";
static const char long_spc91[]  = "MPI_Buffer_detach(buf=%p, size=%p) failed";
static const char short_spc92[] = "**mpi_cancel %p";
static const char long_spc92[]  = "MPI_Cancel(request=%p) failed";
...
static const char long_spc94[]  = "MPI_Close_port(port=\"%s\") failed";
static const char short_spc95[] = "**mpi_comm_accept %s %I %d %C %p";
static const char long_spc95[]  = "MPI_Comm_accept(port=\"%s\", %I, root=%d, %C, newcomm=%p) failed";
static const char short_spc96[] = "**mpi_comm_connect %s %I %d %C %p";
static const char long_spc96[]  = "MPI_Comm_connect(port=\"%s\", %I, root=%d, %C, newcomm=%p) failed";
static const char short_spc97[] = "**mpi_comm_disconnect %p";
static const char long_spc97[]  = "MPI_Comm_disconnect(comm=%p) failed";
...
static const char long_spc101[]  = "MPI_Comm_join(fd=%d, intercomm=%p) failed";
...
static const char long_spc104[]  = "MPI_Comm_spawn(cmd=\"%s\", argv=%p, maxprocs=%d, %I, root=%d, %C, intercomm=%p, errors=%p) failed";
static const char short_spc105[] = "**mpi_comm_spawn_multiple %d %p %p %p %p %d %C %p %p";
static const char long_spc105[]  = "MPI_Comm_spawn_multiple(count=%d, cmds=%p, argvs=%p, maxprocs=%p, infos=%p, root=%d, %C, intercomm=%p, errors=%p) failed";
...
static const char long_spc110[]  = "MPI_Exscan(sbuf=%p, rbuf=%p, count=%d, %D, %O, %C) failed";
...
static const char long_spc112[]  = "MPI_Gather(sbuf=%p, scount=%d, %D, rbuf=%p, rcount=%d, %D, root=%d, %C) failed";
static const char short_spc113[] = "**mpi_gatherv %p %d %D %p %p %p %D %d %C";
static const char long_spc113[]  = "MPI_Gatherv failed(sbuf=%p, scount=%d, %D, rbuf=%p, rcnts=%p, displs=%p, %D, root=%d, %C) failed";
...
static const char long_spc127[]  = "MPI_Ibsend(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
...
static const char long_spc137[]  = "MPI_Iprobe(src=%d, tag=%d, %C, flag=%p, status=%p) failed";
static const char short_spc138[] = "**mpi_irecv %p %d %D %d %d %C %p";
static const char long_spc138[]  = "MPI_Irecv(buf=%p, count=%d, %D, src=%d, tag=%d, %C, request=%p) failed";
static const char short_spc139[] = "**mpi_irsend %p %d %D %d %d %C %p";
static const char long_spc139[]  = "MPI_Irsend(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc140[] = "**mpi_isend %p %d %D %d %d %C %p";
static const char long_spc140[]  = "MPI_Isend(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc141[] = "**mpi_issend %p %d %D %d %d %C %p";
static const char long_spc141[]  = "MPI_Issend(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
...
static const char long_spc144[]  = "MPI_Lookup_name(service=\"%s\", %I, port=%p) failed";
static const char short_spc145[] = "**mpi_op_create %p %d %p";
static const char long_spc145[]  = "MPI_Op_create(fn=%p, commute=%d, op=%p) failed";
static const char short_spc146[] = "**mpi_open_port %I %p";
static const char long_spc146[]  = "MPI_Open_port(%I, port=%p) failed";
static const char short_spc147[] = "**mpi_pack %p %d %D %p %d %p %C";
static const char long_spc147[]  = "MPI_Pack(inbuf=%p, incount=%d, %D, outbuf=%p, outcount=%d, position=%p, %C) failed";
...
static const char long_spc149[]  = "MPI_Probe(src=%d, tag=%d, %C, status=%p) failed";
static const char short_spc150[] = "**mpi_publish_name %s %I %s";
static const char long_spc150[]  = "MPI_Publish_name(service=\"%s\", %I, port=\"%s\") failed";
...
static const char long_spc152[]  = "MPI_Recv(buf=%p, count=%d, %D, src=%d, %C, status=%p) failed";
static const char short_spc153[] = "**mpi_recv_init %p %d %D %d %d %C %p";
static const char long_spc153[]  = "MPI_Recv_init(buf=%p, count=%d, %D, src=%d, tag=%d, %C, request=%p) failed";
static const char short_spc154[] = "**mpi_reduce %p %p %d %D %O %d %C";
static const char long_spc154[]  = "MPI_Reduce(sbuf=%p, rbuf=%p, count=%d, %D, %O, root=%d, %C) failed";
static const char short_spc155[] = "**mpi_reduce_scatter %p %p %p %D %O %C";
static const char long_spc155[]  = "MPI_Reduce_scatter(sbuf=%p, rbuf=%p, rcnts=%p, %D, %O, %C) failed";
...
static const char long_spc157[]  = "MPI_Request_free(request=%p) failed";
...
static const char long_spc159[]  = "MPI_Rsend(buf=%p, count=%d, %D, src=%d, tag=%d, %C) failed";
static const char short_spc160[] = "**mpi_rsend_init %p %d %D %d %d %C %p";
static const char long_spc160[]  = "MPI_Rsend_init(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc161[] = "**mpi_scan %p %p %d %D %O %C";
static const char long_spc161[]  = "MPI_Scan(sbuf=%p, rbuf=%p, count=%d, %D, %O, %C) failed";
static const char short_spc162[] = "**mpi_scatter %p %d %D %p %d %D %d %C";
static const char long_spc162[]  = "MPI_Scatter(sbuf=%p, scount=%d, %D, rbuf=%p, rcount=%d, %D, root=%d, %C) failed";
static const char short_spc163[] = "**mpi_scatterv %p %p %p %D %p %d %D %d %C";
static const char long_spc163[]  = "MPI_Scatterv(sbuf=%p, scnts=%p, displs=%p, %D, rbuf=%p, rcount=%d, %D, root=%d, %C) failed";
static const char short_spc164[] = "**mpi_send %p %d %D %d %d %C";
static const char long_spc164[]  = "MPI_Send(buf=%p, count=%d, %D, dest=%d, tag=%d, %C) failed";
static const char short_spc165[] = "**mpi_send_init %p %d %D %d %d %C %p";
static const char long_spc165[]  = "MPI_Send_init(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc166[] = "**mpi_sendrecv %p %d %D %d %d %p %d %D %d %d %C %p";
static const char long_spc166[]  = "MPI_Sendrecv(sbuf=%p, scount=%d, %D, dest=%d, stag=%d, rbuf=%p, rcount=%d, %D, src=%d, rtag=%d, %C, status=%p) failed";
static const char short_spc167[] = "**mpi_sendrecv_replace %p %d %D %d %d %d %d %C %p";
static const char long_spc167[]  = "MPI_Sendrecv_replace(buf=%p, count=%d, %D, dest=%d, stag=%d, src=%d, rtag=%d, %C, status=%p) failed";
static const char short_spc168[] = "**mpi_ssend %p %d %D %d %d %C";
static const char long_spc168[]  = "MPI_Ssend(buf=%p, count=%d, %D, dest=%d, tag=%d, %C) failed";
static const char short_spc169[] = "**mpi_ssend_init %p %d %D %d %d %C %p";
static const char long_spc169[]  = "MPI_Ssend_init(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc170[] = "**mpi_start %p";
static const char long_spc170[]  = "MPI_Start(request=%p) failed";
static const char short_spc171[] = "**mpi_startall %d %p";
static const char long_spc171[]  = "MPI_Startall(count=%d, req_array=%p) failed";
static const char short_spc172[] = "**mpi_test %p %p %p";
static const char long_spc172[]  = "MPI_Test(request=%p, flag=%p, status=%p) failed";
static const char short_spc173[] = "**mpi_testall %d %p %p %p";
static const char long_spc173[]  = "MPI_Testall(count=%d, req_array=%p, flag=%p, status_array=%p) failed";
static const char short_spc174[] = "**mpi_testany %d %p %p %p %p";
static const char long_spc174[]  = "MPI_Testany(count=%d, req_array=%p, index=%p, flag=%p, status=%p) failed";
static const char short_spc175[] = "**mpi_testsome %d %p %p %p %p";
static const char long_spc175[]  = "MPI_Testsome(count=%d, req_array=%p, out_count=%p, indices=%p, status_array=%p) failed";
...
static const char long_spc196[]  = "MPI_Unpublish_name(service=\"%s\", %I, port=\"%s\") failed";
static const char short_spc197[] = "**mpi_wait %p %p";
static const char long_spc197[]  = "MPI_Wait(request=%p, status%p) failed";
static const char short_spc198[] = "**mpi_waitall %d %p %p";
static const char long_spc198[]  = "MPI_Waitall(count=%d, req_array=%p, status_array=%p) failed";
static const char short_spc199[] = "**mpi_waitany %d %p %p %p";
static const char long_spc199[]  = "MPI_Waitany(count=%d, req_array=%p, index=%p, status=%p) failed";
static const char short_spc200[] = "**mpi_waitsome %d %p %p %p %p";
static const char long_spc200[]  = "MPI_Waitsome(count=%d, req_array=%p, out_count=%p, indices=%p, status_array=%p) failed";
...
static const char short_spc206[] = "**mpi_win_fence %A %W";
static const char long_spc206[]  = "MPI_Win_fence(%A, %W) failed";
...
static const char short_spc223[] = "**namepubfile %s %s %s";
static const char long_spc223[]  = "Unable to publish service name %s using file %s for reason %s";
...
static const char short_spc238[] = "**pkt_type %d";
static const char long_spc238[]  = "invalid packet type (%d)";
static const char short_spc239[] = "**pmi_barrier %d";
static const char long_spc239[]  = "PMI_Barrier returned %d";
static const char short_spc240[] = "**pmi_finalize %d";
static const char long_spc240[]  = "PMI_Finalize returned %d";
static const char short_spc241[] = "**pmi_get_id %d";
static const char long_spc241[]  = "PMI_Get_id returned %d";
static const char short_spc242[] = "**pmi_get_id_length_max %d";
static const char long_spc242[]  = "PMI_Get_id_length_max returned %d";
static const char short_spc243[] = "**pmi_get_rank %d";
static const char long_spc243[]  = "PMI_Get_rank returned %d";
static const char short_spc244[] = "**pmi_get_size %d";
static const char long_spc244[]  = "PMI_Get_size returned %d";
static const char short_spc245[] = "**pmi_init %d";
static const char long_spc245[]  = "PMI_Init returned %d";
static const char short_spc246[] = "**pmi_kvs_commit %d";
static const char long_spc246[]  = "PMI_KVS_Commit returned %d";
static const char short_spc247[] = "**pmi_kvs_create %d";
static const char long_spc247[]  = "PMI_KVS_Create returned %d";
static const char short_spc248[] = "**pmi_kvs_get %d";
static const char long_spc248[]  = "PMI_KVS_Get returned %d";
static const char short_spc249[] = "**pmi_kvs_get_key_length_max %d";
static const char long_spc249[]  = "PMI_KVS_Get_key_length_max returned %d";
static const char short_spc250[] = "**pmi_kvs_get_my_name %d";
static const char long_spc250[]  = "PMI_KVS_Get_my_name returned %d";
static const char short_spc251[] = "**pmi_kvs_get_name_length_max %d";
static const char long_spc251[]  = "PMI_KVS_Get_name_length_max returned %d";
static const char short_spc252[] = "**pmi_kvs_get_parent %d";
static const char long_spc252[]  = "unable to get the PARENT_ROOT_PORT_NAME from the keyval space (pmi_error %d)";
static const char short_spc253[] = "**pmi_kvs_get_value_length_max %d";
static const char long_spc253[]  = "PMI_KVS_Get_value_length_max returned %d";
static const char short_spc254[] = "**pmi_kvs_put %d";
static const char long_spc254[]  = "PMI_KVS_Put returned %d";
static const char short_spc255[] = "**pmi_spawn_multiple %d";
static const char long_spc255[]  = "PMI_Spawn_multiple returned %d";
static const char short_spc256[] = "**post_connect %s";
static const char long_spc256[]  = "%s failed in VC_post_connect";
static const char short_spc257[] = "**rangedup %d %d %d";
static const char long_spc257[]  = "The range array specifies duplicate entries; process %d specified in range array %d was previously specified in range array %d";
static const char short_spc258[] = "**rangeendinvalid %d %d %d";
static const char long_spc258[]  = "The %dth element of a range array ends at %d but must be nonnegative and less than %d";
static const char short_spc259[] = "**rangestartinvalid %d %d %d";
static const char long_spc259[]  = "The %dth element of a range array starts at %d but must be nonnegative and less than %d";
static const char short_spc260[] = "**rank %d %d";
static const char long_spc260[]  = "Invalid rank has value %d but must be nonnegative and less than %d";
static const char short_spc261[] = "**rankarray %d %d %d";
static const char long_spc261[]  = "Invalid rank in rank array at index %d; value is %d but must be in the range 0 to %d";
static const char short_spc262[] = "**rankdup %d %d %d";
static const char long_spc262[]  = "Duplicate ranks in rank array at index %d, has value %d which is also the value at index %d";
static const char short_spc263[] = "**ranklocal %d %d";
static const char long_spc263[]  = "Error specifying local_leader; rank given was %d but must be in the range 0 to %d";
static const char short_spc264[] = "**rankremote %d %d";
static const char long_spc264[]  = "Error specifying remote_leader; rank given was %d but must be in the range 0 to %d";
static const char short_spc265[] = "**rmasize %d";
static const char long_spc265[]  = "Invalid size argument in RMA call (value is %d)";
static const char short_spc266[] = "**root %d";
static const char long_spc266[]  = "Invalid root (value given was %d)";
static const char short_spc267[] = "**rsendnomatch %d %d";
static const char long_spc267[]  = "Ready send from source %d and with tag %d had no matching receive";
static const char short_spc268[] = "**shm_op %d";
static const char long_spc268[]  = "invalid shm operation (%d)";
static const char short_spc269[] = "**shm_open %s %d";
static const char long_spc269[]  = "unable to open shared memory object %s (errno %d)";
static const char short_spc270[] = "**shm_unlink %s %d";
static const char long_spc270[]  = "failed to unlink shared memory object %s, error %d";
static const char short_spc271[] = "**shmat %d";
static const char long_spc271[]  = "shmat failed, error %d";
static const char short_spc272[] = "**shmctl %d %d";
static const char long_spc272[]  = "failed to mark the sysv segment %d for removal, error %d";
static const char short_spc273[] = "**shmget %d";
static const char long_spc273[]  = "shmget failed, error %d";
static const char short_spc274[] = "**shmhost %s %s";
static const char long_spc274[]  = "process not on the same host (%s != %s)";
static const char short_spc275[] = "**shmq_index %d %d";
static const char long_spc275[]  = "invalid shm queue index (%d > %d)";
static const char short_spc276[] = "**shmsize %d";
static const char long_spc276[]  = "Shared memory subsystem unable to allocate a block of the requested size, %d bytes";
static const char short_spc277[] = "**snprintf %d";
static const char long_spc277[]  = "snprintf returned %d";
static const char short_spc278[] = "**sock_byname %d";
static const char long_spc278[]  = "gethostbyname failed (errno %d)";
static const char short_spc279[] = "**sock_connect %d";
static const char long_spc279[]  = "connect failed (errno %d)";
static const char short_spc280[] = "**sock_create %d";
static const char long_spc280[]  = "unable to create a socket (errno %d)";
static const char short_spc281[] = "**sock_gethost %d";
static const char long_spc281[]  = "gethostname failed (errno %d)";
static const char short_spc282[] = "**socket %d";
static const char long_spc282[]  = "WSASocket failed (errno %d)";
static const char short_spc283[] = "**sock|badbuf %d %d";
static const char long_spc283[]  = "the supplied buffer contains invalid memory (set=%d,sock=%d)";
static const char short_spc284[] = "**sock|badiovn %d %d %d";
static const char long_spc284[]  = "size of iov is invalid (set=%d,sock=%d,iov_n=%d)";
static const char short_spc285[] = "**sock|badlen %d %d %d %d";
static const char long_spc285[]  = "bad length parameter(s) (set=%d,sock=%d,min=%d,max=%d)";
static const char short_spc286[] = "**sock|badport %d";
static const char long_spc286[]  = "port number is out of range (sock=%d)";
static const char short_spc287[] = "**sock|closing %d %d";
static const char long_spc287[]  = "sock is in the process of being closed locally (set=%d,sock=%d)";
static const char short_spc288[] = "**sock|connclosed %d %d";
static const char long_spc288[]  = "connection closed by peer (set=%d,sock=%d)";
static const char short_spc289[] = "**sock|connfailed %d %d";
static const char long_spc289[]  = "connection failure (set=%d,sock=%d)";
static const char short_spc290[] = "**sock|notconnected %d %d";
static const char long_spc290[]  = "sock is not connected (set=%d,sock=%d)";
static const char short_spc291[] = "**sock|osnomem %d %d";
static const char long_spc291[]  = "operating system routine failed due to lack of memory (set=%d,sock=%d)";
static const char short_spc292[] = "**sock|poll|accept %d";
static const char long_spc292[]  = "accept failed to acquire a new socket (errno=%d)";
static const char short_spc293[] = "**sock|poll|badhandle %d %d %d";
static const char long_spc293[]  = "sock contains an invalid handle (set=%d,sock=%d,fd=%d)";
static const char short_spc294[] = "**sock|poll|bind %d %d";
static const char long_spc294[]  = "unable to bind socket to port (port=%d,errno=%d)";
static const char short_spc295[] = "**sock|poll|connfailed %d %d %d";
static const char long_spc295[]  = "connection failure (set=%d,sock=%d,errno=%d)";
static const char short_spc296[] = "**sock|poll|connfailed %d";
static const char long_spc296[]  = "connection failure (errno=%d)";
static const char short_spc297[] = "**sock|poll|connrefused %d %d %s";
static const char long_spc297[]  = "connection refused (set=%d,sock=%d,host=%s)";
static const char short_spc298[] = "**sock|poll|eqfail %d %d %d";
static const char long_spc298[]  = "fatal error: failed to enqueue an event; event was lost (set=%d,sock=%d,op=%d)";
static const char short_spc299[] = "**sock|poll|eqfail %d";
static const char long_spc299[]  = "fatal error: failed to enqueue an event; event was lost (op=%d)";
static const char short_spc300[] = "**sock|poll|getport %d";
static const char long_spc300[]  = "failed to obtain port number of listener (errno=%d)";
static const char short_spc301[] = "**sock|poll|hostres %d %d %s";
static const char long_spc301[]  = "unable to resolve host name to an address (set=%d,sock=%d,host=%s)";
static const char short_spc302[] = "**sock|poll|listen %d";
static const char long_spc302[]  = "listen() failed (errno=%d)";
static const char short_spc303[] = "**sock|poll|nodelay %d";
static const char long_spc303[]  = "unable to set TCP no delay attribute on socket (errno=%d)";
static const char short_spc304[] = "**sock|poll|nonblock %d";
static const char long_spc304[]  = "unable to set socket to nonblocking (errno=%d)";
static const char short_spc305[] = "**sock|poll|oserror %d %d %d";
static const char long_spc305[]  = "unknown operating system error (set=%d,sock=%d,errno=%d)";
static const char short_spc306[] = "**sock|poll|oserror %d";
static const char long_spc306[]  = "unknown operating system error (errno=%d)";
static const char short_spc307[] = "**sock|poll|pipe %d";
static const char long_spc307[]  = "unable to allocate pipe to wakeup a blocking poll() (errno=%d)";
static const char short_spc308[] = "**sock|poll|pipenonblock %d";
static const char long_spc308[]  = "unable to set wakeup pipe to nonblocking (errno=%d)";
static const char short_spc309[] = "**sock|poll|reuseaddr %d";
static const char long_spc309[]  = "unable to set reuseaddr attribute on socket (errno=%d)";
static const char short_spc310[] = "**sock|poll|socket %d";
static const char long_spc310[]  = "unable to obtain new socket (errno=%d)";
static const char short_spc311[] = "**sock|poll|unhandledstate %d %s";
static const char long_spc311[]  = "encountered an unhandled state (%d) while processing %s";
static const char short_spc312[] = "**sock|reads %d %d";
static const char long_spc312[]  = "attempt to perform multiple simultaneous reads (set=%d,sock=%d)";
static const char short_spc313[] = "**sock|writes %d %d";
static const char long_spc313[]  = "attempt to perform multiple simultaneous writes (set=%d,sock=%d)";
static const char short_spc314[] = "**stride %d %d %d";
static const char long_spc314[]  = "Range (start = %d, end = %d, stride = %d) does not terminate";
static const char short_spc315[] = "**tag %d";
static const char long_spc315[]  = "Invalid tag, value is %d";
static const char short_spc316[] = "**topotoolarge %d %d";
static const char long_spc316[]  = "Topology size %d is larger than communicator size (%d)";
static const char short_spc317[] = "**truncate %d %d %d %d";
static const char long_spc317[]  = "Message from rank %d and tag %d truncated; %d bytes received but buffer size is %d";
static const char short_spc318[] = "**truncate %d %d";
static const char long_spc318[]  = "Message truncated; %d bytes received but buffer size is %d";
static const char short_spc319[] = "**typematchsize %s %d";
static const char long_spc319[]  = "No MPI datatype available for typeclass %s and size %d";
static const char short_spc320[] = "**typenamelen %d";
static const char long_spc320[]  = " Specified datatype name is too long (%d characters)";
static const char short_spc321[] = "**vc_state %d";
static const char long_spc321[]  = "invalid vc state (%d)";
static const char short_spc322[] = "**wsasock %d";
static const char long_spc322[]  = "WSAStartup failed (errno %d)";

static const int specific_msgs_len = 323;
...
540,42,104,112,541,95,449,465,150,403,
544,109,10,550,546,408,184,183,182,458,
124,125,131,103,106,129,130,123,161,162,
168,167,190,383,9,399,135,134,433,137,
138,468,534,107,136,553,27,224,218,461,
464,463,462,20};
#endif
