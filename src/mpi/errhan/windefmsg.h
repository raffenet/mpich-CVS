...
static const char short_gen150[] = "**inttoosmall";
static const char long_gen150[]  = "An address does not fit into a Fortran INTEGER.  Use MPI_Get_address instead";
static const char short_gen151[] = "**io";
static const char long_gen151[]  = "Other I/O error ";
static const char short_gen152[] = "**ioRMWrdwr";
static const char long_gen152[]  = "Must open file with MPI_MODE_RDWR for read-modify-write ";
static const char short_gen153[] = "**ioagnomatch";
static const char long_gen153[]  = "No aggregators match";
static const char short_gen154[] = "**ioamodeseq";
static const char long_gen154[]  = "Cannot use this function when the file is opened with amode MPI_MODE_SEQUENTIAL ";
static const char short_gen155[] = "**iobadcount";
static const char long_gen155[]  = "Invalid count argument";
static const char short_gen156[] = "**iobaddisp";
static const char long_gen156[]  = "Invalid displacement argument";
static const char short_gen157[] = "**iobadfh";
static const char long_gen157[]  = "Invalid file handle";
static const char short_gen158[] = "**iobadoffset";
static const char long_gen158[]  = "Invalid offset argument";
static const char short_gen159[] = "**iobadsize";
static const char long_gen159[]  = "Invalid size argument";
static const char short_gen160[] = "**iobadwhence";
static const char long_gen160[]  = "Invalid whence argument";
static const char short_gen161[] = "**iodatarepnomem";
static const char long_gen161[]  = "User must allocate memory for datarep";
static const char short_gen162[] = "**iodispifseq";
static const char long_gen162[]  = "disp must be set to MPI_DISPLACEMENT_CURRENT since file was opened with MPI_MODE_SEQUENTIAL";
static const char short_gen163[] = "**ioetype";
static const char long_gen163[]  = "Only an integral number of etypes can be accessed";
static const char short_gen164[] = "**iofiletype";
static const char long_gen164[]  = "Filetype must be constructed out of one or more etypes";
static const char short_gen165[] = "**iofstype";
static const char long_gen165[]  = "Cannot determine filesystem type";
static const char short_gen166[] = "**iofstypeunsupported";
static const char long_gen166[]  = "Specified filesystem is not available";
static const char short_gen167[] = "**ioneedrd";
static const char long_gen167[]  = "Read access is required to this file";
static const char short_gen168[] = "**ionegoffset";
static const char long_gen168[]  = "Negative offset argument";
static const char short_gen169[] = "**iopreallocrdwr";
static const char long_gen169[]  = "Must open file with MPI_MODE_RDWR to preallocate disk space";
static const char short_gen170[] = "**iosequnsupported";
static const char long_gen170[]  = "MPI_MODE_SEQUENTIAL not supported on this file system";
static const char short_gen171[] = "**iosharedunsupported";
static const char long_gen171[]  = "Shared file pointers not supported";
static const char short_gen172[] = "**iosplitcoll";
static const char long_gen172[]  = "Only one active split collective I/O operation is allowed per file handle";
static const char short_gen173[] = "**iosplitcollnone";
static const char long_gen173[]  = "No split collective I/O operation is active";
static const char short_gen174[] = "**keyval";
static const char long_gen174[]  = "Invalid keyval";
static const char short_gen175[] = "**keyvalinvalid";
static const char long_gen175[]  = "Attribute key was MPI_KEYVAL_INVALID";
static const char short_gen176[] = "**keyvalnotcomm";
static const char long_gen176[]  = "Keyval was not defined for communicators";
static const char short_gen177[] = "**keyvalnotdatatype";
static const char long_gen177[]  = "Keyval was not defined for datatype";
static const char short_gen178[] = "**locktype";
static const char long_gen178[]  = "Invalid locktype";
static const char short_gen179[] = "**msgctl";
static const char long_gen179[]  = "msgctl failed";
static const char short_gen180[] = "**msgget";
static const char long_gen180[]  = "msgget failed";
static const char short_gen181[] = "**msgrcv";
static const char long_gen181[]  = "msgrcv failed";
static const char short_gen182[] = "**msgsnd";
static const char long_gen182[]  = "msgsnd failed";
static const char short_gen183[] = "**namepublish";
static const char long_gen183[]  = "Unable to publish service name";
static const char short_gen184[] = "**namepubnotpub";
static const char long_gen184[]  = "Lookup failed for service name ";
static const char short_gen185[] = "**nameservice";
static const char long_gen185[]  = "Invalid service name (see MPI_Publish_name)";
static const char short_gen186[] = "**nextbootmsg";
static const char long_gen186[]  = "failed to get the next bootstrap message";
static const char short_gen187[] = "**noerrclasses";
static const char long_gen187[]  = "No more user-defined error classes";
static const char short_gen188[] = "**noerrcodes";
static const char long_gen188[]  = "No more user-defined error codes";
static const char short_gen189[] = "**nomem";
static const char long_gen189[]  = "Out of memory";
static const char short_gen190[] = "**nomemreq";
static const char long_gen190[]  = "failure occurred while allocating memory for a request object";
static const char short_gen191[] = "**nonamepub";
static const char long_gen191[]  = "No name publishing service available";
static const char short_gen192[] = "**notcarttopo";
static const char long_gen192[]  = "No Cartesian topology associated with this communicator";
static const char short_gen193[] = "**notcstatignore";
static const char long_gen193[]  = "MPI_STATUS_IGNORE cannot be passed to MPI_Status_c2f()";
static const char short_gen194[] = "**notfstatignore";
static const char long_gen194[]  = "MPI_STATUS_IGNORE cannot be passed to MPI_Status_f2c()";
static const char short_gen195[] = "**notgenreq";
static const char long_gen195[]  = "Attempt to complete a request with MPI_GREQUEST_COMPLETE that was not started with MPI_GREQUEST_START";
static const char short_gen196[] = "**notgraphtopo";
static const char long_gen196[]  = "No Graph topology associated with this communicator";
static const char short_gen197[] = "**notimpl";
static const char long_gen197[]  = "Function not implemented";
static const char short_gen198[] = "**notopology";
static const char long_gen198[]  = "No topology associated with this communicator";
static const char short_gen199[] = "**notsame";
static const char long_gen199[]  = "Inconsistent arguments to collective routine ";
static const char short_gen200[] = "**nulledge";
static const char long_gen200[]  = "Edge detected from a node to the same node";
static const char short_gen201[] = "**nullptr";
static const char long_gen201[]  = "Null pointer";
static const char short_gen202[] = "**nullptrtype";
static const char long_gen202[]  = "Null pointer";
static const char short_gen203[] = "**op";
static const char long_gen203[]  = "Invalid MPI_Op";
static const char short_gen204[] = "**open";
static const char long_gen204[]  = "open failed";
static const char short_gen205[] = "**opnotpredefined";
static const char long_gen205[]  = "only predefined ops are valid";
static const char short_gen206[] = "**opundefined";
static const char long_gen206[]  = "MPI_Op operation not defined for this datatype ";
static const char short_gen207[] = "**opundefined_rma";
static const char long_gen207[]  = "RMA target received unknown RMA operation";
static const char short_gen208[] = "**other";
static const char long_gen208[]  = "Other MPI error";
static const char short_gen209[] = "**permattr";
static const char long_gen209[]  = "Cannot set permanent attribute";
static const char short_gen210[] = "**permop";
static const char long_gen210[]  = "Cannot free permanent MPI_Op ";
static const char short_gen211[] = "**pfinal_sockclose";
static const char long_gen211[]  = "sock_close failed";
static const char short_gen212[] = "**pmi_barrier";
static const char long_gen212[]  = "PMI_Barrier failed";
static const char short_gen213[] = "**pmi_finalize";
static const char long_gen213[]  = "PMI_Finalize failed";
static const char short_gen214[] = "**pmi_get_rank";
static const char long_gen214[]  = "PMI_Get_rank failed";
static const char short_gen215[] = "**pmi_get_size";
static const char long_gen215[]  = "PMI_Get_size failed";
static const char short_gen216[] = "**pmi_init";
static const char long_gen216[]  = "PMI_Init failed";
static const char short_gen217[] = "**pmi_kvs_commit";
static const char long_gen217[]  = "PMI_KVS_Commit failed";
static const char short_gen218[] = "**pmi_kvs_get";
static const char long_gen218[]  = "PMI_KVS_Get failed";
static const char short_gen219[] = "**pmi_kvs_get_my_name";
static const char long_gen219[]  = "PMI_KVS_Get_my_name failed";
static const char short_gen220[] = "**pmi_kvs_put";
static const char long_gen220[]  = "PMI_KVS_Put failed";
static const char short_gen221[] = "**poke";
static const char long_gen221[]  = "progress_poke failed";
static const char short_gen222[] = "**port";
static const char long_gen222[]  = "Invalid port";
static const char short_gen223[] = "**post_connect";
static const char long_gen223[]  = "failed to post a connection";
static const char short_gen224[] = "**postpkt";
static const char long_gen224[]  = "Unable to post a read for the next packet header";
static const char short_gen225[] = "**process_group";
static const char long_gen225[]  = "Process group initialization failed";
static const char short_gen226[] = "**progress_handle_sock_op";
static const char long_gen226[]  = "handle_sock_op failed";
static const char short_gen227[] = "**progress_sock_wait";
static const char long_gen227[]  = "sock_wait failed";
static const char short_gen228[] = "**rangedup";
static const char long_gen228[]  = "The range array specifies duplicate entries";
static const char short_gen229[] = "**rangeendinvalid";
static const char long_gen229[]  = "Some element of a range array is either negative or too large";
static const char short_gen230[] = "**rangestartinvalid";
static const char long_gen230[]  = "Some element of a range array is either negative or too large";
static const char short_gen231[] = "**rank";
static const char long_gen231[]  = "Invalid rank";
static const char short_gen232[] = "**rankarray";
static const char long_gen232[]  = "Invalid rank in rank array";
static const char short_gen233[] = "**rankdup";
static const char long_gen233[]  = "Duplicate ranks in rank array ";
static const char short_gen234[] = "**ranklocal";
static const char long_gen234[]  = "Error specifying local_leader ";
static const char short_gen235[] = "**rankremote";
static const char long_gen235[]  = "Error specifying remote_leader ";
static const char short_gen236[] = "**rdma_finalize";
static const char long_gen236[]  = "Channel rdma finalization failed";
static const char short_gen237[] = "**rdma_init";
static const char long_gen237[]  = "Channel rdma initialization failed";
static const char short_gen238[] = "**read_progress";
static const char long_gen238[]  = "Unable to make read progress";
static const char short_gen239[] = "**request";
static const char long_gen239[]  = "Invalid MPI_Request";
static const char short_gen240[] = "**requestnotpersist";
static const char long_gen240[]  = "Request is not persistent in MPI_Start or MPI_Startall.";
static const char short_gen241[] = "**requestpersistactive";
static const char long_gen241[]  = "Persistent request passed to MPI_Start or MPI_Startall is already active.";
static const char short_gen242[] = "**rmaconflict";
static const char long_gen242[]  = "Conflicting accesses to window ";
static const char short_gen243[] = "**rmadisp";
static const char long_gen243[]  = "Invalid displacement argument in RMA call ";
static const char short_gen244[] = "**rmasize";
static const char long_gen244[]  = "Invalid size argument in RMA call";
static const char short_gen245[] = "**rmasync";
static const char long_gen245[]  = "Wrong synchronization of RMA calls ";
static const char short_gen246[] = "**root";
static const char long_gen246[]  = "Invalid root";
static const char short_gen247[] = "**rsendnomatch";
static const char long_gen247[]  = "Ready send had no matching receive ";
static const char short_gen248[] = "**servicename";
static const char long_gen248[]  = "Attempt to lookup an unknown service name ";
static const char short_gen249[] = "**shm_read_progress";
static const char long_gen249[]  = "shared memory read progress failed";
static const char short_gen250[] = "**shmat";
static const char long_gen250[]  = "shmat failed";
static const char short_gen251[] = "**shmconnect_getmem";
static const char long_gen251[]  = "failed to allocate shared memory for a write queue";
static const char short_gen252[] = "**shmget";
static const char long_gen252[]  = "shmget failed";
static const char short_gen253[] = "**shmgetmem";
static const char long_gen253[]  = "Unable to allocate shared memory";
static const char short_gen254[] = "**shmwrite";
static const char long_gen254[]  = "shared memory write failed";
static const char short_gen255[] = "**snprintf";
static const char long_gen255[]  = "snprintf returned an invalid number";
static const char short_gen256[] = "**sock|poll|eqmalloc";
static const char long_gen256[]  = "MPIU_Malloc failed to allocate memory for an event queue structure";
static const char short_gen257[] = "**spawn";
static const char long_gen257[]  = "Error in spawn call";
static const char short_gen258[] = "**stride";
static const char long_gen258[]  = "Range does not terminate";
static const char short_gen259[] = "**stridezero";
static const char long_gen259[]  = "Zero stride is invalid";
static const char short_gen260[] = "**success";
static const char long_gen260[]  = "No MPI error";
static const char short_gen261[] = "**tag";
static const char long_gen261[]  = "Invalid tag";
static const char short_gen262[] = "**toomanycomm";
static const char long_gen262[]  = "Too many communicators";
static const char short_gen263[] = "**topology";
static const char long_gen263[]  = "Invalid topology";
static const char short_gen264[] = "**topotoolarge";
static const char long_gen264[]  = "Topology size is greater than communicator size";
static const char short_gen265[] = "**truncate";
static const char long_gen265[]  = "Message truncated";
static const char short_gen266[] = "**typenamelen";
static const char long_gen266[]  = " Specified datatype name is too long";
static const char short_gen267[] = "**unknown";
static const char long_gen267[]  = "Unknown error.  Please file a bug report.";
static const char short_gen268[] = "**unsupporteddatarep";
static const char long_gen268[]  = "Only native data representation currently supported";
static const char short_gen269[] = "**win";
static const char long_gen269[]  = "Invalid MPI_Win";
static const char short_gen270[] = "**winwait";
static const char long_gen270[]  = "WaitForSingleObject failed";
static const char short_gen271[] = "**write_progress";
static const char long_gen271[]  = "Write progress failed";

static const int generic_msgs_len = 272;
...
static const char short_spc51[] = "**io %s";
static const char long_spc51[]  = "Other I/O error %s";
static const char short_spc52[] = "**msgctl %d";
static const char long_spc52[]  = "msgctl returned %d";
static const char short_spc53[] = "**msgget %d";
static const char long_spc53[]  = "msgget returned %d";
static const char short_spc54[] = "**msgrcv %d";
static const char long_spc54[]  = "msgrcv returned %d";
static const char short_spc55[] = "**msgsnd %d";
static const char long_spc55[]  = "msgsnd returned %d";
static const char short_spc56[] = "**namepublish %s";
static const char long_spc56[]  = "Unable to publish service name %s";
static const char short_spc57[] = "**namepubnotpub %s";
static const char long_spc57[]  = "Lookup failed for service name %s";
static const char short_spc58[] = "**nomem %s";
static const char long_spc58[]  = "Out of memory (unable to allocate a '%s')";
static const char short_spc59[] = "**notsame %s %s";
static const char long_spc59[]  = "Inconsistent arguments %s to collective routine %s";
static const char short_spc60[] = "**nulledge %d %d";
static const char long_spc60[]  = "Edge for node %d (entry edges[%d]) is to itself";
static const char short_spc61[] = "**nullptr %s";
static const char long_spc61[]  = "Null pointer in parameter %s";
static const char short_spc62[] = "**nullptrtype %s";
static const char long_spc62[]  = "Null %s pointer";
static const char short_spc63[] = "**open %s %d %d";
static const char long_spc63[]  = "open(%s) failed for process %d, error %d";
static const char short_spc64[] = "**opnotpredefined %d";
static const char long_spc64[]  = "only predefined ops are valid (op = %d)";
static const char short_spc65[] = "**opundefined %s";
static const char long_spc65[]  = "MPI_Op %s operation not defined for this datatype ";
static const char short_spc66[] = "**opundefined_rma %d";
static const char long_spc66[]  = "RMA target received unknown RMA operation type %d";
static const char short_spc67[] = "**pmi_barrier %d";
static const char long_spc67[]  = "PMI_Barrier returned %d";
static const char short_spc68[] = "**pmi_finalize %d";
static const char long_spc68[]  = "PMI_Finalize returned %d";
static const char short_spc69[] = "**pmi_get_rank %d";
static const char long_spc69[]  = "PMI_Get_rank returned %d";
static const char short_spc70[] = "**pmi_get_size %d";
static const char long_spc70[]  = "PMI_Get_size returned %d";
static const char short_spc71[] = "**pmi_init %d";
static const char long_spc71[]  = "PMI_Init returned %d";
static const char short_spc72[] = "**pmi_kvs_commit %d";
static const char long_spc72[]  = "PMI_KVS_Commit returned %d";
static const char short_spc73[] = "**pmi_kvs_get %d";
static const char long_spc73[]  = "PMI_KVS_Get returned %d";
static const char short_spc74[] = "**pmi_kvs_get_my_name %d";
static const char long_spc74[]  = "PMI_KVS_Get_my_name returned %d";
static const char short_spc75[] = "**pmi_kvs_put %d";
static const char long_spc75[]  = "PMI_KVS_Put returned %d";
static const char short_spc76[] = "**post_connect %s";
static const char long_spc76[]  = "%s failed in VC_post_connect";
static const char short_spc77[] = "**rangedup %d %d %d";
static const char long_spc77[]  = "The range array specifies duplicate entries; process %d specified in range array %d was previously specified in range array %d";
static const char short_spc78[] = "**rangeendinvalid %d %d %d";
static const char long_spc78[]  = "The %dth element of a range array ends at %d but must be nonnegative and less than %d";
static const char short_spc79[] = "**rangestartinvalid %d %d %d";
static const char long_spc79[]  = "The %dth element of a range array starts at %d but must be nonnegative and less than %d";
static const char short_spc80[] = "**rank %d %d";
static const char long_spc80[]  = "Invalid rank has value %d but must be nonnegative and less than %d";
static const char short_spc81[] = "**rankarray %d %d %d";
static const char long_spc81[]  = "Invalid rank in rank array at index %d; value is %d but must be in the range 0 to %d";
static const char short_spc82[] = "**rankdup %d %d %d";
static const char long_spc82[]  = "Duplicate ranks in rank array at index %d, has value %d which is also the value at index %d";
static const char short_spc83[] = "**ranklocal %d %d";
static const char long_spc83[]  = "Error specifying local_leader; rank given was %d but must be in the range 0 to %d";
static const char short_spc84[] = "**rankremote %d %d";
static const char long_spc84[]  = "Error specifying remote_leader; rank given was %d but must be in the range 0 to %d";
static const char short_spc85[] = "**rmasize %d";
static const char long_spc85[]  = "Invalid size argument in RMA call (value is %d)";
static const char short_spc86[] = "**root %d";
static const char long_spc86[]  = "Invalid root (value given was %d)";
static const char short_spc87[] = "**rsendnomatch %d %d";
static const char long_spc87[]  = "Ready send from source %d and with tag %d had no matching receive";
static const char short_spc88[] = "**shmat %d";
static const char long_spc88[]  = "shmat failed, error %d";
static const char short_spc89[] = "**shmget %d";
static const char long_spc89[]  = "shmget failed, error %d";
static const char short_spc90[] = "**snprintf %d";
static const char long_spc90[]  = "snprintf returned %d";
static const char short_spc91[] = "**stride %d %d %d";
static const char long_spc91[]  = "Range (start = %d, end = %d, stride = %d) does not terminate";
static const char short_spc92[] = "**tag %d";
static const char long_spc92[]  = "Invalid tag, value is %d";
static const char short_spc93[] = "**topotoolarge %d %d";
static const char long_spc93[]  = "Topology size %d is larger than communicator size (%d)";
static const char short_spc94[] = "**typenamelen %d";
static const char long_spc94[]  = " Specified datatype name is too long (%d characters)";

static const int specific_msgs_len = 95;
...
260,30,87,94,261,77,231,246,121,203,
263,91,9,267,265,208,149,147,146,239,
103,104,110,86,89,108,109,102,128,129,
135,134,151,185,8,199,112,111,222,114,
115,248,257,90,113,269,19,178,174,242,
245,244,243,14};
#endif
