...
static const char short_gen204[] = "**iofilecorrupt";
static const char long_gen204[]  = "File corrupt";
static const char short_gen205[] = "**iofilenull";
static const char long_gen205[]  = "Null file handle";
static const char short_gen206[] = "**iofiletype";
static const char long_gen206[]  = "Filetype must be constructed out of one or more etypes";
static const char short_gen207[] = "**iofstype";
static const char long_gen207[]  = "Cannot determine filesystem type";
static const char short_gen208[] = "**iofstypeunsupported";
static const char long_gen208[]  = "Specified filesystem is not available";
static const char short_gen209[] = "**ioneedrd";
static const char long_gen209[]  = "Read access is required to this file";
static const char short_gen210[] = "**ionegoffset";
static const char long_gen210[]  = "Negative offset argument";
static const char short_gen211[] = "**iopreallocrdwr";
static const char long_gen211[]  = "Must open file with MPI_MODE_RDWR to preallocate disk space";
static const char short_gen212[] = "**iosequnsupported";
static const char long_gen212[]  = "MPI_MODE_SEQUENTIAL not supported on this file system";
static const char short_gen213[] = "**iosharedfailed";
static const char long_gen213[]  = "Could not access shared file pointer";
static const char short_gen214[] = "**iosharedunsupported";
static const char long_gen214[]  = "Shared file pointers not supported";
static const char short_gen215[] = "**iosplitcoll";
static const char long_gen215[]  = "Only one active split collective I/O operation is allowed per file handle";
static const char short_gen216[] = "**iosplitcollnone";
static const char long_gen216[]  = "No split collective I/O operation is active";
static const char short_gen217[] = "**iov_offset";
static const char long_gen217[]  = "invalid iov offset";
static const char short_gen218[] = "**keyval";
static const char long_gen218[]  = "Invalid keyval";
static const char short_gen219[] = "**keyvalinvalid";
static const char long_gen219[]  = "Attribute key was MPI_KEYVAL_INVALID";
static const char short_gen220[] = "**keyvalnotcomm";
static const char long_gen220[]  = "Keyval was not defined for communicators";
static const char short_gen221[] = "**keyvalnotdatatype";
static const char long_gen221[]  = "Keyval was not defined for datatype";
static const char short_gen222[] = "**keyvalnotwin";
static const char long_gen222[]  = "Keyval was not defined for window objects";
static const char short_gen223[] = "**listen";
static const char long_gen223[]  = "listen failed";
static const char short_gen224[] = "**locktype";
static const char long_gen224[]  = "Invalid locktype";
static const char short_gen225[] = "**mmap";
static const char long_gen225[]  = "unable to map memory, mmap failed";
static const char short_gen226[] = "**mpi_accumulate";
static const char long_gen226[]  = "MPI_Accumulate failed";
static const char short_gen227[] = "**mpi_add_error_string";
static const char long_gen227[]  = "MPI_Add_error_string failed";
static const char short_gen228[] = "**mpi_allgather";
static const char long_gen228[]  = "MPI_Allgather failed";
static const char short_gen229[] = "**mpi_allgatherv";
static const char long_gen229[]  = "MPI_Allgatherv failed";
static const char short_gen230[] = "**mpi_allreduce";
static const char long_gen230[]  = "MPI_Allreduce failed";
static const char short_gen231[] = "**mpi_alltoall";
static const char long_gen231[]  = "MPI_Alltoall failed";
static const char short_gen232[] = "**mpi_alltoallv";
static const char long_gen232[]  = "MPI_Alltoallv failed";
static const char short_gen233[] = "**mpi_alltoallw";
static const char long_gen233[]  = "MPI_Alltoallw failed";
static const char short_gen234[] = "**mpi_attr_delete";
static const char long_gen234[]  = "MPI_Attr_delete failed";
static const char short_gen235[] = "**mpi_attr_get";
static const char long_gen235[]  = "MPI_Attr_get failed";
static const char short_gen236[] = "**mpi_attr_put";
static const char long_gen236[]  = "MPI_Attr_put failed";
static const char short_gen237[] = "**mpi_barrier";
static const char long_gen237[]  = "MPI_Barrier failed";
static const char short_gen238[] = "**mpi_bcast";
static const char long_gen238[]  = "MPI_Bcast failed";
static const char short_gen239[] = "**mpi_bsend";
static const char long_gen239[]  = "MPI_Bsend failed";
static const char short_gen240[] = "**mpi_bsend_init";
static const char long_gen240[]  = "MPI_Bsend_init failed";
static const char short_gen241[] = "**mpi_buffer_attach";
static const char long_gen241[]  = "MPI_Buffer_attach failed";
static const char short_gen242[] = "**mpi_buffer_detach";
static const char long_gen242[]  = "MPI_Buffer_detach failed";
static const char short_gen243[] = "**mpi_cancel";
static const char long_gen243[]  = "MPI_Cancel failed";
static const char short_gen244[] = "**mpi_cart_create";
static const char long_gen244[]  = "MPI_Cart_create failed";
static const char short_gen245[] = "**mpi_close_port";
static const char long_gen245[]  = "MPI_Close_port failed";
static const char short_gen246[] = "**mpi_comm_accept";
static const char long_gen246[]  = "MPI_Comm_accept failed";
static const char short_gen247[] = "**mpi_comm_connect";
static const char long_gen247[]  = "MPI_Comm_connect failed";
static const char short_gen248[] = "**mpi_comm_disconnect";
static const char long_gen248[]  = "MPI_Comm_disconnect failed";
static const char short_gen249[] = "**mpi_comm_dup";
static const char long_gen249[]  = "MPI_Comm_dup failed";
static const char short_gen250[] = "**mpi_comm_free";
static const char long_gen250[]  = "MPI_Comm_free failed";
static const char short_gen251[] = "**mpi_comm_group";
static const char long_gen251[]  = "MPI_Comm_group failed";
static const char short_gen252[] = "**mpi_comm_join";
static const char long_gen252[]  = "MPI_Comm_join failed";
static const char short_gen253[] = "**mpi_comm_remote_group";
static const char long_gen253[]  = "MPI_Comm_remote_group failed";
static const char short_gen254[] = "**mpi_comm_set_attr";
static const char long_gen254[]  = "MPI_Comm_set_attr failed";
static const char short_gen255[] = "**mpi_comm_spawn";
static const char long_gen255[]  = "MPI_Comm_spawn failed";
static const char short_gen256[] = "**mpi_comm_spawn_multiple";
static const char long_gen256[]  = "MPI_Comm_spawn_multiple failed";
static const char short_gen257[] = "**mpi_comm_split";
static const char long_gen257[]  = "MPI_Comm_split failed";
static const char short_gen258[] = "**mpi_errhandler_create";
static const char long_gen258[]  = "MPI_Errhandler_create failed";
static const char short_gen259[] = "**mpi_errhandler_get";
static const char long_gen259[]  = "MPI_Errhandler_get failed";
static const char short_gen260[] = "**mpi_errhandler_set";
static const char long_gen260[]  = "MPI_Errhandler_set failed";
static const char short_gen261[] = "**mpi_exscan";
static const char long_gen261[]  = "MPI_Exscan failed";
static const char short_gen262[] = "**mpi_file_create_errhandler";
static const char long_gen262[]  = "MPI_File_create_errhandler failed";
static const char short_gen263[] = "**mpi_gather";
static const char long_gen263[]  = "MPI_Gather failed";
static const char short_gen264[] = "**mpi_gatherv";
static const char long_gen264[]  = "MPI_Gatherv failed";
static const char short_gen265[] = "**mpi_get";
static const char long_gen265[]  = "MPI_Get failed";
static const char short_gen266[] = "**mpi_get_processor_name";
static const char long_gen266[]  = "MPI_Get_processor_name failed";
static const char short_gen267[] = "**mpi_graph_create";
static const char long_gen267[]  = "MPI_Graph_create failed";
static const char short_gen268[] = "**mpi_graph_map";
static const char long_gen268[]  = "MPI_Graph_map failed";
static const char short_gen269[] = "**mpi_grequest_start";
static const char long_gen269[]  = "MPI_Grequest_start failed";
static const char short_gen270[] = "**mpi_group_difference";
static const char long_gen270[]  = "MPI_Group_difference failed";
static const char short_gen271[] = "**mpi_group_excl";
static const char long_gen271[]  = "MPI_Group_excl failed";
static const char short_gen272[] = "**mpi_group_free";
static const char long_gen272[]  = "MPI_Group_free failed";
static const char short_gen273[] = "**mpi_group_incl";
static const char long_gen273[]  = "MPI_Group_incl failed";
static const char short_gen274[] = "**mpi_group_intersection";
static const char long_gen274[]  = "MPI_Group_intersection failed";
static const char short_gen275[] = "**mpi_group_range_excl";
static const char long_gen275[]  = "MPI_Group_range_excl failed";
static const char short_gen276[] = "**mpi_group_range_incl";
static const char long_gen276[]  = "MPI_Group_range_incl failed";
static const char short_gen277[] = "**mpi_group_union";
static const char long_gen277[]  = "MPI_Group_union failed";
static const char short_gen278[] = "**mpi_ibsend";
static const char long_gen278[]  = "MPI_Ibsend failed";
static const char short_gen279[] = "**mpi_info_create";
static const char long_gen279[]  = "MPI_Info_create failed";
static const char short_gen280[] = "**mpi_info_delete";
static const char long_gen280[]  = "MPI_Info_delete failed";
static const char short_gen281[] = "**mpi_info_dup";
static const char long_gen281[]  = "MPI_Info_dup failed";
static const char short_gen282[] = "**mpi_info_get_nthkey";
static const char long_gen282[]  = "MPI_Info_get_nthkey failed";
static const char short_gen283[] = "**mpi_info_set";
static const char long_gen283[]  = "MPI_Info_set failed";
static const char short_gen284[] = "**mpi_init";
static const char long_gen284[]  = "MPI_Init failed";
static const char short_gen285[] = "**mpi_init_thread";
static const char long_gen285[]  = "MPI_Init_thread failed";
static const char short_gen286[] = "**mpi_intercomm_create";
static const char long_gen286[]  = "MPI_Intercomm_create failed";
static const char short_gen287[] = "**mpi_intercomm_merge";
static const char long_gen287[]  = "MPI_Intercomm_merge failed";
static const char short_gen288[] = "**mpi_iprobe";
static const char long_gen288[]  = "MPI_Iprobe failed";
static const char short_gen289[] = "**mpi_irecv";
static const char long_gen289[]  = "MPI_Irecv failed";
static const char short_gen290[] = "**mpi_irsend";
static const char long_gen290[]  = "MPI_Irsend failed";
static const char short_gen291[] = "**mpi_isend";
static const char long_gen291[]  = "MPI_Isend failed";
static const char short_gen292[] = "**mpi_issend";
static const char long_gen292[]  = "MPI_Issend failed";
static const char short_gen293[] = "**mpi_keyval_create";
static const char long_gen293[]  = "MPI_Keyval_create failed";
static const char short_gen294[] = "**mpi_keyval_free";
static const char long_gen294[]  = "MPI_Keyval_free failed";
static const char short_gen295[] = "**mpi_lookup_name";
static const char long_gen295[]  = "MPI_Lookup_name failed";
static const char short_gen296[] = "**mpi_op_create";
static const char long_gen296[]  = "MPI_Op_create failed";
static const char short_gen297[] = "**mpi_open_port";
static const char long_gen297[]  = "MPI_Open_port failed";
static const char short_gen298[] = "**mpi_pack";
static const char long_gen298[]  = "MPI_Pack failed";
static const char short_gen299[] = "**mpi_pack_external";
static const char long_gen299[]  = "MPI_Pack_external failed";
static const char short_gen300[] = "**mpi_probe";
static const char long_gen300[]  = "MPI_Probe failed";
static const char short_gen301[] = "**mpi_publish_name";
static const char long_gen301[]  = "MPI_Publish_name failed";
static const char short_gen302[] = "**mpi_put";
static const char long_gen302[]  = "MPI_Put failed";
static const char short_gen303[] = "**mpi_recv";
static const char long_gen303[]  = "MPI_Recv failed";
static const char short_gen304[] = "**mpi_recv_init";
static const char long_gen304[]  = "MPI_Recv_init failed";
static const char short_gen305[] = "**mpi_reduce";
static const char long_gen305[]  = "MPI_Reduce failed";
static const char short_gen306[] = "**mpi_reduce_scatter";
static const char long_gen306[]  = "MPI_Reduce_scatter failed";
static const char short_gen307[] = "**mpi_register_datarep";
static const char long_gen307[]  = "MPI_Register_datarep failed";
static const char short_gen308[] = "**mpi_request_free";
static const char long_gen308[]  = "MPI_Request_free failed";
static const char short_gen309[] = "**mpi_request_get_status";
static const char long_gen309[]  = "MPI_Request_get_status failed";
static const char short_gen310[] = "**mpi_rsend";
static const char long_gen310[]  = "MPI_Rsend failed";
static const char short_gen311[] = "**mpi_rsend_init";
static const char long_gen311[]  = "MPI_Rsend_init failed";
static const char short_gen312[] = "**mpi_scan";
static const char long_gen312[]  = "MPI_Scan failed";
static const char short_gen313[] = "**mpi_scatter";
static const char long_gen313[]  = "MPI_Scatter failed";
static const char short_gen314[] = "**mpi_scatterv";
static const char long_gen314[]  = "MPI_Scatterv failed";
static const char short_gen315[] = "**mpi_send";
static const char long_gen315[]  = "MPI_Send failed";
static const char short_gen316[] = "**mpi_send_init";
static const char long_gen316[]  = "MPI_Send_init failed";
static const char short_gen317[] = "**mpi_sendrecv";
static const char long_gen317[]  = "MPI_Sendrecv failed";
static const char short_gen318[] = "**mpi_sendrecv_replace";
static const char long_gen318[]  = "MPI_Sendrecv_replace failed";
static const char short_gen319[] = "**mpi_ssend";
static const char long_gen319[]  = "MPI_Ssend failed";
static const char short_gen320[] = "**mpi_ssend_init";
static const char long_gen320[]  = "MPI_Ssend_init failed";
static const char short_gen321[] = "**mpi_start";
static const char long_gen321[]  = "MPI_Start failed";
static const char short_gen322[] = "**mpi_startall";
static const char long_gen322[]  = "MPI_Start_all failed";
static const char short_gen323[] = "**mpi_test";
static const char long_gen323[]  = "MPI_Test failed";
static const char short_gen324[] = "**mpi_testall";
static const char long_gen324[]  = "MPI_Testall failed";
static const char short_gen325[] = "**mpi_testany";
static const char long_gen325[]  = "MPI_Testany failed";
static const char short_gen326[] = "**mpi_testsome";
static const char long_gen326[]  = "MPI_Testsome failed";
static const char short_gen327[] = "**mpi_type_commit";
static const char long_gen327[]  = "MPI_Type_commit failed";
static const char short_gen328[] = "**mpi_type_contiguous";
static const char long_gen328[]  = "MPI_Type_continuous failed";
static const char short_gen329[] = "**mpi_type_create_hindexed";
static const char long_gen329[]  = "MPI_Type_create_hindexed failed";
static const char short_gen330[] = "**mpi_type_create_hvector";
static const char long_gen330[]  = "MPI_Type_create_hvector failed";
static const char short_gen331[] = "**mpi_type_create_indexed_block";
static const char long_gen331[]  = "MPI_Type_create_indexed_block failed";
static const char short_gen332[] = "**mpi_type_create_keyval";
static const char long_gen332[]  = "MPI_Type_create_keyval failed";
static const char short_gen333[] = "**mpi_type_create_resized";
static const char long_gen333[]  = "MPI_Type_create_resized failed";
static const char short_gen334[] = "**mpi_type_create_struct";
static const char long_gen334[]  = "MPI_Type_create_struct failed";
static const char short_gen335[] = "**mpi_type_delete_attr";
static const char long_gen335[]  = "MPI_Type_delete_attr failed";
static const char short_gen336[] = "**mpi_type_dup";
static const char long_gen336[]  = "MPI_Type_dup failed";
static const char short_gen337[] = "**mpi_type_get_contents";
static const char long_gen337[]  = "MPI_Type_get_contents failed";
static const char short_gen338[] = "**mpi_type_get_envelope";
static const char long_gen338[]  = "MPI_Type_get_envelope failed";
static const char short_gen339[] = "**mpi_type_hindexed";
static const char long_gen339[]  = "MPI_Type_hindexed failed";
static const char short_gen340[] = "**mpi_type_hvector";
static const char long_gen340[]  = "MPI_Type_hvector failed";
static const char short_gen341[] = "**mpi_type_indexed";
static const char long_gen341[]  = "MPI_Type_indexed failed";
static const char short_gen342[] = "**mpi_type_match_size";
static const char long_gen342[]  = "MPI_Type_match_size failed";
static const char short_gen343[] = "**mpi_type_set_attr";
static const char long_gen343[]  = "MPI_Type_set_attr failed";
static const char short_gen344[] = "**mpi_type_struct";
static const char long_gen344[]  = "MPI_Type_struct failed";
static const char short_gen345[] = "**mpi_type_vector";
static const char long_gen345[]  = "MPI_Type_vector failed";
static const char short_gen346[] = "**mpi_unpack_external";
static const char long_gen346[]  = "MPI_Unpack_external failed";
static const char short_gen347[] = "**mpi_unpublish_name";
static const char long_gen347[]  = "MPI_Unpublish_name failed";
static const char short_gen348[] = "**mpi_wait";
static const char long_gen348[]  = "MPI_Wait failed";
static const char short_gen349[] = "**mpi_waitall";
static const char long_gen349[]  = "MPI_Waitall failed";
static const char short_gen350[] = "**mpi_waitany";
static const char long_gen350[]  = "MPI_Waitany failed";
static const char short_gen351[] = "**mpi_waitsome";
static const char long_gen351[]  = "MPI_Waitsome failed";
static const char short_gen352[] = "**mpi_win_complete";
static const char long_gen352[]  = "MPI_Win_complete failed";
static const char short_gen353[] = "**mpi_win_create";
static const char long_gen353[]  = "MPI_Win_create failed";
static const char short_gen354[] = "**mpi_win_create_errhandler";
static const char long_gen354[]  = "MPI_Win_create_errhandler failed";
static const char short_gen355[] = "**mpi_win_create_keyval";
static const char long_gen355[]  = "MPI_Win_create_keyval failed";
static const char short_gen356[] = "**mpi_win_delete_attr";
static const char long_gen356[]  = "MPI_Win_delete_attr failed";
static const char short_gen357[] = "**mpi_win_fence";
static const char long_gen357[]  = "MPI_Win_fence failed";
static const char short_gen358[] = "**mpi_win_free";
static const char long_gen358[]  = "MPI_Win_free failed";
static const char short_gen359[] = "**mpi_win_get_group";
static const char long_gen359[]  = "MPI_Win_get_group failed";
static const char short_gen360[] = "**mpi_win_lock";
static const char long_gen360[]  = "MPI_Win_lock failed";
static const char short_gen361[] = "**mpi_win_post";
static const char long_gen361[]  = "MPI_Win_post failed";
static const char short_gen362[] = "**mpi_win_set_attr";
static const char long_gen362[]  = "MPI_Win_set_attr failed";
static const char short_gen363[] = "**mpi_win_test";
static const char long_gen363[]  = "MPI_Win_test failed";
static const char short_gen364[] = "**mpi_win_unlock";
static const char long_gen364[]  = "MPI_Win_unlock failed";
static const char short_gen365[] = "**mpi_win_wait";
static const char long_gen365[]  = "MPI_Win_wait failed";
static const char short_gen366[] = "**mq_close";
static const char long_gen366[]  = "failed to close a posix message queue";
static const char short_gen367[] = "**mq_open";
static const char long_gen367[]  = "failed to open a posix message queue";
static const char short_gen368[] = "**mq_receive";
static const char long_gen368[]  = "failed to receive a posix message queue message";
static const char short_gen369[] = "**mq_send";
static const char long_gen369[]  = "failed to send a posix message queue message";
static const char short_gen370[] = "**mqp_failure";
static const char long_gen370[]  = "failed to make progress on the shared memory bootstrap message queue";
static const char short_gen371[] = "**mqshm_create";
static const char long_gen371[]  = "failed to create a shared memory message queue";
static const char short_gen372[] = "**mqshm_receive";
static const char long_gen372[]  = "failed to receive a bootstrap message";
static const char short_gen373[] = "**mqshm_send";
static const char long_gen373[]  = "failed to send a bootstrap message";
static const char short_gen374[] = "**mqshm_unlink";
static const char long_gen374[]  = "unable to unlink the shared memory message queue";
static const char short_gen375[] = "**msgctl";
static const char long_gen375[]  = "msgctl failed";
static const char short_gen376[] = "**msgget";
static const char long_gen376[]  = "msgget failed";
static const char short_gen377[] = "**msgrcv";
static const char long_gen377[]  = "msgrcv failed";
static const char short_gen378[] = "**msgsnd";
static const char long_gen378[]  = "msgsnd failed";
static const char short_gen379[] = "**multi_post_read";
static const char long_gen379[]  = "posting a read while a previously posted read is outstanding";
static const char short_gen380[] = "**multi_post_write";
static const char long_gen380[]  = "posting a write while a previously posted write is outstanding";
static const char short_gen381[] = "**namepubfile";
static const char long_gen381[]  = "Unable to publish service name";
static const char short_gen382[] = "**namepubnotpub";
static const char long_gen382[]  = "Lookup failed for service name ";
static const char short_gen383[] = "**nameservice";
static const char long_gen383[]  = "Invalid service name (see MPI_Publish_name)";
static const char short_gen384[] = "**needthreads";
static const char long_gen384[]  = "This function needs threads and threads have not been enabled";
static const char short_gen385[] = "**nextbootmsg";
static const char long_gen385[]  = "failed to get the next bootstrap message";
static const char short_gen386[] = "**noca";
static const char long_gen386[]  = "unable to find an active infiniband channel adapter";
static const char short_gen387[] = "**noerrclasses";
static const char long_gen387[]  = "No more user-defined error classes";
static const char short_gen388[] = "**noerrcodes";
static const char long_gen388[]  = "No more user-defined error codes";
static const char short_gen389[] = "**nomem";
static const char long_gen389[]  = "Out of memory";
static const char short_gen390[] = "**nomemreq";
static const char long_gen390[]  = "failure occurred while allocating memory for a request object";
static const char short_gen391[] = "**nonamepub";
static const char long_gen391[]  = "No name publishing service available";
static const char short_gen392[] = "**notcarttopo";
static const char long_gen392[]  = "No Cartesian topology associated with this communicator";
static const char short_gen393[] = "**notcstatignore";
static const char long_gen393[]  = "MPI_STATUS_IGNORE cannot be passed to MPI_Status_c2f()";
static const char short_gen394[] = "**notfstatignore";
static const char long_gen394[]  = "MPI_STATUS_IGNORE cannot be passed to MPI_Status_f2c()";
static const char short_gen395[] = "**notgenreq";
static const char long_gen395[]  = "Attempt to complete a request with MPI_GREQUEST_COMPLETE that was not started with MPI_GREQUEST_START";
static const char short_gen396[] = "**notgraphtopo";
static const char long_gen396[]  = "No Graph topology associated with this communicator";
static const char short_gen397[] = "**notimpl";
static const char long_gen397[]  = "Function not implemented";
static const char short_gen398[] = "**notopology";
static const char long_gen398[]  = "No topology associated with this communicator";
static const char short_gen399[] = "**notsame";
static const char long_gen399[]  = "Inconsistent arguments to collective routine ";
static const char short_gen400[] = "**nulledge";
static const char long_gen400[]  = "Edge detected from a node to the same node";
static const char short_gen401[] = "**nullptr";
static const char long_gen401[]  = "Null pointer";
static const char short_gen402[] = "**nullptrtype";
static const char long_gen402[]  = "Null pointer";
static const char short_gen403[] = "**op";
static const char long_gen403[]  = "Invalid MPI_Op";
static const char short_gen404[] = "**open";
static const char long_gen404[]  = "open failed";
static const char short_gen405[] = "**opnotpredefined";
static const char long_gen405[]  = "only predefined ops are valid";
static const char short_gen406[] = "**opundefined";
static const char long_gen406[]  = "MPI_Op operation not defined for this datatype ";
static const char short_gen407[] = "**opundefined_rma";
static const char long_gen407[]  = "RMA target received unknown RMA operation";
static const char short_gen408[] = "**other";
static const char long_gen408[]  = "Other MPI error";
static const char short_gen409[] = "**pctwice";
static const char long_gen409[]  = "post connect called twice";
static const char short_gen410[] = "**pd_alloc";
static const char long_gen410[]  = "unable to allocate a protection domain";
static const char short_gen411[] = "**permattr";
static const char long_gen411[]  = "Cannot set permanent attribute";
static const char short_gen412[] = "**permop";
static const char long_gen412[]  = "Cannot free permanent MPI_Op ";
static const char short_gen413[] = "**pfinal_sockclose";
static const char long_gen413[]  = "sock_close failed";
static const char short_gen414[] = "**pkt_ptr";
static const char long_gen414[]  = "invalid shm queue packet pointer";
static const char short_gen415[] = "**pkt_type";
static const char long_gen415[]  = "invalid packet type";
static const char short_gen416[] = "**pmi_barrier";
static const char long_gen416[]  = "PMI_Barrier failed";
static const char short_gen417[] = "**pmi_finalize";
static const char long_gen417[]  = "PMI_Finalize failed";
static const char short_gen418[] = "**pmi_get_id";
static const char long_gen418[]  = "PMI_Get_id failed";
static const char short_gen419[] = "**pmi_get_id_length_max";
static const char long_gen419[]  = "PMI_Get_id_length_max failed";
static const char short_gen420[] = "**pmi_get_rank";
static const char long_gen420[]  = "PMI_Get_rank failed";
static const char short_gen421[] = "**pmi_get_size";
static const char long_gen421[]  = "PMI_Get_size failed";
static const char short_gen422[] = "**pmi_init";
static const char long_gen422[]  = "PMI_Init failed";
static const char short_gen423[] = "**pmi_kvs_commit";
static const char long_gen423[]  = "PMI_KVS_Commit failed";
static const char short_gen424[] = "**pmi_kvs_create";
static const char long_gen424[]  = "PMI_KVS_Create failed";
static const char short_gen425[] = "**pmi_kvs_get";
static const char long_gen425[]  = "PMI_KVS_Get failed";
static const char short_gen426[] = "**pmi_kvs_get_key_length_max";
static const char long_gen426[]  = "PMI_KVS_Get_key_length_max failed";
static const char short_gen427[] = "**pmi_kvs_get_my_name";
static const char long_gen427[]  = "PMI_KVS_Get_my_name failed";
static const char short_gen428[] = "**pmi_kvs_get_name_length_max";
static const char long_gen428[]  = "PMI_KVS_Get_name_length_max failed";
static const char short_gen429[] = "**pmi_kvs_get_value_length_max";
static const char long_gen429[]  = "PMI_KVS_Get_value_length_max failed";
static const char short_gen430[] = "**pmi_kvs_put";
static const char long_gen430[]  = "PMI_KVS_Put failed";
static const char short_gen431[] = "**pmi_spawn_multiple";
static const char long_gen431[]  = "PMI_Spawn_multiple failed";
static const char short_gen432[] = "**poke";
static const char long_gen432[]  = "progress_poke failed";
static const char short_gen433[] = "**port";
static const char long_gen433[]  = "Invalid port";
static const char short_gen434[] = "**post_accept";
static const char long_gen434[]  = "post accept failed";
static const char short_gen435[] = "**post_connect";
static const char long_gen435[]  = "failed to post a connection";
static const char short_gen436[] = "**post_sock_write_on_shm";
static const char long_gen436[]  = "posting a socket read on a shm connection";
...
static const char short_spc49[] = "**fail %s";
static const char long_spc49[]  = "failure - %s";
static const char short_spc50[] = "**fileaccess %s";
static const char long_spc50[]  = "Access denied to file %s";
static const char short_spc51[] = "**filenamedir %s";
static const char long_spc51[]  = "Invalid or missing directory %s";
static const char short_spc52[] = "**filenamelong %s %d";
static const char long_spc52[]  = "Pathname %s too long (%d characters)";
static const char short_spc53[] = "**filenoexist %s";
static const char long_spc53[]  = "File %s does not exist";
static const char short_spc54[] = "**filerdonly %s";
static const char long_spc54[]  = "Read-only file or filesystem name %s";
static const char short_spc55[] = "**ftok %s %d %d";
static const char long_spc55[]  = "failed to create a sysv key from the file '%s' and id %d, error %d";
static const char short_spc56[] = "**ftruncate %s %d %d";
static const char long_spc56[]  = "unable to resize the shared memory object %s to size %d (errno %d)";
static const char short_spc57[] = "**gethostbyname %d";
static const char long_spc57[]  = "gethostbyname failed (errno %d)";
static const char short_spc58[] = "**getinfo %d";
static const char long_spc58[]  = "getaddrinfo failed (errno %d)";
static const char short_spc59[] = "**groupnotincomm %d";
static const char long_spc59[]  = "Rank %d of the specified group is not a member of this communicator";
static const char short_spc60[] = "**hostlookup %d %d %s";
static const char long_spc60[]  = "Host lookup failed for process group %d, rank %d, business card <%s>";
static const char short_spc61[] = "**ibu_op %d";
static const char long_spc61[]  = "invalid infiniband operation (%d)";
static const char short_spc62[] = "**ibu_wait %d";
static const char long_spc62[]  = "ibu_wait failed (errno %d)";
static const char short_spc63[] = "**indexneg %d %d";
static const char long_spc63[]  = "Index value for index[%d] is %d but must be nonnegative";
static const char short_spc64[] = "**indexnonmonotone %d %d %d";
static const char long_spc64[]  = "Index values in graph topology must be monotone nondecreasing but index[%d] is %d but the next index value is %d";
static const char short_spc65[] = "**infonkey %d %d";
static const char long_spc65[]  = "Requested key %d but this MPI_Info only has %d keys";
static const char short_spc66[] = "**infonokey %s";
static const char long_spc66[]  = "MPI_Info key %s is not defined ";
...
static const char short_spc76[] = "**mpi_accumulate %p %d %D %d %d %d %D %O %W";
static const char long_spc76[]  = "MPI_Accumulate(%p, %d, %D, %d, %d, %d, %D, %O, %W) failed";
static const char short_spc77[] = "**mpi_add_error_string %d %s";
static const char long_spc77[]  = "MPI_Add_error_string(code=%d, str=\"%s\") failed";
static const char short_spc78[] = "**mpi_allgather %p %d %D %p %d %D %C";
static const char long_spc78[]  = "MPI_Allgather(sbuf=%p, scount=%d, %D, rbuf=%p, rcount=%d, %D, %C) failed";
static const char short_spc79[] = "**mpi_allgatherv %p %d %D %p %p %p %D %C";
static const char long_spc79[]  = "MPI_Allgatherv(sbuf=%p, scount=%d, %D, rbuf=%p, rcounts=%p, displs=%p, %D, %C) failed";
static const char short_spc80[] = "**mpi_allreduce %p %p %d %D %O %C";
static const char long_spc80[]  = "MPI_Allreduce(sbuf=%p, rbuf=%p, count=%d, %D, %O, %C) failed";
static const char short_spc81[] = "**mpi_alltoall %p %d %D %p %d %D %C";
static const char long_spc81[]  = "MPI_Alltoall(sbuf=%p, scount=%d, %D, rbuf=%p, rcount=%d, %D, %C) failed";
static const char short_spc82[] = "**mpi_alltoallv %p %p %p %D %p %p %p %D %C";
static const char long_spc82[]  = "MPI_Alltoallv(sbuf=%p, scnts=%p, sdispls=%p, %D, rbuf=%p, rcnts=%p, rdispls=%p, %D, %C) failed";
static const char short_spc83[] = "**mpi_alltoallw %p %p %p %p %p %p %p %p %C";
static const char long_spc83[]  = "MPI_Alltoallw(sbuf=%p, scnts=%p, sdispls=%p, stypes=%p, rbuf=%p, rcnts=%p, rdispls=%p, rtypes=%p, %C) failed";
static const char short_spc84[] = "**mpi_attr_delete %C %d";
static const char long_spc84[]  = "MPI_Attr_delete(%C, %d) failed";
static const char short_spc85[] = "**mpi_attr_get %C %d %p %p";
static const char long_spc85[]  = "MPI_Atr_get(%C, %d, %p, %p) failed";
static const char short_spc86[] = "**mpi_attr_put %C %d %p";
static const char long_spc86[]  = "MPI_Attr_put(%C, %d, %p) failed";
static const char short_spc87[] = "**mpi_barrier %C";
static const char long_spc87[]  = "MPI_Barrier(%C) failed";
static const char short_spc88[] = "**mpi_bcast %p %d %D %d %C";
static const char long_spc88[]  = "MPI_Bcast(buf=%p, count=%d, %D, root=%d, %C) failed";
static const char short_spc89[] = "**mpi_bsend %p %d %D %d %d %C";
static const char long_spc89[]  = "MPI_Bsend(buf=%p, count=%d, %D, dest=%d, tag=%d, %C) failed";
static const char short_spc90[] = "**mpi_bsend_init %p %d %D %d %d %C %p";
static const char long_spc90[]  = "MPI_Bsend_init(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc91[] = "**mpi_buffer_attach %p %d";
static const char long_spc91[]  = "MPI_Buffer_attach(buf=%p, size=%d) failed";
static const char short_spc92[] = "**mpi_buffer_detach %p %p";
static const char long_spc92[]  = "MPI_Buffer_detach(buf=%p, size=%p) failed";
static const char short_spc93[] = "**mpi_cancel %p";
static const char long_spc93[]  = "MPI_Cancel(request=%p) failed";
static const char short_spc94[] = "**mpi_cart_create %C %d %p %p %d %p";
static const char long_spc94[]  = "MPI_Cart_create(%C, %d, %p, %p, %d, %p) failed";
static const char short_spc95[] = "**mpi_close_port %s";
static const char long_spc95[]  = "MPI_Close_port(port=\"%s\") failed";
static const char short_spc96[] = "**mpi_comm_accept %s %I %d %C %p";
static const char long_spc96[]  = "MPI_Comm_accept(port=\"%s\", %I, root=%d, %C, newcomm=%p) failed";
static const char short_spc97[] = "**mpi_comm_connect %s %I %d %C %p";
static const char long_spc97[]  = "MPI_Comm_connect(port=\"%s\", %I, root=%d, %C, newcomm=%p) failed";
static const char short_spc98[] = "**mpi_comm_disconnect %p";
static const char long_spc98[]  = "MPI_Comm_disconnect(comm=%p) failed";
static const char short_spc99[] = "**mpi_comm_dup %C %p";
static const char long_spc99[]  = "MPI_Comm_dup(%C, %p) failed";
static const char short_spc100[] = "**mpi_comm_free %p";
static const char long_spc100[]  = "MPI_Comm_free(%p) failed";
static const char short_spc101[] = "**mpi_comm_group %C %p";
static const char long_spc101[]  = "MPI_Comm_group(%C, %p) failed";
static const char short_spc102[] = "**mpi_comm_join %d %p";
static const char long_spc102[]  = "MPI_Comm_join(fd=%d, intercomm=%p) failed";
static const char short_spc103[] = "**mpi_comm_remote_group %C %p";
static const char long_spc103[]  = "MPI_Comm_remote_group(%C, %p) failed";
static const char short_spc104[] = "**mpi_comm_set_attr %C %d %p";
static const char long_spc104[]  = "MPI_Comm_set_attr(%C, %d, %p) failed";
static const char short_spc105[] = "**mpi_comm_spawn %s %p %d %I %d %C %p %p";
static const char long_spc105[]  = "MPI_Comm_spawn(cmd=\"%s\", argv=%p, maxprocs=%d, %I, root=%d, %C, intercomm=%p, errors=%p) failed";
static const char short_spc106[] = "**mpi_comm_spawn_multiple %d %p %p %p %p %d %C %p %p";
static const char long_spc106[]  = "MPI_Comm_spawn_multiple(count=%d, cmds=%p, argvs=%p, maxprocs=%p, infos=%p, root=%d, %C, intercomm=%p, errors=%p) failed";
static const char short_spc107[] = "**mpi_comm_split %C %d %d %p";
static const char long_spc107[]  = "MPI_Comm_split(%C, %d, %d, %p) failed";
static const char short_spc108[] = "**mpi_errhandler_create %p %p";
static const char long_spc108[]  = "MPI_Errhandler_create(%p) failed";
static const char short_spc109[] = "**mpi_errhandler_get %C %p";
static const char long_spc109[]  = "MPI_Errhandler_get(%C, %p) failed";
static const char short_spc110[] = "**mpi_errhandler_set %C %E";
static const char long_spc110[]  = "MPI_Errhandler_set(%C, %E) failed";
static const char short_spc111[] = "**mpi_exscan %p %p %d %D %O %C";
static const char long_spc111[]  = "MPI_Exscan(sbuf=%p, rbuf=%p, count=%d, %D, %O, %C) failed";
static const char short_spc112[] = "**mpi_file_create_errhandler %p %p";
static const char long_spc112[]  = "MPI_File_create_errhandler(%p, %p) failed";
static const char short_spc113[] = "**mpi_gather %p %d %D %p %d %D %d %C";
static const char long_spc113[]  = "MPI_Gather(sbuf=%p, scount=%d, %D, rbuf=%p, rcount=%d, %D, root=%d, %C) failed";
static const char short_spc114[] = "**mpi_gatherv %p %d %D %p %p %p %D %d %C";
static const char long_spc114[]  = "MPI_Gatherv failed(sbuf=%p, scount=%d, %D, rbuf=%p, rcnts=%p, displs=%p, %D, root=%d, %C) failed";
static const char short_spc115[] = "**mpi_get %p %d %D %d %d %d %D %W";
static const char long_spc115[]  = "MPI_Get(%p, %d, %D, %d, %d, %d, %D, %W) failed";
static const char short_spc116[] = "**mpi_get_processor_name %p %p";
static const char long_spc116[]  = "MPI_Get_processor_name(%p, %p) failed";
static const char short_spc117[] = "**mpi_graph_create %C %d %p %p %d %p";
static const char long_spc117[]  = "MPI_Graph_create(%C, %d, %p, %p, %d, %p) failed";
static const char short_spc118[] = "**mpi_graph_map %C %d %p %p %p";
static const char long_spc118[]  = "MPI_Graph_map(%C, %d, %p, %p, %p) failed";
static const char short_spc119[] = "**mpi_grequest_start %p %p %p %p %p";
static const char long_spc119[]  = "MPI_Grequest_start(%p, %p, %p, %p, %p) failed";
static const char short_spc120[] = "**mpi_group_difference %G %G %p";
static const char long_spc120[]  = "MPI_Group_difference(%G, %G, %p) failed";
static const char short_spc121[] = "**mpi_group_excl %G %d %p %p";
static const char long_spc121[]  = "MPI_Group_excl(%G, %d, %p, %p) failed";
static const char short_spc122[] = "**mpi_group_free %p";
static const char long_spc122[]  = "MPI_Group_free(%p) failed";
static const char short_spc123[] = "**mpi_group_incl %G %d %p %p";
static const char long_spc123[]  = "MPI_Group_incl(%G, %d, %p, %p) failed";
static const char short_spc124[] = "**mpi_group_intersection %G %G %p";
static const char long_spc124[]  = "MPI_Group_intersection(%G, %G, %p) failed";
static const char short_spc125[] = "**mpi_group_range_excl %G %d %p %p";
static const char long_spc125[]  = "MPI_Group_range_excl(%G, %d, %p, %p) failed";
static const char short_spc126[] = "**mpi_group_range_incl %G %d %p %p";
static const char long_spc126[]  = "MPI_Group_range_incl(%G, %d, %p, %p) failed";
static const char short_spc127[] = "**mpi_group_union %G %G %p";
static const char long_spc127[]  = "MPI_Group_union(%G, %G, %p) failed";
static const char short_spc128[] = "**mpi_ibsend %p %d %D %d %d %C %p";
static const char long_spc128[]  = "MPI_Ibsend(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc129[] = "**mpi_info_create %p";
static const char long_spc129[]  = "MPI_Info_create(%p) failed";
static const char short_spc130[] = "**mpi_info_delete %I %p";
static const char long_spc130[]  = "MPI_Info_delete(%I, %p) failed";
static const char short_spc131[] = "**mpi_info_dup %I %p";
static const char long_spc131[]  = "MPI_Info_dup(%I, %p) failed";
static const char short_spc132[] = "**mpi_info_get_nthkey %I %d %p";
static const char long_spc132[]  = "MPI_Info_get_nthkey(%I, %d, %p) failed";
static const char short_spc133[] = "**mpi_info_set %I %p %p";
static const char long_spc133[]  = "MPI_Info_set(%I, %p, %p) failed";
static const char short_spc134[] = "**mpi_init %p %p";
static const char long_spc134[]  = "MPI_Init(%p, %p) failed";
static const char short_spc135[] = "**mpi_init_thread %p %p %d %p";
static const char long_spc135[]  = "MPI_Init_thread(%p, %p, %d, %p)";
static const char short_spc136[] = "**mpi_intercomm_create %C %d %C %d %d %p";
static const char long_spc136[]  = "MPI_Intercomm_create(%C, %d, %C, %d, %d, %p) failed";
static const char short_spc137[] = "**mpi_intercomm_merge %C %d %p";
static const char long_spc137[]  = "MPI_Intercomm_merge(%C, %d, %p) failed";
static const char short_spc138[] = "**mpi_iprobe %d %d %C %p %p";
static const char long_spc138[]  = "MPI_Iprobe(src=%d, tag=%d, %C, flag=%p, status=%p) failed";
static const char short_spc139[] = "**mpi_irecv %p %d %D %d %d %C %p";
static const char long_spc139[]  = "MPI_Irecv(buf=%p, count=%d, %D, src=%d, tag=%d, %C, request=%p) failed";
static const char short_spc140[] = "**mpi_irsend %p %d %D %d %d %C %p";
static const char long_spc140[]  = "MPI_Irsend(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc141[] = "**mpi_isend %p %d %D %d %d %C %p";
static const char long_spc141[]  = "MPI_Isend(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc142[] = "**mpi_issend %p %d %D %d %d %C %p";
static const char long_spc142[]  = "MPI_Issend(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc143[] = "**mpi_keyval_create %p %p %p %p";
static const char long_spc143[]  = "MPI_Keyval_create(%p, %p, %p, %p) failed";
static const char short_spc144[] = "**mpi_keyval_free %p";
static const char long_spc144[]  = "MPI_Keyval_free(%p) failed";
static const char short_spc145[] = "**mpi_lookup_name %s %I %p";
static const char long_spc145[]  = "MPI_Lookup_name(service=\"%s\", %I, port=%p) failed";
static const char short_spc146[] = "**mpi_op_create %p %d %p";
static const char long_spc146[]  = "MPI_Op_create(fn=%p, commute=%d, op=%p) failed";
static const char short_spc147[] = "**mpi_open_port %I %p";
static const char long_spc147[]  = "MPI_Open_port(%I, port=%p) failed";
static const char short_spc148[] = "**mpi_pack %p %d %D %p %d %p %C";
static const char long_spc148[]  = "MPI_Pack(inbuf=%p, incount=%d, %D, outbuf=%p, outcount=%d, position=%p, %C) failed";
static const char short_spc149[] = "**mpi_pack_external %s %p %d %D %p %d %p";
static const char long_spc149[]  = "MPI_Pack_external(%s, %p, %d, %D, %p, %d, %p) failed";
static const char short_spc150[] = "**mpi_probe %d %d %C %p";
static const char long_spc150[]  = "MPI_Probe(src=%d, tag=%d, %C, status=%p) failed";
static const char short_spc151[] = "**mpi_publish_name %s %I %s";
static const char long_spc151[]  = "MPI_Publish_name(service=\"%s\", %I, port=\"%s\") failed";
static const char short_spc152[] = "**mpi_put %p %d %D %d %d %d %D %W";
static const char long_spc152[]  = "MPI_Put(%p, %d, %D, %d, %d, %d, %D, %W) failed";
static const char short_spc153[] = "**mpi_recv %p %d %D %d %d %C %p";
static const char long_spc153[]  = "MPI_Recv(buf=%p, count=%d, %D, src=%d, %C, status=%p) failed";
static const char short_spc154[] = "**mpi_recv_init %p %d %D %d %d %C %p";
static const char long_spc154[]  = "MPI_Recv_init(buf=%p, count=%d, %D, src=%d, tag=%d, %C, request=%p) failed";
static const char short_spc155[] = "**mpi_reduce %p %p %d %D %O %d %C";
static const char long_spc155[]  = "MPI_Reduce(sbuf=%p, rbuf=%p, count=%d, %D, %O, root=%d, %C) failed";
static const char short_spc156[] = "**mpi_reduce_scatter %p %p %p %D %O %C";
static const char long_spc156[]  = "MPI_Reduce_scatter(sbuf=%p, rbuf=%p, rcnts=%p, %D, %O, %C) failed";
static const char short_spc157[] = "**mpi_register_datarep %s %p %p %p %p";
static const char long_spc157[]  = "MPI_Register_Datarep(%s %p %p %p %p) failed";
static const char short_spc158[] = "**mpi_request_free %p";
static const char long_spc158[]  = "MPI_Request_free(request=%p) failed";
static const char short_spc159[] = "**mpi_request_get_status %R %p %p";
static const char long_spc159[]  = "MPI_Request_get_status(%R, %p, %p) failed";
static const char short_spc160[] = "**mpi_rsend %p %d %D %d %d %C";
static const char long_spc160[]  = "MPI_Rsend(buf=%p, count=%d, %D, src=%d, tag=%d, %C) failed";
static const char short_spc161[] = "**mpi_rsend_init %p %d %D %d %d %C %p";
static const char long_spc161[]  = "MPI_Rsend_init(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc162[] = "**mpi_scan %p %p %d %D %O %C";
static const char long_spc162[]  = "MPI_Scan(sbuf=%p, rbuf=%p, count=%d, %D, %O, %C) failed";
static const char short_spc163[] = "**mpi_scatter %p %d %D %p %d %D %d %C";
static const char long_spc163[]  = "MPI_Scatter(sbuf=%p, scount=%d, %D, rbuf=%p, rcount=%d, %D, root=%d, %C) failed";
static const char short_spc164[] = "**mpi_scatterv %p %p %p %D %p %d %D %d %C";
static const char long_spc164[]  = "MPI_Scatterv(sbuf=%p, scnts=%p, displs=%p, %D, rbuf=%p, rcount=%d, %D, root=%d, %C) failed";
static const char short_spc165[] = "**mpi_send %p %d %D %d %d %C";
static const char long_spc165[]  = "MPI_Send(buf=%p, count=%d, %D, dest=%d, tag=%d, %C) failed";
static const char short_spc166[] = "**mpi_send_init %p %d %D %d %d %C %p";
static const char long_spc166[]  = "MPI_Send_init(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc167[] = "**mpi_sendrecv %p %d %D %d %d %p %d %D %d %d %C %p";
static const char long_spc167[]  = "MPI_Sendrecv(sbuf=%p, scount=%d, %D, dest=%d, stag=%d, rbuf=%p, rcount=%d, %D, src=%d, rtag=%d, %C, status=%p) failed";
static const char short_spc168[] = "**mpi_sendrecv_replace %p %d %D %d %d %d %d %C %p";
static const char long_spc168[]  = "MPI_Sendrecv_replace(buf=%p, count=%d, %D, dest=%d, stag=%d, src=%d, rtag=%d, %C, status=%p) failed";
static const char short_spc169[] = "**mpi_ssend %p %d %D %d %d %C";
static const char long_spc169[]  = "MPI_Ssend(buf=%p, count=%d, %D, dest=%d, tag=%d, %C) failed";
static const char short_spc170[] = "**mpi_ssend_init %p %d %D %d %d %C %p";
static const char long_spc170[]  = "MPI_Ssend_init(buf=%p, count=%d, %D, dest=%d, tag=%d, %C, request=%p) failed";
static const char short_spc171[] = "**mpi_start %p";
static const char long_spc171[]  = "MPI_Start(request=%p) failed";
static const char short_spc172[] = "**mpi_startall %d %p";
static const char long_spc172[]  = "MPI_Startall(count=%d, req_array=%p) failed";
static const char short_spc173[] = "**mpi_test %p %p %p";
static const char long_spc173[]  = "MPI_Test(request=%p, flag=%p, status=%p) failed";
static const char short_spc174[] = "**mpi_testall %d %p %p %p";
static const char long_spc174[]  = "MPI_Testall(count=%d, req_array=%p, flag=%p, status_array=%p) failed";
static const char short_spc175[] = "**mpi_testany %d %p %p %p %p";
static const char long_spc175[]  = "MPI_Testany(count=%d, req_array=%p, index=%p, flag=%p, status=%p) failed";
static const char short_spc176[] = "**mpi_testsome %d %p %p %p %p";
static const char long_spc176[]  = "MPI_Testsome(count=%d, req_array=%p, out_count=%p, indices=%p, status_array=%p) failed";
static const char short_spc177[] = "**mpi_type_commit %p";
static const char long_spc177[]  = "MPI_Type_commit(%p) failed";
static const char short_spc178[] = "**mpi_type_contiguous %d %D %p";
static const char long_spc178[]  = "MPI_Type_contiguous(%d, %D, %p) failed";
static const char short_spc179[] = "**mpi_type_create_hindexed %d %p %p %D %p";
static const char long_spc179[]  = "MPI_Type_create_hindexed(%d, %p, %p, %D, %p) failed";
static const char short_spc180[] = "**mpi_type_create_hvector %d %d %d %D %p";
static const char long_spc180[]  = "MPI_Type_create_hvector(%d, %d, %d, %D, %p) failed";
static const char short_spc181[] = "**mpi_type_create_indexed_block %d %d %p %D %p";
static const char long_spc181[]  = "MPI_Type_create_indexed_block(%d, %d, %p, %D, %p) failed";
static const char short_spc182[] = "**mpi_type_create_keyval %p %p %p %p";
static const char long_spc182[]  = "MPI_Type_create_keyval(%p, %p, %p, %p) failed";
static const char short_spc183[] = "**mpi_type_create_resized %D %d %d %p";
static const char long_spc183[]  = "MPI_Type_create_resized(%D, %d, %d, %p) failed";
static const char short_spc184[] = "**mpi_type_create_struct %d %p %p %p %p";
static const char long_spc184[]  = "MPI_Type_create_struct(%d, %p, %p, %p, %p) failed";
static const char short_spc185[] = "**mpi_type_delete_attr %D %d";
static const char long_spc185[]  = "MPI_Type_delete_atrr(%D, %d) failed";
static const char short_spc186[] = "**mpi_type_dup %D %p";
static const char long_spc186[]  = "MPI_Type_dup(%D, %p) failed";
static const char short_spc187[] = "**mpi_type_get_contents %D %d %d %d %p %p %p";
static const char long_spc187[]  = "MPI_Type_get_contents(%D, %d, %d, %d, %p, %p, %p) failed";
static const char short_spc188[] = "**mpi_type_get_envelope %D %p %p %p %p";
static const char long_spc188[]  = "MPI_Type_get_envelope(%D, %p, %p, %p, %p) failed";
static const char short_spc189[] = "**mpi_type_hindexed %d %p %p %D %p";
static const char long_spc189[]  = "MPI_Type_hindexed(%d, %p, %p, %D, %p) failed";
static const char short_spc190[] = "**mpi_type_hvector %d %d %d %D %p";
static const char long_spc190[]  = "MPI_Type_hvector(%d, %d, %d, %D, %p) failed";
static const char short_spc191[] = "**mpi_type_indexed %d %p %p %D %p";
static const char long_spc191[]  = "MPI_Type_indexed(%d, %p, %p, %D, %p) failed";
static const char short_spc192[] = "**mpi_type_match_size %d %d %p";
static const char long_spc192[]  = "MPI_Type_match_size(%d, %d, %p) failed";
static const char short_spc193[] = "**mpi_type_set_attr %D %d %p";
static const char long_spc193[]  = "MPI_Type_set_attr(%D, %d, %p) failed";
static const char short_spc194[] = "**mpi_type_struct %d %p %p %p %p";
static const char long_spc194[]  = "MPI_Type_struct(%d, %p, %p, %p, %p) failed";
static const char short_spc195[] = "**mpi_type_vector %d %d %d %D %p";
static const char long_spc195[]  = "MPI_Type_vector(%d, %d, %d, %D, %p) failed";
static const char short_spc196[] = "**mpi_unpack_external %s %p %d %p %p %d %D";
static const char long_spc196[]  = "MPI_Unpack_external(%s, %p, %d, %p, %p, %d, %D) failed";
static const char short_spc197[] = "**mpi_unpublish_name %s %I %s";
static const char long_spc197[]  = "MPI_Unpublish_name(service=\"%s\", %I, port=\"%s\") failed";
static const char short_spc198[] = "**mpi_wait %p %p";
static const char long_spc198[]  = "MPI_Wait(request=%p, status%p) failed";
static const char short_spc199[] = "**mpi_waitall %d %p %p";
static const char long_spc199[]  = "MPI_Waitall(count=%d, req_array=%p, status_array=%p) failed";
static const char short_spc200[] = "**mpi_waitany %d %p %p %p";
static const char long_spc200[]  = "MPI_Waitany(count=%d, req_array=%p, index=%p, status=%p) failed";
static const char short_spc201[] = "**mpi_waitsome %d %p %p %p %p";
static const char long_spc201[]  = "MPI_Waitsome(count=%d, req_array=%p, out_count=%p, indices=%p, status_array=%p) failed";
static const char short_spc202[] = "**mpi_win_complete %W";
static const char long_spc202[]  = "MPI_Win_complete(%W) failed";
static const char short_spc203[] = "**mpi_win_create %p %d %d %I %C %p";
static const char long_spc203[]  = "MPI_Win_create(%p, %d, %d, %I, %C, %p) failed";
static const char short_spc204[] = "**mpi_win_create_errhandler %p %p";
static const char long_spc204[]  = "MPI_Win_create_errhandler(%p, %p) failed";
static const char short_spc205[] = "**mpi_win_create_keyval %p %p %p %p";
static const char long_spc205[]  = "MPI_Win_create_keyval(%p, %p, %p, %p) failed";
static const char short_spc206[] = "**mpi_win_delete_attr %W %d";
static const char long_spc206[]  = "MPI_Win_delete_attr(%W, %d) failed";
static const char short_spc207[] = "**mpi_win_fence %A %W";
static const char long_spc207[]  = "MPI_Win_fence(%A, %W) failed";
static const char short_spc208[] = "**mpi_win_free %p";
static const char long_spc208[]  = "MPI_Win_free(%p) failed";
static const char short_spc209[] = "**mpi_win_get_group %W %p";
static const char long_spc209[]  = "MPI_Win_get_group(%W, %p) failed";
static const char short_spc210[] = "**mpi_win_lock %d %d %d %W";
static const char long_spc210[]  = "MPI_Win_lock(%d, %d, %d, %W) failed";
static const char short_spc211[] = "**mpi_win_post %G %d %W";
static const char long_spc211[]  = "MPI_Win_post(%G, %d, %W) failed";
static const char short_spc212[] = "**mpi_win_set_attr %W %d %p";
static const char long_spc212[]  = "MPI_Win_set_attr(%W, %d, %p) failed";
static const char short_spc213[] = "**mpi_win_test %W %p";
static const char long_spc213[]  = "MPI_Win_test(%W, %p) failed";
static const char short_spc214[] = "**mpi_win_unlock %d %W";
static const char long_spc214[]  = "MPI_Win_unlock(%d, %W) failed";
static const char short_spc215[] = "**mpi_win_wait %W";
static const char long_spc215[]  = "MPI_Win_wait(%W) failed";
static const char short_spc216[] = "**mq_close %d";
static const char long_spc216[]  = "failed to close a posix message queue, error %d";
static const char short_spc217[] = "**mq_open %d";
static const char long_spc217[]  = "failed to open a posix message queue, error %d";
static const char short_spc218[] = "**mq_receive %d";
static const char long_spc218[]  = "failed to receive a posix message queue message, error %d";
static const char short_spc219[] = "**mq_send %d";
static const char long_spc219[]  = "failed to send a posix message queue message, error %d";
static const char short_spc220[] = "**msgctl %d";
static const char long_spc220[]  = "msgctl returned %d";
static const char short_spc221[] = "**msgget %d";
static const char long_spc221[]  = "msgget returned %d";
static const char short_spc222[] = "**msgrcv %d";
static const char long_spc222[]  = "msgrcv returned %d";
static const char short_spc223[] = "**msgsnd %d";
static const char long_spc223[]  = "msgsnd returned %d";
static const char short_spc224[] = "**namepubfile %s %s %s";
static const char long_spc224[]  = "Unable to publish service name %s using file %s for reason %s";
static const char short_spc225[] = "**namepubnotpub %s";
static const char long_spc225[]  = "Lookup failed for service name %s";
static const char short_spc226[] = "**nomem %d";
static const char long_spc226[]  = "Out of memory (unable to allocate %d bytes)";
static const char short_spc227[] = "**nomem %s %d";
static const char long_spc227[]  = "Out of memory (unable to allocate a '%s' of size %d)";
static const char short_spc228[] = "**nomem %s";
static const char long_spc228[]  = "Out of memory (unable to allocate a '%s')";
static const char short_spc229[] = "**notsame %s %s";
static const char long_spc229[]  = "Inconsistent arguments %s to collective routine %s";
static const char short_spc230[] = "**nulledge %d %d";
static const char long_spc230[]  = "Edge for node %d (entry edges[%d]) is to itself";
static const char short_spc231[] = "**nullptr %s";
static const char long_spc231[]  = "Null pointer in parameter %s";
static const char short_spc232[] = "**nullptrtype %s";
static const char long_spc232[]  = "Null %s pointer";
static const char short_spc233[] = "**open %s %d %d";
static const char long_spc233[]  = "open(%s) failed for process %d, error %d";
static const char short_spc234[] = "**opnotpredefined %d";
static const char long_spc234[]  = "only predefined ops are valid (op = %d)";
static const char short_spc235[] = "**opundefined %s";
static const char long_spc235[]  = "MPI_Op %s operation not defined for this datatype ";
static const char short_spc236[] = "**opundefined_rma %d";
static const char long_spc236[]  = "RMA target received unknown RMA operation type %d";
static const char short_spc237[] = "**pd_alloc %s";
static const char long_spc237[]  = "unable to allocate a protection domain - %s";
static const char short_spc238[] = "**pkt_ptr %p %p";
static const char long_spc238[]  = "invalid shm queue packet pointer (%p != %p)";
static const char short_spc239[] = "**pkt_type %d";
static const char long_spc239[]  = "invalid packet type (%d)";
static const char short_spc240[] = "**pmi_barrier %d";
static const char long_spc240[]  = "PMI_Barrier returned %d";
static const char short_spc241[] = "**pmi_finalize %d";
static const char long_spc241[]  = "PMI_Finalize returned %d";
static const char short_spc242[] = "**pmi_get_id %d";
static const char long_spc242[]  = "PMI_Get_id returned %d";
static const char short_spc243[] = "**pmi_get_id_length_max %d";
static const char long_spc243[]  = "PMI_Get_id_length_max returned %d";
static const char short_spc244[] = "**pmi_get_rank %d";
static const char long_spc244[]  = "PMI_Get_rank returned %d";
static const char short_spc245[] = "**pmi_get_size %d";
static const char long_spc245[]  = "PMI_Get_size returned %d";
static const char short_spc246[] = "**pmi_init %d";
static const char long_spc246[]  = "PMI_Init returned %d";
static const char short_spc247[] = "**pmi_kvs_commit %d";
static const char long_spc247[]  = "PMI_KVS_Commit returned %d";
static const char short_spc248[] = "**pmi_kvs_create %d";
static const char long_spc248[]  = "PMI_KVS_Create returned %d";
static const char short_spc249[] = "**pmi_kvs_get %d";
static const char long_spc249[]  = "PMI_KVS_Get returned %d";
static const char short_spc250[] = "**pmi_kvs_get_key_length_max %d";
static const char long_spc250[]  = "PMI_KVS_Get_key_length_max returned %d";
static const char short_spc251[] = "**pmi_kvs_get_my_name %d";
static const char long_spc251[]  = "PMI_KVS_Get_my_name returned %d";
static const char short_spc252[] = "**pmi_kvs_get_name_length_max %d";
static const char long_spc252[]  = "PMI_KVS_Get_name_length_max returned %d";
static const char short_spc253[] = "**pmi_kvs_get_parent %d";
static const char long_spc253[]  = "unable to get the PARENT_ROOT_PORT_NAME from the keyval space (pmi_error %d)";
static const char short_spc254[] = "**pmi_kvs_get_value_length_max %d";
static const char long_spc254[]  = "PMI_KVS_Get_value_length_max returned %d";
static const char short_spc255[] = "**pmi_kvs_put %d";
static const char long_spc255[]  = "PMI_KVS_Put returned %d";
static const char short_spc256[] = "**pmi_spawn_multiple %d";
static const char long_spc256[]  = "PMI_Spawn_multiple returned %d";
static const char short_spc257[] = "**post_connect %s";
static const char long_spc257[]  = "%s failed in VC_post_connect";
static const char short_spc258[] = "**rangedup %d %d %d";
static const char long_spc258[]  = "The range array specifies duplicate entries; process %d specified in range array %d was previously specified in range array %d";
static const char short_spc259[] = "**rangeendinvalid %d %d %d";
static const char long_spc259[]  = "The %dth element of a range array ends at %d but must be nonnegative and less than %d";
static const char short_spc260[] = "**rangestartinvalid %d %d %d";
static const char long_spc260[]  = "The %dth element of a range array starts at %d but must be nonnegative and less than %d";
static const char short_spc261[] = "**rank %d %d";
static const char long_spc261[]  = "Invalid rank has value %d but must be nonnegative and less than %d";
static const char short_spc262[] = "**rankarray %d %d %d";
static const char long_spc262[]  = "Invalid rank in rank array at index %d; value is %d but must be in the range 0 to %d";
static const char short_spc263[] = "**rankdup %d %d %d";
static const char long_spc263[]  = "Duplicate ranks in rank array at index %d, has value %d which is also the value at index %d";
static const char short_spc264[] = "**ranklocal %d %d";
static const char long_spc264[]  = "Error specifying local_leader; rank given was %d but must be in the range 0 to %d";
static const char short_spc265[] = "**rankremote %d %d";
static const char long_spc265[]  = "Error specifying remote_leader; rank given was %d but must be in the range 0 to %d";
static const char short_spc266[] = "**rmasize %d";
static const char long_spc266[]  = "Invalid size argument in RMA call (value is %d)";
static const char short_spc267[] = "**root %d";
static const char long_spc267[]  = "Invalid root (value given was %d)";
static const char short_spc268[] = "**rsendnomatch %d %d";
static const char long_spc268[]  = "Ready send from source %d and with tag %d had no matching receive";
static const char short_spc269[] = "**shm_op %d";
static const char long_spc269[]  = "invalid shm operation (%d)";
static const char short_spc270[] = "**shm_open %s %d";
static const char long_spc270[]  = "unable to open shared memory object %s (errno %d)";
static const char short_spc271[] = "**shm_unlink %s %d";
static const char long_spc271[]  = "failed to unlink shared memory object %s, error %d";
static const char short_spc272[] = "**shmat %d";
static const char long_spc272[]  = "shmat failed, error %d";
static const char short_spc273[] = "**shmctl %d %d";
static const char long_spc273[]  = "failed to mark the sysv segment %d for removal, error %d";
static const char short_spc274[] = "**shmget %d";
static const char long_spc274[]  = "shmget failed, error %d";
static const char short_spc275[] = "**shmhost %s %s";
static const char long_spc275[]  = "process not on the same host (%s != %s)";
static const char short_spc276[] = "**shmq_index %d %d";
static const char long_spc276[]  = "invalid shm queue index (%d > %d)";
static const char short_spc277[] = "**shmsize %d";
static const char long_spc277[]  = "Shared memory subsystem unable to allocate a block of the requested size, %d bytes";
static const char short_spc278[] = "**snprintf %d";
static const char long_spc278[]  = "snprintf returned %d";
static const char short_spc279[] = "**sock_byname %d";
static const char long_spc279[]  = "gethostbyname failed (errno %d)";
static const char short_spc280[] = "**sock_connect %d";
static const char long_spc280[]  = "connect failed (errno %d)";
static const char short_spc281[] = "**sock_create %d";
static const char long_spc281[]  = "unable to create a socket (errno %d)";
static const char short_spc282[] = "**sock_gethost %d";
static const char long_spc282[]  = "gethostname failed (errno %d)";
static const char short_spc283[] = "**socket %d";
static const char long_spc283[]  = "WSASocket failed (errno %d)";
static const char short_spc284[] = "**sock|badbuf %d %d";
static const char long_spc284[]  = "the supplied buffer contains invalid memory (set=%d,sock=%d)";
static const char short_spc285[] = "**sock|badiovn %d %d %d";
static const char long_spc285[]  = "size of iov is invalid (set=%d,sock=%d,iov_n=%d)";
static const char short_spc286[] = "**sock|badlen %d %d %d %d";
static const char long_spc286[]  = "bad length parameter(s) (set=%d,sock=%d,min=%d,max=%d)";
static const char short_spc287[] = "**sock|badport %d";
static const char long_spc287[]  = "port number is out of range (sock=%d)";
static const char short_spc288[] = "**sock|closing %d %d";
static const char long_spc288[]  = "sock is in the process of being closed locally (set=%d,sock=%d)";
static const char short_spc289[] = "**sock|connclosed %d %d";
static const char long_spc289[]  = "connection closed by peer (set=%d,sock=%d)";
static const char short_spc290[] = "**sock|connfailed %d %d";
static const char long_spc290[]  = "connection failure (set=%d,sock=%d)";
static const char short_spc291[] = "**sock|notconnected %d %d";
static const char long_spc291[]  = "sock is not connected (set=%d,sock=%d)";
static const char short_spc292[] = "**sock|osnomem %d %d";
static const char long_spc292[]  = "operating system routine failed due to lack of memory (set=%d,sock=%d)";
static const char short_spc293[] = "**sock|poll|accept %d";
static const char long_spc293[]  = "accept failed to acquire a new socket (errno=%d)";
static const char short_spc294[] = "**sock|poll|badhandle %d %d %d";
static const char long_spc294[]  = "sock contains an invalid handle (set=%d,sock=%d,fd=%d)";
static const char short_spc295[] = "**sock|poll|bind %d %d";
static const char long_spc295[]  = "unable to bind socket to port (port=%d,errno=%d)";
static const char short_spc296[] = "**sock|poll|connfailed %d %d %d";
static const char long_spc296[]  = "connection failure (set=%d,sock=%d,errno=%d)";
static const char short_spc297[] = "**sock|poll|connfailed %d";
static const char long_spc297[]  = "connection failure (errno=%d)";
static const char short_spc298[] = "**sock|poll|connrefused %d %d %s";
static const char long_spc298[]  = "connection refused (set=%d,sock=%d,host=%s)";
static const char short_spc299[] = "**sock|poll|eqfail %d %d %d";
static const char long_spc299[]  = "fatal error: failed to enqueue an event; event was lost (set=%d,sock=%d,op=%d)";
static const char short_spc300[] = "**sock|poll|eqfail %d";
static const char long_spc300[]  = "fatal error: failed to enqueue an event; event was lost (op=%d)";
static const char short_spc301[] = "**sock|poll|getport %d";
static const char long_spc301[]  = "failed to obtain port number of listener (errno=%d)";
static const char short_spc302[] = "**sock|poll|hostres %d %d %s";
static const char long_spc302[]  = "unable to resolve host name to an address (set=%d,sock=%d,host=%s)";
static const char short_spc303[] = "**sock|poll|listen %d";
static const char long_spc303[]  = "listen() failed (errno=%d)";
static const char short_spc304[] = "**sock|poll|nodelay %d";
static const char long_spc304[]  = "unable to set TCP no delay attribute on socket (errno=%d)";
static const char short_spc305[] = "**sock|poll|nonblock %d";
static const char long_spc305[]  = "unable to set socket to nonblocking (errno=%d)";
static const char short_spc306[] = "**sock|poll|oserror %d %d %d";
static const char long_spc306[]  = "unknown operating system error (set=%d,sock=%d,errno=%d)";
static const char short_spc307[] = "**sock|poll|oserror %d";
static const char long_spc307[]  = "unknown operating system error (errno=%d)";
static const char short_spc308[] = "**sock|poll|pipe %d";
static const char long_spc308[]  = "unable to allocate pipe to wakeup a blocking poll() (errno=%d)";
static const char short_spc309[] = "**sock|poll|pipenonblock %d";
static const char long_spc309[]  = "unable to set wakeup pipe to nonblocking (errno=%d)";
static const char short_spc310[] = "**sock|poll|reuseaddr %d";
static const char long_spc310[]  = "unable to set reuseaddr attribute on socket (errno=%d)";
static const char short_spc311[] = "**sock|poll|socket %d";
static const char long_spc311[]  = "unable to obtain new socket (errno=%d)";
static const char short_spc312[] = "**sock|poll|unhandledstate %d %s";
static const char long_spc312[]  = "encountered an unhandled state (%d) while processing %s";
static const char short_spc313[] = "**sock|reads %d %d";
static const char long_spc313[]  = "attempt to perform multiple simultaneous reads (set=%d,sock=%d)";
static const char short_spc314[] = "**sock|writes %d %d";
static const char long_spc314[]  = "attempt to perform multiple simultaneous writes (set=%d,sock=%d)";
static const char short_spc315[] = "**stride %d %d %d";
static const char long_spc315[]  = "Range (start = %d, end = %d, stride = %d) does not terminate";
static const char short_spc316[] = "**tag %d";
static const char long_spc316[]  = "Invalid tag, value is %d";
static const char short_spc317[] = "**topotoolarge %d %d";
static const char long_spc317[]  = "Topology size %d is larger than communicator size (%d)";
static const char short_spc318[] = "**truncate %d %d %d %d";
static const char long_spc318[]  = "Message from rank %d and tag %d truncated; %d bytes received but buffer size is %d";
static const char short_spc319[] = "**truncate %d %d";
static const char long_spc319[]  = "Message truncated; %d bytes received but buffer size is %d";
static const char short_spc320[] = "**typematchsize %s %d";
static const char long_spc320[]  = "No MPI datatype available for typeclass %s and size %d";
static const char short_spc321[] = "**typenamelen %d";
static const char long_spc321[]  = " Specified datatype name is too long (%d characters)";
static const char short_spc322[] = "**vc_state %d";
static const char long_spc322[]  = "invalid vc state (%d)";
static const char short_spc323[] = "**wsasock %d";
static const char long_spc323[]  = "WSAStartup failed (errno %d)";

static const int specific_msgs_len = 324;
...
536,42,104,112,537,95,448,464,150,403,
540,109,10,546,542,408,184,183,182,457,
124,125,131,103,106,129,130,123,161,162,
168,167,190,383,9,399,135,134,433,137,
138,467,530,107,136,549,27,224,218,460,
463,462,461,20};
#endif
