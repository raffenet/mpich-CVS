...
static const char short_gen139[] = "**event_wait";
static const char long_gen139[]  = "unable to wait on an event";
static const char short_gen140[] = "**fail";
static const char long_gen140[]  = "failure";
...
static const char short_gen158[] = "**finalize_progress";
static const char long_gen158[]  = "finalizing the progress engine failed";
static const char short_gen159[] = "**finalize_progress_finalize";
static const char long_gen159[]  = "Progress finalize failed";
static const char short_gen160[] = "**finalize_release_mem";
static const char long_gen160[]  = "Release shared memory failed";
static const char short_gen161[] = "**finish_qp";
static const char long_gen161[]  = "unable to establish a queue pair connection";
static const char short_gen162[] = "**ftok";
static const char long_gen162[]  = "failed to create a sysv key from a file name";
static const char short_gen163[] = "**ftruncate";
static const char long_gen163[]  = "unable to resize the shared memory object";
static const char short_gen164[] = "**get_guids";
static const char long_gen164[]  = "unable to get the guids for the infiniband channel adapter";
static const char short_gen165[] = "**gethostbyname";
static const char long_gen165[]  = "gethostbyname failed";
static const char short_gen166[] = "**getinfo";
static const char long_gen166[]  = "getaddrinfo failed";
static const char short_gen167[] = "**graphnnodes";
static const char long_gen167[]  = "Number of graph nodes exceeds size of communicator.";
static const char short_gen168[] = "**group";
static const char long_gen168[]  = "Invalid group";
static const char short_gen169[] = "**groupnotincomm";
static const char long_gen169[]  = "Specified group is not within the communicator";
static const char short_gen170[] = "**handle_sock_op";
static const char long_gen170[]  = "handle_sock_op failed";
static const char short_gen171[] = "**handle_written";
static const char long_gen171[]  = "unable to handle written data";
static const char short_gen172[] = "**hostlookup";
static const char long_gen172[]  = "Host lookup failed";
static const char short_gen173[] = "**ibu_op";
static const char long_gen173[]  = "invalid infiniband operation";
static const char short_gen174[] = "**ibu_wait";
static const char long_gen174[]  = "ibu_wait failed";
static const char short_gen175[] = "**ibwrite";
static const char long_gen175[]  = "infiniband write failed";
static const char short_gen176[] = "**indexneg";
static const char long_gen176[]  = "Index value in graph topology must be nonnegative";
static const char short_gen177[] = "**indexnonmonotone";
static const char long_gen177[]  = "Index values in graph topology must be monotone nondecreasing";
static const char short_gen178[] = "**info";
static const char long_gen178[]  = "Invalid MPI_Info";
static const char short_gen179[] = "**infokey";
static const char long_gen179[]  = "Invalid key for MPI_Info ";
static const char short_gen180[] = "**infokeyempty";
static const char long_gen180[]  = "Empty or blank key ";
static const char short_gen181[] = "**infokeylong";
static const char long_gen181[]  = "Key is too long";
static const char short_gen182[] = "**infokeynull";
static const char long_gen182[]  = "Null key";
static const char short_gen183[] = "**infonkey";
static const char long_gen183[]  = "Requested nth key does not exist";
static const char short_gen184[] = "**infonokey";
static const char long_gen184[]  = "MPI_Info key is not defined ";
static const char short_gen185[] = "**infoval";
static const char long_gen185[]  = "Invalid MPI_Info value ";
static const char short_gen186[] = "**infovallong";
static const char long_gen186[]  = "Value is too long ";
static const char short_gen187[] = "**infovalnull";
static const char long_gen187[]  = "Null value";
static const char short_gen188[] = "**init";
static const char long_gen188[]  = "Initialization failed";
static const char short_gen189[] = "**init_buscard";
static const char long_gen189[]  = "failed to get my business card";
static const char short_gen190[] = "**init_description";
static const char long_gen190[]  = "unable to get the host description";
static const char short_gen191[] = "**init_getptr";
static const char long_gen191[]  = "failed to get the vcr";
static const char short_gen192[] = "**init_ibu";
static const char long_gen192[]  = "infiniband initialization failed";
static const char short_gen193[] = "**init_ibu_set";
static const char long_gen193[]  = "unable to create an infinband completion queue";
static const char short_gen194[] = "**init_progress";
static const char long_gen194[]  = "progress_init failed";
static const char short_gen195[] = "**init_vcrdup";
static const char long_gen195[]  = "failed to duplicate the virtual connection reference";
static const char short_gen196[] = "**init_vcrt";
static const char long_gen196[]  = "failed to create VCRT";
static const char short_gen197[] = "**initialized";
static const char long_gen197[]  = "MPI not initialized. Call MPI_Init or MPI_Init_thread first";
static const char short_gen198[] = "**inittwice";
static const char long_gen198[]  = "Cannot call MPI_INIT or MPI_INIT_THREAD more than once";
static const char short_gen199[] = "**inpending";
static const char long_gen199[]  = "Pending request (no error)";
static const char short_gen200[] = "**instatus";
static const char long_gen200[]  = "See the MPI_ERROR field in MPI_Status for the error code";
static const char short_gen201[] = "**intern";
static const char long_gen201[]  = "Internal MPI error!";
static const char short_gen202[] = "**inttoosmall";
static const char long_gen202[]  = "An address does not fit into a Fortran INTEGER.  Use MPI_Get_address instead";
static const char short_gen203[] = "**invalid_handle";
static const char long_gen203[]  = "invalid handle";
static const char short_gen204[] = "**invalid_listener";
static const char long_gen204[]  = "invalid listener";
...
static const char short_gen220[] = "**iofilecorrupt";
static const char long_gen220[]  = "File corrupt";
static const char short_gen221[] = "**iofilenull";
static const char long_gen221[]  = "Null file handle";
static const char short_gen222[] = "**iofiletype";
static const char long_gen222[]  = "Filetype must be constructed out of one or more etypes";
static const char short_gen223[] = "**iofstype";
static const char long_gen223[]  = "Cannot determine filesystem type";
static const char short_gen224[] = "**iofstypeunsupported";
static const char long_gen224[]  = "Specified filesystem is not available";
static const char short_gen225[] = "**ioneedrd";
static const char long_gen225[]  = "Read access is required to this file";
static const char short_gen226[] = "**ionegoffset";
static const char long_gen226[]  = "Negative offset argument";
static const char short_gen227[] = "**iopreallocrdwr";
static const char long_gen227[]  = "Must open file with MPI_MODE_RDWR to preallocate disk space";
static const char short_gen228[] = "**iosequnsupported";
static const char long_gen228[]  = "MPI_MODE_SEQUENTIAL not supported on this file system";
static const char short_gen229[] = "**iosharedfailed";
static const char long_gen229[]  = "Could not access shared file pointer";
static const char short_gen230[] = "**iosharedunsupported";
static const char long_gen230[]  = "Shared file pointers not supported";
static const char short_gen231[] = "**iosplitcoll";
static const char long_gen231[]  = "Only one active split collective I/O operation is allowed per file handle";
static const char short_gen232[] = "**iosplitcollnone";
static const char long_gen232[]  = "No split collective I/O operation is active";
static const char short_gen233[] = "**iov_offset";
static const char long_gen233[]  = "invalid iov offset";
static const char short_gen234[] = "**keyval";
static const char long_gen234[]  = "Invalid keyval";
static const char short_gen235[] = "**keyvalinvalid";
static const char long_gen235[]  = "Attribute key was MPI_KEYVAL_INVALID";
static const char short_gen236[] = "**keyvalnotcomm";
static const char long_gen236[]  = "Keyval was not defined for communicators";
static const char short_gen237[] = "**keyvalnotdatatype";
static const char long_gen237[]  = "Keyval was not defined for datatype";
static const char short_gen238[] = "**keyvalnotwin";
static const char long_gen238[]  = "Keyval was not defined for window objects";
static const char short_gen239[] = "**listen";
static const char long_gen239[]  = "listen failed";
static const char short_gen240[] = "**locktype";
static const char long_gen240[]  = "Invalid lock type";
static const char short_gen241[] = "**mmap";
static const char long_gen241[]  = "unable to map memory, mmap failed";
static const char short_gen242[] = "**mpi_abort";
static const char long_gen242[]  = "MPI_Abort failed";
static const char short_gen243[] = "**mpi_accumulate";
static const char long_gen243[]  = "MPI_Accumulate failed";
static const char short_gen244[] = "**mpi_add_error_class";
static const char long_gen244[]  = "MPI_Add_error_class failed";
static const char short_gen245[] = "**mpi_add_error_code";
static const char long_gen245[]  = "MPI_Add_error_code failed";
static const char short_gen246[] = "**mpi_add_error_string";
static const char long_gen246[]  = "MPI_Add_error_string failed";
static const char short_gen247[] = "**mpi_address";
static const char long_gen247[]  = "MPI_Address failed";
static const char short_gen248[] = "**mpi_allgather";
static const char long_gen248[]  = "MPI_Allgather failed";
static const char short_gen249[] = "**mpi_allgatherv";
static const char long_gen249[]  = "MPI_Allgatherv failed";
static const char short_gen250[] = "**mpi_alloc_mem";
static const char long_gen250[]  = "MPI_Alloc_mem failed";
static const char short_gen251[] = "**mpi_allreduce";
static const char long_gen251[]  = "MPI_Allreduce failed";
static const char short_gen252[] = "**mpi_alltoall";
static const char long_gen252[]  = "MPI_Alltoall failed";
static const char short_gen253[] = "**mpi_alltoallv";
static const char long_gen253[]  = "MPI_Alltoallv failed";
static const char short_gen254[] = "**mpi_alltoallw";
static const char long_gen254[]  = "MPI_Alltoallw failed";
static const char short_gen255[] = "**mpi_attr_delete";
static const char long_gen255[]  = "MPI_Attr_delete failed";
static const char short_gen256[] = "**mpi_attr_get";
static const char long_gen256[]  = "MPI_Attr_get failed";
static const char short_gen257[] = "**mpi_attr_put";
static const char long_gen257[]  = "MPI_Attr_put failed";
static const char short_gen258[] = "**mpi_barrier";
static const char long_gen258[]  = "MPI_Barrier failed";
static const char short_gen259[] = "**mpi_bcast";
static const char long_gen259[]  = "MPI_Bcast failed";
static const char short_gen260[] = "**mpi_bsend";
static const char long_gen260[]  = "MPI_Bsend failed";
static const char short_gen261[] = "**mpi_bsend_init";
static const char long_gen261[]  = "MPI_Bsend_init failed";
static const char short_gen262[] = "**mpi_buffer_attach";
static const char long_gen262[]  = "MPI_Buffer_attach failed";
static const char short_gen263[] = "**mpi_buffer_detach";
static const char long_gen263[]  = "MPI_Buffer_detach failed";
static const char short_gen264[] = "**mpi_cancel";
static const char long_gen264[]  = "MPI_Cancel failed";
static const char short_gen265[] = "**mpi_cart_coords";
static const char long_gen265[]  = "MPI_Cart_coords failed";
static const char short_gen266[] = "**mpi_cart_create";
static const char long_gen266[]  = "MPI_Cart_create failed";
static const char short_gen267[] = "**mpi_cart_get";
static const char long_gen267[]  = "MPI_Cart_get failed";
static const char short_gen268[] = "**mpi_cart_map";
static const char long_gen268[]  = "MPI_Cart_map failed";
static const char short_gen269[] = "**mpi_cart_rank";
static const char long_gen269[]  = "MPI_Cart_rank failed";
static const char short_gen270[] = "**mpi_cart_shift";
static const char long_gen270[]  = "MPI_Cart_shift failed";
static const char short_gen271[] = "**mpi_cart_sub";
static const char long_gen271[]  = "MPI_Cart_sub failed";
static const char short_gen272[] = "**mpi_cartdim_get";
static const char long_gen272[]  = "MPI_Cartdim_get failed";
static const char short_gen273[] = "**mpi_close_port";
static const char long_gen273[]  = "MPI_Close_port failed";
static const char short_gen274[] = "**mpi_comm_accept";
static const char long_gen274[]  = "MPI_Comm_accept failed";
static const char short_gen275[] = "**mpi_comm_call_errhandler";
static const char long_gen275[]  = "MPI_Comm_call_errhandler failed";
static const char short_gen276[] = "**mpi_comm_compare";
static const char long_gen276[]  = "MPI_Comm_compare failed";
static const char short_gen277[] = "**mpi_comm_connect";
static const char long_gen277[]  = "MPI_Comm_connect failed";
static const char short_gen278[] = "**mpi_comm_create";
static const char long_gen278[]  = "MPI_Comm_create failed";
static const char short_gen279[] = "**mpi_comm_create_errhandler";
static const char long_gen279[]  = "MPI_Comm_create_errhandler failed";
static const char short_gen280[] = "**mpi_comm_create_keyval";
static const char long_gen280[]  = "MPI_Comm_create_keyval failed";
static const char short_gen281[] = "**mpi_comm_delete_attr";
static const char long_gen281[]  = "MPI_Comm_delete_attr failed";
static const char short_gen282[] = "**mpi_comm_disconnect";
static const char long_gen282[]  = "MPI_Comm_disconnect failed";
static const char short_gen283[] = "**mpi_comm_dup";
static const char long_gen283[]  = "MPI_Comm_dup failed";
static const char short_gen284[] = "**mpi_comm_free";
static const char long_gen284[]  = "MPI_Comm_free failed";
static const char short_gen285[] = "**mpi_comm_free_keyval";
static const char long_gen285[]  = "MPI_Comm_free_keyval failed";
static const char short_gen286[] = "**mpi_comm_get_attr";
static const char long_gen286[]  = "MPI_Comm_get_attr failed";
static const char short_gen287[] = "**mpi_comm_get_errhandler";
static const char long_gen287[]  = "MPI_Comm_get_errhandler failed";
static const char short_gen288[] = "**mpi_comm_get_name";
static const char long_gen288[]  = "MPI_Comm_get_name failed";
static const char short_gen289[] = "**mpi_comm_get_parent";
static const char long_gen289[]  = "MPI_Comm_get_parent failed";
static const char short_gen290[] = "**mpi_comm_group";
static const char long_gen290[]  = "MPI_Comm_group failed";
static const char short_gen291[] = "**mpi_comm_join";
static const char long_gen291[]  = "MPI_Comm_join failed";
static const char short_gen292[] = "**mpi_comm_rank";
static const char long_gen292[]  = "MPI_Comm_rank failed";
static const char short_gen293[] = "**mpi_comm_remote_group";
static const char long_gen293[]  = "MPI_Comm_remote_group failed";
static const char short_gen294[] = "**mpi_comm_remote_size";
static const char long_gen294[]  = "MPI_Comm_remote_size failed";
static const char short_gen295[] = "**mpi_comm_set_attr";
static const char long_gen295[]  = "MPI_Comm_set_attr failed";
static const char short_gen296[] = "**mpi_comm_set_errhandler";
static const char long_gen296[]  = "MPI_Comm_set_errhandler failed";
static const char short_gen297[] = "**mpi_comm_set_name";
static const char long_gen297[]  = "MPI_Comm_set_name failed";
static const char short_gen298[] = "**mpi_comm_size";
static const char long_gen298[]  = "MPI_Comm_size failed";
static const char short_gen299[] = "**mpi_comm_spawn";
static const char long_gen299[]  = "MPI_Comm_spawn failed";
static const char short_gen300[] = "**mpi_comm_spawn_multiple";
static const char long_gen300[]  = "MPI_Comm_spawn_multiple failed";
static const char short_gen301[] = "**mpi_comm_split";
static const char long_gen301[]  = "MPI_Comm_split failed";
static const char short_gen302[] = "**mpi_comm_test_inter";
static const char long_gen302[]  = "MPI_Comm_test_inter failed";
static const char short_gen303[] = "**mpi_dims_create";
static const char long_gen303[]  = "MPI_Dims_create failed";
static const char short_gen304[] = "**mpi_errhandler_create";
static const char long_gen304[]  = "MPI_Errhandler_create failed";
static const char short_gen305[] = "**mpi_errhandler_free";
static const char long_gen305[]  = "MPI_Errhandler_free failed";
static const char short_gen306[] = "**mpi_errhandler_get";
static const char long_gen306[]  = "MPI_Errhandler_get failed";
static const char short_gen307[] = "**mpi_errhandler_set";
static const char long_gen307[]  = "MPI_Errhandler_set failed";
static const char short_gen308[] = "**mpi_error_class";
static const char long_gen308[]  = "MPI_Error_class failed";
static const char short_gen309[] = "**mpi_error_string";
static const char long_gen309[]  = "MPI_Error_string failed";
static const char short_gen310[] = "**mpi_exscan";
static const char long_gen310[]  = "MPI_Exscan failed";
static const char short_gen311[] = "**mpi_file_call_errhandler";
static const char long_gen311[]  = "MPI_File_call_errhandler failed";
static const char short_gen312[] = "**mpi_file_create_errhandler";
static const char long_gen312[]  = "MPI_File_create_errhandler failed";
static const char short_gen313[] = "**mpi_file_get_errhandler";
static const char long_gen313[]  = "MPI_File_get_errhandler failed";
static const char short_gen314[] = "**mpi_file_set_errhandler";
static const char long_gen314[]  = "MPI_File_set_errhandler failed";
static const char short_gen315[] = "**mpi_finalize";
static const char long_gen315[]  = "MPI_Finalize failed";
static const char short_gen316[] = "**mpi_finalized";
static const char long_gen316[]  = "MPI_Finalized failed";
static const char short_gen317[] = "**mpi_free_mem";
static const char long_gen317[]  = "MPI_Free_mem failed";
static const char short_gen318[] = "**mpi_gather";
static const char long_gen318[]  = "MPI_Gather failed";
static const char short_gen319[] = "**mpi_gatherv";
static const char long_gen319[]  = "MPI_Gatherv failed";
static const char short_gen320[] = "**mpi_get";
static const char long_gen320[]  = "MPI_Get failed";
static const char short_gen321[] = "**mpi_get_address";
static const char long_gen321[]  = "MPI_Get_address failed";
static const char short_gen322[] = "**mpi_get_count";
static const char long_gen322[]  = "MPI_Get_count failed";
static const char short_gen323[] = "**mpi_get_elements";
static const char long_gen323[]  = "MPI_Get_elements failed";
static const char short_gen324[] = "**mpi_get_processor_name";
static const char long_gen324[]  = "MPI_Get_processor_name failed";
static const char short_gen325[] = "**mpi_get_version";
static const char long_gen325[]  = "MPI_Get_version failed";
static const char short_gen326[] = "**mpi_graph_create";
static const char long_gen326[]  = "MPI_Graph_create failed";
static const char short_gen327[] = "**mpi_graph_get";
static const char long_gen327[]  = "MPI_Graph_get failed";
static const char short_gen328[] = "**mpi_graph_map";
static const char long_gen328[]  = "MPI_Graph_map failed";
static const char short_gen329[] = "**mpi_graph_neighbors";
static const char long_gen329[]  = "MPI_Graph_neighbors failed";
static const char short_gen330[] = "**mpi_graph_neighbors_count";
static const char long_gen330[]  = "MPI_Graph_neighbors_count failed";
static const char short_gen331[] = "**mpi_graphdims_get";
static const char long_gen331[]  = "MPI_Graphdims_get failed";
static const char short_gen332[] = "**mpi_grequest_complete";
static const char long_gen332[]  = "MPI_Grequest_complete failed";
static const char short_gen333[] = "**mpi_grequest_start";
static const char long_gen333[]  = "MPI_Grequest_start failed";
static const char short_gen334[] = "**mpi_group_compare";
static const char long_gen334[]  = "MPI_Group_compare failed";
static const char short_gen335[] = "**mpi_group_difference";
static const char long_gen335[]  = "MPI_Group_difference failed";
static const char short_gen336[] = "**mpi_group_excl";
static const char long_gen336[]  = "MPI_Group_excl failed";
static const char short_gen337[] = "**mpi_group_free";
static const char long_gen337[]  = "MPI_Group_free failed";
static const char short_gen338[] = "**mpi_group_incl";
static const char long_gen338[]  = "MPI_Group_incl failed";
static const char short_gen339[] = "**mpi_group_intersection";
static const char long_gen339[]  = "MPI_Group_intersection failed";
static const char short_gen340[] = "**mpi_group_range_excl";
static const char long_gen340[]  = "MPI_Group_range_excl failed";
static const char short_gen341[] = "**mpi_group_range_incl";
static const char long_gen341[]  = "MPI_Group_range_incl failed";
static const char short_gen342[] = "**mpi_group_rank";
static const char long_gen342[]  = "MPI_Group_rank failed";
static const char short_gen343[] = "**mpi_group_size";
static const char long_gen343[]  = "MPI_Group_size failed";
static const char short_gen344[] = "**mpi_group_translate_ranks";
static const char long_gen344[]  = "MPI_Group_translate_ranks failed";
static const char short_gen345[] = "**mpi_group_union";
static const char long_gen345[]  = "MPI_Group_union failed";
static const char short_gen346[] = "**mpi_ibsend";
static const char long_gen346[]  = "MPI_Ibsend failed";
static const char short_gen347[] = "**mpi_info_create";
static const char long_gen347[]  = "MPI_Info_create failed";
static const char short_gen348[] = "**mpi_info_delete";
static const char long_gen348[]  = "MPI_Info_delete failed";
static const char short_gen349[] = "**mpi_info_dup";
static const char long_gen349[]  = "MPI_Info_dup failed";
static const char short_gen350[] = "**mpi_info_free";
static const char long_gen350[]  = "MPI_Info_free failed";
static const char short_gen351[] = "**mpi_info_get";
static const char long_gen351[]  = "MPI_Info_get failed";
static const char short_gen352[] = "**mpi_info_get_nkeys";
static const char long_gen352[]  = "MPI_Info_get_nkeys failed";
static const char short_gen353[] = "**mpi_info_get_nthkey";
static const char long_gen353[]  = "MPI_Info_get_nthkey failed";
static const char short_gen354[] = "**mpi_info_get_valuelen";
static const char long_gen354[]  = "MPI_Info_get_valuelen failed";
static const char short_gen355[] = "**mpi_info_set";
static const char long_gen355[]  = "MPI_Info_set failed";
static const char short_gen356[] = "**mpi_init";
static const char long_gen356[]  = "MPI_Init failed";
static const char short_gen357[] = "**mpi_init_thread";
static const char long_gen357[]  = "MPI_Init_thread failed";
static const char short_gen358[] = "**mpi_initialized";
static const char long_gen358[]  = "MPI_Initialized failed";
static const char short_gen359[] = "**mpi_intercomm_create";
static const char long_gen359[]  = "MPI_Intercomm_create failed";
static const char short_gen360[] = "**mpi_intercomm_merge";
static const char long_gen360[]  = "MPI_Intercomm_merge failed";
static const char short_gen361[] = "**mpi_iprobe";
static const char long_gen361[]  = "MPI_Iprobe failed";
static const char short_gen362[] = "**mpi_irecv";
static const char long_gen362[]  = "MPI_Irecv failed";
static const char short_gen363[] = "**mpi_irsend";
static const char long_gen363[]  = "MPI_Irsend failed";
static const char short_gen364[] = "**mpi_is_thread_main";
static const char long_gen364[]  = "MPI_Is_thread_main failed";
static const char short_gen365[] = "**mpi_isend";
static const char long_gen365[]  = "MPI_Isend failed";
static const char short_gen366[] = "**mpi_issend";
static const char long_gen366[]  = "MPI_Issend failed";
static const char short_gen367[] = "**mpi_keyval_create";
static const char long_gen367[]  = "MPI_Keyval_create failed";
static const char short_gen368[] = "**mpi_keyval_free";
static const char long_gen368[]  = "MPI_Keyval_free failed";
static const char short_gen369[] = "**mpi_lookup_name";
static const char long_gen369[]  = "MPI_Lookup_name failed";
static const char short_gen370[] = "**mpi_op_create";
static const char long_gen370[]  = "MPI_Op_create failed";
static const char short_gen371[] = "**mpi_op_free";
static const char long_gen371[]  = "MPI_Op_free failed";
static const char short_gen372[] = "**mpi_open_port";
static const char long_gen372[]  = "MPI_Open_port failed";
static const char short_gen373[] = "**mpi_pack";
static const char long_gen373[]  = "MPI_Pack failed";
static const char short_gen374[] = "**mpi_pack_external";
static const char long_gen374[]  = "MPI_Pack_external failed";
static const char short_gen375[] = "**mpi_pack_external_size";
static const char long_gen375[]  = "MPI_Pack_external_size failed";
static const char short_gen376[] = "**mpi_pack_size";
static const char long_gen376[]  = "MPI_Pack_size failed";
static const char short_gen377[] = "**mpi_pcontrol";
static const char long_gen377[]  = "MPI_Pcontrol failed";
static const char short_gen378[] = "**mpi_probe";
static const char long_gen378[]  = "MPI_Probe failed";
static const char short_gen379[] = "**mpi_publish_name";
static const char long_gen379[]  = "MPI_Publish_name failed";
static const char short_gen380[] = "**mpi_put";
static const char long_gen380[]  = "MPI_Put failed";
static const char short_gen381[] = "**mpi_query_thread";
static const char long_gen381[]  = "MPI_Query_thread failed";
static const char short_gen382[] = "**mpi_recv";
static const char long_gen382[]  = "MPI_Recv failed";
static const char short_gen383[] = "**mpi_recv_init";
static const char long_gen383[]  = "MPI_Recv_init failed";
static const char short_gen384[] = "**mpi_reduce";
static const char long_gen384[]  = "MPI_Reduce failed";
static const char short_gen385[] = "**mpi_reduce_scatter";
static const char long_gen385[]  = "MPI_Reduce_scatter failed";
static const char short_gen386[] = "**mpi_register_datarep";
static const char long_gen386[]  = "MPI_Register_datarep failed";
static const char short_gen387[] = "**mpi_request_free";
static const char long_gen387[]  = "MPI_Request_free failed";
static const char short_gen388[] = "**mpi_request_get_status";
static const char long_gen388[]  = "MPI_Request_get_status failed";
static const char short_gen389[] = "**mpi_rsend";
static const char long_gen389[]  = "MPI_Rsend failed";
static const char short_gen390[] = "**mpi_rsend_init";
static const char long_gen390[]  = "MPI_Rsend_init failed";
static const char short_gen391[] = "**mpi_scan";
static const char long_gen391[]  = "MPI_Scan failed";
static const char short_gen392[] = "**mpi_scatter";
static const char long_gen392[]  = "MPI_Scatter failed";
static const char short_gen393[] = "**mpi_scatterv";
static const char long_gen393[]  = "MPI_Scatterv failed";
static const char short_gen394[] = "**mpi_send";
static const char long_gen394[]  = "MPI_Send failed";
static const char short_gen395[] = "**mpi_send_init";
static const char long_gen395[]  = "MPI_Send_init failed";
static const char short_gen396[] = "**mpi_sendrecv";
static const char long_gen396[]  = "MPI_Sendrecv failed";
static const char short_gen397[] = "**mpi_sendrecv_replace";
static const char long_gen397[]  = "MPI_Sendrecv_replace failed";
static const char short_gen398[] = "**mpi_ssend";
static const char long_gen398[]  = "MPI_Ssend failed";
static const char short_gen399[] = "**mpi_ssend_init";
static const char long_gen399[]  = "MPI_Ssend_init failed";
static const char short_gen400[] = "**mpi_start";
static const char long_gen400[]  = "MPI_Start failed";
static const char short_gen401[] = "**mpi_startall";
static const char long_gen401[]  = "MPI_Start_all failed";
static const char short_gen402[] = "**mpi_status_set_cancelled";
static const char long_gen402[]  = "MPI_Status_set_cancelled failed";
static const char short_gen403[] = "**mpi_status_set_elements";
static const char long_gen403[]  = "MPI_Status_set_elements failed";
static const char short_gen404[] = "**mpi_test";
static const char long_gen404[]  = "MPI_Test failed";
static const char short_gen405[] = "**mpi_test_cancelled";
static const char long_gen405[]  = "MPI_Test_cancelled failed";
static const char short_gen406[] = "**mpi_testall";
static const char long_gen406[]  = "MPI_Testall failed";
static const char short_gen407[] = "**mpi_testany";
static const char long_gen407[]  = "MPI_Testany failed";
static const char short_gen408[] = "**mpi_testsome";
static const char long_gen408[]  = "MPI_Testsome failed";
static const char short_gen409[] = "**mpi_topo_test";
static const char long_gen409[]  = "MPI_Topo_test failed";
static const char short_gen410[] = "**mpi_type_commit";
static const char long_gen410[]  = "MPI_Type_commit failed";
static const char short_gen411[] = "**mpi_type_contiguous";
static const char long_gen411[]  = "MPI_Type_continuous failed";
static const char short_gen412[] = "**mpi_type_create_darray";
static const char long_gen412[]  = "MPI_Type_create_darray failed";
static const char short_gen413[] = "**mpi_type_create_hindexed";
static const char long_gen413[]  = "MPI_Type_create_hindexed failed";
static const char short_gen414[] = "**mpi_type_create_hvector";
static const char long_gen414[]  = "MPI_Type_create_hvector failed";
static const char short_gen415[] = "**mpi_type_create_indexed_block";
static const char long_gen415[]  = "MPI_Type_create_indexed_block failed";
static const char short_gen416[] = "**mpi_type_create_keyval";
static const char long_gen416[]  = "MPI_Type_create_keyval failed";
static const char short_gen417[] = "**mpi_type_create_resized";
static const char long_gen417[]  = "MPI_Type_create_resized failed";
static const char short_gen418[] = "**mpi_type_create_struct";
static const char long_gen418[]  = "MPI_Type_create_struct failed";
static const char short_gen419[] = "**mpi_type_create_subarray";
static const char long_gen419[]  = "MPI_Type_create_subarray failed";
static const char short_gen420[] = "**mpi_type_delete_attr";
static const char long_gen420[]  = "MPI_Type_delete_attr failed";
static const char short_gen421[] = "**mpi_type_dup";
static const char long_gen421[]  = "MPI_Type_dup failed";
static const char short_gen422[] = "**mpi_type_extent";
static const char long_gen422[]  = "MPI_Type_extent failed";
static const char short_gen423[] = "**mpi_type_free";
static const char long_gen423[]  = "MPI_Type_free failed";
static const char short_gen424[] = "**mpi_type_free_keyval";
static const char long_gen424[]  = "MPI_Type_free_keyval failed";
static const char short_gen425[] = "**mpi_type_get_attr";
static const char long_gen425[]  = "MPI_Type_get_attr failed";
static const char short_gen426[] = "**mpi_type_get_contents";
static const char long_gen426[]  = "MPI_Type_get_contents failed";
static const char short_gen427[] = "**mpi_type_get_envelope";
static const char long_gen427[]  = "MPI_Type_get_envelope failed";
static const char short_gen428[] = "**mpi_type_get_extent";
static const char long_gen428[]  = "MPI_Type_get_extent failed";
static const char short_gen429[] = "**mpi_type_get_name";
static const char long_gen429[]  = "MPI_Type_get_name failed";
static const char short_gen430[] = "**mpi_type_get_true_extent";
static const char long_gen430[]  = "MPI_Type_get_true_extent failed";
static const char short_gen431[] = "**mpi_type_hindexed";
static const char long_gen431[]  = "MPI_Type_hindexed failed";
static const char short_gen432[] = "**mpi_type_hvector";
static const char long_gen432[]  = "MPI_Type_hvector failed";
static const char short_gen433[] = "**mpi_type_indexed";
static const char long_gen433[]  = "MPI_Type_indexed failed";
static const char short_gen434[] = "**mpi_type_lb";
static const char long_gen434[]  = "MPI_Type_lb failed";
static const char short_gen435[] = "**mpi_type_match_size";
static const char long_gen435[]  = "MPI_Type_match_size failed";
static const char short_gen436[] = "**mpi_type_set_attr";
static const char long_gen436[]  = "MPI_Type_set_attr failed";
static const char short_gen437[] = "**mpi_type_set_name";
static const char long_gen437[]  = "MPI_Type_set_name failed";
static const char short_gen438[] = "**mpi_type_size";
static const char long_gen438[]  = "MPI_Type_size failed";
static const char short_gen439[] = "**mpi_type_struct";
static const char long_gen439[]  = "MPI_Type_struct failed";
static const char short_gen440[] = "**mpi_type_ub";
static const char long_gen440[]  = "MPI_Type_ub failed";
static const char short_gen441[] = "**mpi_type_vector";
static const char long_gen441[]  = "MPI_Type_vector failed";
static const char short_gen442[] = "**mpi_unpack";
static const char long_gen442[]  = "MPI_Unpack failed";
static const char short_gen443[] = "**mpi_unpack_external";
static const char long_gen443[]  = "MPI_Unpack_external failed";
static const char short_gen444[] = "**mpi_unpublish_name";
static const char long_gen444[]  = "MPI_Unpublish_name failed";
static const char short_gen445[] = "**mpi_wait";
static const char long_gen445[]  = "MPI_Wait failed";
static const char short_gen446[] = "**mpi_waitall";
static const char long_gen446[]  = "MPI_Waitall failed";
static const char short_gen447[] = "**mpi_waitany";
static const char long_gen447[]  = "MPI_Waitany failed";
static const char short_gen448[] = "**mpi_waitsome";
static const char long_gen448[]  = "MPI_Waitsome failed";
static const char short_gen449[] = "**mpi_win_call_errhandler";
static const char long_gen449[]  = "MPI_Win_call_errhandler failed";
static const char short_gen450[] = "**mpi_win_complete";
static const char long_gen450[]  = "MPI_Win_complete failed";
static const char short_gen451[] = "**mpi_win_create";
static const char long_gen451[]  = "MPI_Win_create failed";
static const char short_gen452[] = "**mpi_win_create_errhandler";
static const char long_gen452[]  = "MPI_Win_create_errhandler failed";
static const char short_gen453[] = "**mpi_win_create_keyval";
static const char long_gen453[]  = "MPI_Win_create_keyval failed";
static const char short_gen454[] = "**mpi_win_delete_attr";
static const char long_gen454[]  = "MPI_Win_delete_attr failed";
static const char short_gen455[] = "**mpi_win_fence";
static const char long_gen455[]  = "MPI_Win_fence failed";
static const char short_gen456[] = "**mpi_win_free";
static const char long_gen456[]  = "MPI_Win_free failed";
static const char short_gen457[] = "**mpi_win_free_keyval";
static const char long_gen457[]  = "MPI_Win_free_keyval failed";
static const char short_gen458[] = "**mpi_win_get_attr";
static const char long_gen458[]  = "MPI_Win_get_attr failed";
static const char short_gen459[] = "**mpi_win_get_errhandler";
static const char long_gen459[]  = "MPI_Win_get_errhandler failed";
static const char short_gen460[] = "**mpi_win_get_group";
static const char long_gen460[]  = "MPI_Win_get_group failed";
static const char short_gen461[] = "**mpi_win_get_name";
static const char long_gen461[]  = "MPI_Win_get_name failed";
static const char short_gen462[] = "**mpi_win_lock";
static const char long_gen462[]  = "MPI_Win_lock failed";
static const char short_gen463[] = "**mpi_win_post";
static const char long_gen463[]  = "MPI_Win_post failed";
static const char short_gen464[] = "**mpi_win_set_attr";
static const char long_gen464[]  = "MPI_Win_set_attr failed";
static const char short_gen465[] = "**mpi_win_set_errhandler";
static const char long_gen465[]  = "MPI_Win_set_errhandler failed";
static const char short_gen466[] = "**mpi_win_set_name";
static const char long_gen466[]  = "MPI_Win_set_name failed";
static const char short_gen467[] = "**mpi_win_start";
static const char long_gen467[]  = "MPI_Win_start failed";
static const char short_gen468[] = "**mpi_win_test";
static const char long_gen468[]  = "MPI_Win_test failed";
static const char short_gen469[] = "**mpi_win_unlock";
static const char long_gen469[]  = "MPI_Win_unlock failed";
static const char short_gen470[] = "**mpi_win_wait";
static const char long_gen470[]  = "MPI_Win_wait failed";
static const char short_gen471[] = "**mpi_wtick";
static const char long_gen471[]  = "MPI_Wtick failed";
...
static const char short_gen486[] = "**namepubnotpub";
static const char long_gen486[]  = "Lookup failed for service name ";
static const char short_gen487[] = "**nameservice";
static const char long_gen487[]  = "Invalid service name (see MPI_Publish_name)";
static const char short_gen488[] = "**needthreads";
static const char long_gen488[]  = "This function needs threads and threads have not been enabled";
static const char short_gen489[] = "**nextbootmsg";
static const char long_gen489[]  = "failed to get the next bootstrap message";
static const char short_gen490[] = "**noca";
static const char long_gen490[]  = "unable to find an active infiniband channel adapter";
static const char short_gen491[] = "**noerrclasses";
static const char long_gen491[]  = "No more user-defined error classes";
static const char short_gen492[] = "**noerrcodes";
static const char long_gen492[]  = "No more user-defined error codes";
static const char short_gen493[] = "**nomem";
static const char long_gen493[]  = "Out of memory";
static const char short_gen494[] = "**nomemreq";
static const char long_gen494[]  = "failure occurred while allocating memory for a request object";
static const char short_gen495[] = "**nonamepub";
static const char long_gen495[]  = "No name publishing service available";
static const char short_gen496[] = "**notcarttopo";
static const char long_gen496[]  = "No Cartesian topology associated with this communicator";
static const char short_gen497[] = "**notcstatignore";
static const char long_gen497[]  = "MPI_STATUS_IGNORE cannot be passed to MPI_Status_c2f()";
static const char short_gen498[] = "**notfstatignore";
static const char long_gen498[]  = "MPI_STATUS_IGNORE cannot be passed to MPI_Status_f2c()";
static const char short_gen499[] = "**notgenreq";
static const char long_gen499[]  = "Attempt to complete a request with MPI_GREQUEST_COMPLETE that was not started with MPI_GREQUEST_START";
static const char short_gen500[] = "**notgraphtopo";
static const char long_gen500[]  = "No Graph topology associated with this communicator";
static const char short_gen501[] = "**notimpl";
static const char long_gen501[]  = "Function not implemented";
static const char short_gen502[] = "**notopology";
static const char long_gen502[]  = "No topology associated with this communicator";
static const char short_gen503[] = "**notsame";
static const char long_gen503[]  = "Inconsistent arguments to collective routine ";
static const char short_gen504[] = "**nouniquehigh";
static const char long_gen504[]  = "Could not determine which group to place first in merged intracommunicator.  Please use the parameter high to choose which group should be placed first.";
static const char short_gen505[] = "**nulledge";
static const char long_gen505[]  = "Edge detected from a node to the same node";
static const char short_gen506[] = "**nullptr";
static const char long_gen506[]  = "Null pointer";
static const char short_gen507[] = "**nullptrtype";
static const char long_gen507[]  = "Null pointer";
static const char short_gen508[] = "**op";
static const char long_gen508[]  = "Invalid MPI_Op";
static const char short_gen509[] = "**open";
static const char long_gen509[]  = "open failed";
static const char short_gen510[] = "**opnotpredefined";
static const char long_gen510[]  = "only predefined ops are valid";
static const char short_gen511[] = "**opundefined";
static const char long_gen511[]  = "MPI_Op operation not defined for this datatype ";
static const char short_gen512[] = "**opundefined_rma";
static const char long_gen512[]  = "RMA target received unknown RMA operation";
static const char short_gen513[] = "**other";
static const char long_gen513[]  = "Other MPI error";
static const char short_gen514[] = "**pctwice";
static const char long_gen514[]  = "post close called twice";
static const char short_gen515[] = "**pd_alloc";
static const char long_gen515[]  = "unable to allocate a protection domain";
static const char short_gen516[] = "**permattr";
static const char long_gen516[]  = "Cannot set permanent attribute";
static const char short_gen517[] = "**permop";
static const char long_gen517[]  = "Cannot free permanent MPI_Op ";
static const char short_gen518[] = "**pfinal_sockclose";
static const char long_gen518[]  = "sock_close failed";
static const char short_gen519[] = "**pglookup";
static const char long_gen519[]  = "unable to find the process group structure";
static const char short_gen520[] = "**pkt_ptr";
static const char long_gen520[]  = "invalid shm queue packet pointer";
static const char short_gen521[] = "**pmi_barrier";
static const char long_gen521[]  = "PMI_Barrier failed";
static const char short_gen522[] = "**pmi_finalize";
static const char long_gen522[]  = "PMI_Finalize failed";
static const char short_gen523[] = "**pmi_get_id";
static const char long_gen523[]  = "PMI_Get_id failed";
static const char short_gen524[] = "**pmi_get_id_length_max";
static const char long_gen524[]  = "PMI_Get_id_length_max failed";
static const char short_gen525[] = "**pmi_get_rank";
static const char long_gen525[]  = "PMI_Get_rank failed";
static const char short_gen526[] = "**pmi_get_size";
static const char long_gen526[]  = "PMI_Get_size failed";
static const char short_gen527[] = "**pmi_init";
static const char long_gen527[]  = "PMI_Init failed";
static const char short_gen528[] = "**pmi_kvs_commit";
static const char long_gen528[]  = "PMI_KVS_Commit failed";
static const char short_gen529[] = "**pmi_kvs_create";
static const char long_gen529[]  = "PMI_KVS_Create failed";
static const char short_gen530[] = "**pmi_kvs_destroy";
static const char long_gen530[]  = "PMI_KVS_Destroy failed";
static const char short_gen531[] = "**pmi_kvs_get";
static const char long_gen531[]  = "PMI_KVS_Get failed";
static const char short_gen532[] = "**pmi_kvs_get_key_length_max";
static const char long_gen532[]  = "PMI_KVS_Get_key_length_max failed";
static const char short_gen533[] = "**pmi_kvs_get_my_name";
static const char long_gen533[]  = "PMI_KVS_Get_my_name failed";
static const char short_gen534[] = "**pmi_kvs_get_name_length_max";
static const char long_gen534[]  = "PMI_KVS_Get_name_length_max failed";
static const char short_gen535[] = "**pmi_kvs_get_value_length_max";
static const char long_gen535[]  = "PMI_KVS_Get_value_length_max failed";
static const char short_gen536[] = "**pmi_kvs_put";
static const char long_gen536[]  = "PMI_KVS_Put failed";
static const char short_gen537[] = "**pmi_spawn_multiple";
static const char long_gen537[]  = "PMI_Spawn_multiple failed";
static const char short_gen538[] = "**poke";
static const char long_gen538[]  = "progress_poke failed";
static const char short_gen539[] = "**port";
static const char long_gen539[]  = "Invalid port";
static const char short_gen540[] = "**post_accept";
static const char long_gen540[]  = "post accept failed";
static const char short_gen541[] = "**post_connect";
static const char long_gen541[]  = "failed to post a connection";
static const char short_gen542[] = "**postpkt";
static const char long_gen542[]  = "Unable to post a read for the next packet header";
static const char short_gen543[] = "**postwrite";
static const char long_gen543[]  = "postwrite failed";
static const char short_gen544[] = "**process_group";
static const char long_gen544[]  = "Process group initialization failed";
static const char short_gen545[] = "**progress";
static const char long_gen545[]  = "progress engine failure";
static const char short_gen546[] = "**progress_finalize";
static const char long_gen546[]  = "finalization of the progress engine failed";
static const char short_gen547[] = "**progress_handle_sock_op";
static const char long_gen547[]  = "handle_sock_op failed";
static const char short_gen548[] = "**progress_init";
static const char long_gen548[]  = "unable to initialize the progress engine";
static const char short_gen549[] = "**progress_sock_wait";
static const char long_gen549[]  = "sock_wait failed";
static const char short_gen550[] = "**progress_test";
static const char long_gen550[]  = "progress_test engine failure";
static const char short_gen551[] = "**rangedup";
static const char long_gen551[]  = "The range array specifies duplicate entries";
static const char short_gen552[] = "**rangeendinvalid";
static const char long_gen552[]  = "Some element of a range array is either negative or too large";
static const char short_gen553[] = "**rangestartinvalid";
static const char long_gen553[]  = "Some element of a range array is either negative or too large";
static const char short_gen554[] = "**rank";
static const char long_gen554[]  = "Invalid rank";
static const char short_gen555[] = "**rankarray";
static const char long_gen555[]  = "Invalid rank in rank array";
static const char short_gen556[] = "**rankdup";
static const char long_gen556[]  = "Duplicate ranks in rank array ";
static const char short_gen557[] = "**ranklocal";
static const char long_gen557[]  = "Error specifying local_leader ";
static const char short_gen558[] = "**rankremote";
static const char long_gen558[]  = "Error specifying remote_leader ";
static const char short_gen559[] = "**rdma_finalize";
static const char long_gen559[]  = "Channel rdma finalization failed";
static const char short_gen560[] = "**rdma_init";
static const char long_gen560[]  = "Channel rdma initialization failed";
static const char short_gen561[] = "**read_progress";
static const char long_gen561[]  = "Unable to make read progress";
static const char short_gen562[] = "**recvbuf_inplace";
static const char long_gen562[]  = "recvbuf cannot be MPI_IN_PLACE";
static const char short_gen563[] = "**request";
static const char long_gen563[]  = "Invalid MPI_Request";
...
static const char short_gen565[] = "**requestpersistactive";
static const char long_gen565[]  = "Persistent request passed to MPI_Start or MPI_Startall is already active.";
static const char short_gen566[] = "**rmaconflict";
static const char long_gen566[]  = "Conflicting accesses to window ";
static const char short_gen567[] = "**rmadisp";
static const char long_gen567[]  = "Invalid displacement argument in RMA call ";
static const char short_gen568[] = "**rmasize";
static const char long_gen568[]  = "Invalid size argument in RMA call";
static const char short_gen569[] = "**rmasync";
static const char long_gen569[]  = "Wrong synchronization of RMA calls ";
static const char short_gen570[] = "**root";
static const char long_gen570[]  = "Invalid root";
static const char short_gen571[] = "**rsendnomatch";
static const char long_gen571[]  = "Ready send had no matching receive ";
static const char short_gen572[] = "**sendbuf_inplace";
static const char long_gen572[]  = "sendbuf cannot be MPI_IN_PLACE";
static const char short_gen573[] = "**servicename";
static const char long_gen573[]  = "Attempt to lookup an unknown service name ";
static const char short_gen574[] = "**shm_op";
static const char long_gen574[]  = "invalid shm operation";
static const char short_gen575[] = "**shm_open";
static const char long_gen575[]  = "unable to open a shared memory object";
static const char short_gen576[] = "**shm_read_progress";
static const char long_gen576[]  = "shared memory read progress failed";
static const char short_gen577[] = "**shm_unlink";
static const char long_gen577[]  = "failed to unlink shared memory";
static const char short_gen578[] = "**shm_wait";
static const char long_gen578[]  = "wait function failed";
static const char short_gen579[] = "**shmat";
static const char long_gen579[]  = "shmat failed";
static const char short_gen580[] = "**shmconnect_getmem";
static const char long_gen580[]  = "failed to allocate shared memory for a write queue";
static const char short_gen581[] = "**shmctl";
static const char long_gen581[]  = "failed to mark the sysv segment for removal";
static const char short_gen582[] = "**shmget";
static const char long_gen582[]  = "shmget failed";
static const char short_gen583[] = "**shmgetmem";
static const char long_gen583[]  = "Unable to allocate shared memory";
static const char short_gen584[] = "**shmhost";
static const char long_gen584[]  = "process not on the same host";
static const char short_gen585[] = "**shmq_index";
static const char long_gen585[]  = "invalid shm queue index";
static const char short_gen586[] = "**shmsize";
static const char long_gen586[]  = "Shared memory subsystem unable to allocate a block of the requested size";
static const char short_gen587[] = "**shmwrite";
static const char long_gen587[]  = "shared memory write failed";
static const char short_gen588[] = "**snprintf";
static const char long_gen588[]  = "snprintf returned an invalid number";
static const char short_gen589[] = "**sock_byname";
static const char long_gen589[]  = "gethostbyname failed";
static const char short_gen590[] = "**sock_closed";
static const char long_gen590[]  = "socket closed";
static const char short_gen591[] = "**sock_connect";
static const char long_gen591[]  = "connect failed";
static const char short_gen592[] = "**sock_create";
static const char long_gen592[]  = "unable to create a socket";
static const char short_gen593[] = "**sock_gethost";
static const char long_gen593[]  = "gethostname failed";
static const char short_gen594[] = "**sock_init";
static const char long_gen594[]  = "unable to initialize the sock library";
static const char short_gen595[] = "**sock_nop_accept";
static const char long_gen595[]  = "accept called without having received an op_accept";
static const char short_gen596[] = "**sock_post_close";
static const char long_gen596[]  = "posting a close of the socket failed";
static const char short_gen597[] = "**sock_wait";
static const char long_gen597[]  = "sock_wait failed";
...
static const char short_gen615[] = "**sock|hostres";
static const char long_gen615[]  = "unable to resolve host name to an address";
static const char short_gen616[] = "**sock|listener_bad_sock";
static const char long_gen616[]  = " supplied sock is not a listener";
static const char short_gen617[] = "**sock|listener_bad_state";
static const char long_gen617[]  = " supplied listener sock is in a bad state";
static const char short_gen618[] = "**sock|listener_read";
static const char long_gen618[]  = "read operation not allowed on a listener";
static const char short_gen619[] = "**sock|listener_write";
static const char long_gen619[]  = "write operation not allowed on a listener";
static const char short_gen620[] = "**sock|nosock";
static const char long_gen620[]  = "no new sock was available to accept";
static const char short_gen621[] = "**sock|notconnected";
static const char long_gen621[]  = "sock is not connected";
static const char short_gen622[] = "**sock|oserror";
static const char long_gen622[]  = "unexpected operating system error";
static const char short_gen623[] = "**sock|osnomem";
static const char long_gen623[]  = "operating system routine failed due to lack of memory";
static const char short_gen624[] = "**sock|poll|accept";
static const char long_gen624[]  = "accept failed to acquire a new socket";
static const char short_gen625[] = "**sock|poll|bind";
static const char long_gen625[]  = "unable to bind socket to port";
static const char short_gen626[] = "**sock|poll|eqfail";
static const char long_gen626[]  = "fatal error: failed to enqueue an event; event was lost";
static const char short_gen627[] = "**sock|poll|eqmalloc";
static const char long_gen627[]  = "MPIU_Malloc failed to allocate memory for an event queue structure";
static const char short_gen628[] = "**sock|poll|listen";
static const char long_gen628[]  = "listen() failed";
static const char short_gen629[] = "**sock|poll|nodelay";
static const char long_gen629[]  = "unable to set TCP no delay attribute on socket";
static const char short_gen630[] = "**sock|poll|nonblock";
static const char long_gen630[]  = "unable to set socket to nonblocking";
static const char short_gen631[] = "**sock|poll|pipe";
static const char long_gen631[]  = "unable to allocate pipe to wakeup a blocking poll()";
static const char short_gen632[] = "**sock|poll|pipenonblock";
static const char long_gen632[]  = "unable to set wakeup pipe to nonblocking";
static const char short_gen633[] = "**sock|poll|reuseaddr";
static const char long_gen633[]  = "unable to set reuseaddr attribute on socket";
static const char short_gen634[] = "**sock|poll|socket";
static const char long_gen634[]  = "unable to obtain new socket";
static const char short_gen635[] = "**sock|poll|unhandledstate";
static const char long_gen635[]  = "encountered an unexpected state";
static const char short_gen636[] = "**sock|poll|unhandledtype";
static const char long_gen636[]  = "encountered an unexpected sock type";
static const char short_gen637[] = "**sock|reads";
static const char long_gen637[]  = "attempt to perform multiple simultaneous reads";
static const char short_gen638[] = "**sock|setalloc";
static const char long_gen638[]  = "unable to allocate a new sock set object";
static const char short_gen639[] = "**sock|sockalloc";
static const char long_gen639[]  = "unable to allocate a new sock object";
static const char short_gen640[] = "**sock|uninit";
static const char long_gen640[]  = "Sock library has not been initialized";
static const char short_gen641[] = "**sock|writes";
static const char long_gen641[]  = "attempt to perform multiple simultaneous writes";
static const char short_gen642[] = "**spawn";
static const char long_gen642[]  = "Error in spawn call";
static const char short_gen643[] = "**ssmwrite";
static const char long_gen643[]  = "sock/shared memory write failed";
static const char short_gen644[] = "**ssmwritev";
static const char long_gen644[]  = "sock/shared memory writev failed";
static const char short_gen645[] = "**stride";
static const char long_gen645[]  = "Range does not terminate";
static const char short_gen646[] = "**stridezero";
static const char long_gen646[]  = "Zero stride is invalid";
static const char short_gen647[] = "**strncpy";
static const char long_gen647[]  = "insufficient buffer length to complete strncpy";
static const char short_gen648[] = "**success";
static const char long_gen648[]  = "No MPI error";
static const char short_gen649[] = "**tag";
static const char long_gen649[]  = "Invalid tag";
static const char short_gen650[] = "**test_sock_wait";
static const char long_gen650[]  = "sock_wait failed";
static const char short_gen651[] = "**toomanycomm";
static const char long_gen651[]  = "Too many communicators";
static const char short_gen652[] = "**topology";
static const char long_gen652[]  = "Invalid topology";
static const char short_gen653[] = "**topotoolarge";
static const char long_gen653[]  = "Topology size is greater than communicator size";
static const char short_gen654[] = "**truncate";
static const char long_gen654[]  = "Message truncated";
static const char short_gen655[] = "**typematchnoclass";
static const char long_gen655[]  = "The value of typeclass is not one of MPI_TYPECLASS_REAL, MPI_TYPECLASS_INTEGER, or MPI_TYPECLASS_COMPLEX";
static const char short_gen656[] = "**typematchsize";
static const char long_gen656[]  = "No MPI datatype available for the given typeclass and size";
static const char short_gen657[] = "**typenamelen";
static const char long_gen657[]  = " Specified datatype name is too long";
static const char short_gen658[] = "**unknown";
static const char long_gen658[]  = "Unknown error.  Please file a bug report.";
static const char short_gen659[] = "**unsupporteddatarep";
static const char long_gen659[]  = "Only native data representation currently supported";
static const char short_gen660[] = "**vc_state";
static const char long_gen660[]  = "invalid vc state";
static const char short_gen661[] = "**win";
static const char long_gen661[]  = "Invalid MPI_Win";
static const char short_gen662[] = "**winunlockrank";
static const char long_gen662[]  = "Invalid rank argument";
static const char short_gen663[] = "**winwait";
static const char long_gen663[]  = "WaitForSingleObject failed";
static const char short_gen664[] = "**write";
static const char long_gen664[]  = "write failed";
static const char short_gen665[] = "**write_progress";
static const char long_gen665[]  = "Write progress failed";
static const char short_gen666[] = "**writev";
static const char long_gen666[]  = "writev failed";
...
static const char long_spc54[]  = "failure - %s (errno %d)";
...
static const char long_spc82[]  = "MPI_Abort(%C, %d) failed";
static const char short_spc83[] = "**mpi_accumulate %p %d %D %d %d %d %D %O %W";
static const char long_spc83[]  = "MPI_Accumulate(%p, %d, %D, %d, %d, %d, %D, %O, %W) failed";
static const char short_spc84[] = "**mpi_add_error_class %p";
static const char long_spc84[]  = "MPI_Add_error_class(%p) failed";
static const char short_spc85[] = "**mpi_add_error_code %d %p";
static const char long_spc85[]  = "MPI_Add_error_code(%d, %p) failed";
...
static const char long_spc90[]  = "MPI_Alloc_mem(%d, %I, %p) failed";
...
static const char long_spc95[]  = "MPI_Attr_delete(%C, %d) failed";
static const char short_spc96[] = "**mpi_attr_get %C %d %p %p";
static const char long_spc96[]  = "MPI_Atr_get(%C, %d, %p, %p) failed";
static const char short_spc97[] = "**mpi_attr_put %C %d %p";
static const char long_spc97[]  = "MPI_Attr_put(%C, %d, %p) failed";
...
static const char long_spc105[]  = "MPI_Cart_coords(%C, %d, %d, %p) failed";
static const char short_spc106[] = "**mpi_cart_create %C %d %p %p %d %p";
static const char long_spc106[]  = "MPI_Cart_create(%C, %d, %p, %p, %d, %p) failed";
static const char short_spc107[] = "**mpi_cart_get %C %d %p %p %p";
static const char long_spc107[]  = "MPI_Cart_get(%C, %d, %p, %p, %p) failed";
static const char short_spc108[] = "**mpi_cart_map %C %d %p %p %p";
static const char long_spc108[]  = "MPI_Cart_map(%C, %d, %p, %p) failed";
static const char short_spc109[] = "**mpi_cart_rank %C %p %p";
static const char long_spc109[]  = "MPI_Cart_rank(%C, %p, %p) failed";
static const char short_spc110[] = "**mpi_cart_shift %C %d %d %p %p";
static const char long_spc110[]  = "MPI_Cart_shift(%C, %d, %d, %p, %p) failed";
static const char short_spc111[] = "**mpi_cart_sub %C %p %p";
static const char long_spc111[]  = "MPI_Cart_sub(%C, %p, %p) failed";
static const char short_spc112[] = "**mpi_cartdim_get %C %p";
static const char long_spc112[]  = "MPI_Cartdim_get(%C, %p) failed";
...
static const char long_spc115[]  = "MPI_Comm_call_errhandler(%C, %d) failed";
static const char short_spc116[] = "**mpi_comm_compare %C %C %p";
static const char long_spc116[]  = "MPI_Comm_compare(%C, %C, %p) failed";
...
static const char long_spc118[]  = "MPI_Comm_create(%C, %G, %p) failed";
static const char short_spc119[] = "**mpi_comm_create_errhandler %p %p";
static const char long_spc119[]  = "MPI_Comm_create_errhandler(%p, %p) failed";
static const char short_spc120[] = "**mpi_comm_create_keyval %p %p %p %p";
static const char long_spc120[]  = "MPI_Comm_create_keyval(%p, %p, %p, %p) failed";
static const char short_spc121[] = "**mpi_comm_delete_attr %C %d";
static const char long_spc121[]  = "MPI_Comm_delete_attr(%C, %d) failed";
...
static const char long_spc123[]  = "MPI_Comm_dup(%C, %p) failed";
static const char short_spc124[] = "**mpi_comm_free %p";
static const char long_spc124[]  = "MPI_Comm_free(%p) failed";
static const char short_spc125[] = "**mpi_comm_free_keyval %p";
static const char long_spc125[]  = "MPI_Comm_free_keyval(%p) failed";
static const char short_spc126[] = "**mpi_comm_get_attr %C %d %p %p";
static const char long_spc126[]  = "MPI_Comm_get_attr(%C, %d, %p, %p) failed";
static const char short_spc127[] = "**mpi_comm_get_errhandler %C %p";
static const char long_spc127[]  = "MPI_Comm_get_errhandler(%C, %p) failed";
static const char short_spc128[] = "**mpi_comm_get_name %C %p %p";
static const char long_spc128[]  = "MPI_Comm_get_name(%C, %p, %p) failed";
...
static const char long_spc130[]  = "MPI_Comm_group(%C, %p) failed";
...
static const char long_spc132[]  = "MPI_Comm_rank(%C, %p) failed";
static const char short_spc133[] = "**mpi_comm_remote_group %C %p";
static const char long_spc133[]  = "MPI_Comm_remote_group(%C, %p) failed";
static const char short_spc134[] = "**mpi_comm_remote_size %C %p";
static const char long_spc134[]  = "MPI_Comm_remote_size(%C, %p) failed";
static const char short_spc135[] = "**mpi_comm_set_attr %C %d %p";
static const char long_spc135[]  = "MPI_Comm_set_attr(%C, %d, %p) failed";
...
static const char long_spc137[]  = "MPI_Comm_set_name(%C, %s) failed";
static const char short_spc138[] = "**mpi_comm_size %C %p";
static const char long_spc138[]  = "MPI_Comm_size(%C, %p) failed";
...
static const char long_spc141[]  = "MPI_Comm_split(%C, %d, %d, %p) failed";
static const char short_spc142[] = "**mpi_comm_test_inter %C %p";
static const char long_spc142[]  = "MPI_Comm_test_inter(%C, %p) failed";
static const char short_spc143[] = "**mpi_dims_create %d %d %p";
static const char long_spc143[]  = "MPI_Dims_create(%d, %d, %p) failed";
static const char short_spc144[] = "**mpi_errhandler_create %p %p";
static const char long_spc144[]  = "MPI_Errhandler_create(%p) failed";
static const char short_spc145[] = "**mpi_errhandler_free %p";
static const char long_spc145[]  = "MPI_Errhandler_free(%p) failed";
static const char short_spc146[] = "**mpi_errhandler_get %C %p";
static const char long_spc146[]  = "MPI_Errhandler_get(%C, %p) failed";
...
static const char long_spc148[]  = "MPI_Error_class(%d, %p) failed";
static const char short_spc149[] = "**mpi_error_string %d %s %p";
static const char long_spc149[]  = "MPI_Error_string(%d, %s, %p) failed";
...
static const char long_spc151[]  = "MPI_File_call_errhandler(%F, %d) failed";
static const char short_spc152[] = "**mpi_file_create_errhandler %p %p";
static const char long_spc152[]  = "MPI_File_create_errhandler(%p, %p) failed";
static const char short_spc153[] = "**mpi_file_get_errhandler %F %p";
static const char long_spc153[]  = "MPI_File_get_errhandler(%F, %p) failed";
...
static const char long_spc155[]  = "MPI_Finalized(%p) failed";
...
static const char long_spc159[]  = "MPI_Get(%p, %d, %D, %d, %d, %d, %D, %W) failed";
...
static const char long_spc161[]  = "MPI_Get_count(%p, %D, %p) failed";
static const char short_spc162[] = "**mpi_get_elements %p %D %p";
static const char long_spc162[]  = "MPI_Get_elements(%p, %D, %p) failed";
static const char short_spc163[] = "**mpi_get_processor_name %p %p";
static const char long_spc163[]  = "MPI_Get_processor_name(%p, %p) failed";
static const char short_spc164[] = "**mpi_get_version %p %p";
static const char long_spc164[]  = "MPI_Get_version(%p, %p) failed";
static const char short_spc165[] = "**mpi_graph_create %C %d %p %p %d %p";
static const char long_spc165[]  = "MPI_Graph_create(%C, %d, %p, %p, %d, %p) failed";
static const char short_spc166[] = "**mpi_graph_get %C %d %d %p %p";
static const char long_spc166[]  = "MPI_Graph_get(%C, %d, %d, %p, %p) failed";
static const char short_spc167[] = "**mpi_graph_map %C %d %p %p %p";
static const char long_spc167[]  = "MPI_Graph_map(%C, %d, %p, %p, %p) failed";
static const char short_spc168[] = "**mpi_graph_neighbors %C %d %d %p";
static const char long_spc168[]  = "MPI_Graph_neighbors(%C, %d, %d, %p) failed";
static const char short_spc169[] = "**mpi_graph_neighbors_count %C %d %p";
static const char long_spc169[]  = "MPI_Graph_neighbors_count(%C, %d, %p) failed";
static const char short_spc170[] = "**mpi_graphdims_get %C %p %p";
static const char long_spc170[]  = "MPI_Graphdims_get(%C, %p, %p) failed";
...
static const char long_spc172[]  = "MPI_Grequest_start(%p, %p, %p, %p, %p) failed";
static const char short_spc173[] = "**mpi_group_compare %G %G %p";
static const char long_spc173[]  = "MPI_Group_compare(%G, %G, %p) failed";
static const char short_spc174[] = "**mpi_group_difference %G %G %p";
static const char long_spc174[]  = "MPI_Group_difference(%G, %G, %p) failed";
static const char short_spc175[] = "**mpi_group_excl %G %d %p %p";
static const char long_spc175[]  = "MPI_Group_excl(%G, %d, %p, %p) failed";
static const char short_spc176[] = "**mpi_group_free %p";
static const char long_spc176[]  = "MPI_Group_free(%p) failed";
static const char short_spc177[] = "**mpi_group_incl %G %d %p %p";
static const char long_spc177[]  = "MPI_Group_incl(%G, %d, %p, %p) failed";
static const char short_spc178[] = "**mpi_group_intersection %G %G %p";
static const char long_spc178[]  = "MPI_Group_intersection(%G, %G, %p) failed";
static const char short_spc179[] = "**mpi_group_range_excl %G %d %p %p";
static const char long_spc179[]  = "MPI_Group_range_excl(%G, %d, %p, %p) failed";
static const char short_spc180[] = "**mpi_group_range_incl %G %d %p %p";
static const char long_spc180[]  = "MPI_Group_range_incl(%G, %d, %p, %p) failed";
static const char short_spc181[] = "**mpi_group_rank %G %p";
static const char long_spc181[]  = "MPI_Group_rank(%G, %p) failed";
static const char short_spc182[] = "**mpi_group_size %G %p";
static const char long_spc182[]  = "MPI_Group_size(%G, %p) failed";
static const char short_spc183[] = "**mpi_group_translate_ranks %G %d %p %G %p";
static const char long_spc183[]  = "MPI_Group_translate_ranks(%G, %d, %p, %G, %p) failed";
static const char short_spc184[] = "**mpi_group_union %G %G %p";
static const char long_spc184[]  = "MPI_Group_union(%G, %G, %p) failed";
...
static const char long_spc186[]  = "MPI_Info_create(%p) failed";
static const char short_spc187[] = "**mpi_info_delete %I %p";
static const char long_spc187[]  = "MPI_Info_delete(%I, %p) failed";
static const char short_spc188[] = "**mpi_info_dup %I %p";
static const char long_spc188[]  = "MPI_Info_dup(%I, %p) failed";
static const char short_spc189[] = "**mpi_info_free %p";
static const char long_spc189[]  = "MPI_Info_free(%p) failed";
static const char short_spc190[] = "**mpi_info_get %I %s %d %p %p";
static const char long_spc190[]  = "MPI_Info_get(%I, %s, %d, %p, %p) failed";
static const char short_spc191[] = "**mpi_info_get_nkeys %I %p";
static const char long_spc191[]  = "MPI_Info_get_nkeys(%I, %p) failed";
static const char short_spc192[] = "**mpi_info_get_nthkey %I %d %p";
static const char long_spc192[]  = "MPI_Info_get_nthkey(%I, %d, %p) failed";
static const char short_spc193[] = "**mpi_info_get_valuelen %I %s %p %p";
static const char long_spc193[]  = "MPI_Info_get_valuelen(%I, %s, %p, %p) failed";
static const char short_spc194[] = "**mpi_info_set %I %p %p";
static const char long_spc194[]  = "MPI_Info_set(%I, %p, %p) failed";
static const char short_spc195[] = "**mpi_init %p %p";
static const char long_spc195[]  = "MPI_Init(%p, %p) failed";
static const char short_spc196[] = "**mpi_init_thread %p %p %d %p";
static const char long_spc196[]  = "MPI_Init_thread(%p, %p, %d, %p)";
static const char short_spc197[] = "**mpi_initialized %p";
static const char long_spc197[]  = "MPI_Initialized(%p) failed";
static const char short_spc198[] = "**mpi_intercomm_create %C %d %C %d %d %p";
static const char long_spc198[]  = "MPI_Intercomm_create(%C, %d, %C, %d, %d, %p) failed";
static const char short_spc199[] = "**mpi_intercomm_merge %C %d %p";
static const char long_spc199[]  = "MPI_Intercomm_merge(%C, %d, %p) failed";
...
static const char long_spc203[]  = "MPI_Is_thread_main(%p) failed";
...
static const char long_spc207[]  = "MPI_Keyval_free(%p) failed";
...
static const char long_spc213[]  = "MPI_Pack_external(%s, %p, %d, %D, %p, %d, %p) failed";
static const char short_spc214[] = "**mpi_pack_external_size %p %d %D %p";
static const char long_spc214[]  = "MPI_Pack_external_size(%p, %d, %D, %p) failed";
...
static const char long_spc216[]  = "MPI_Pcontrol(%d) failed";
...
static const char long_spc219[]  = "MPI_Put(%p, %d, %D, %d, %d, %d, %D, %W) failed";
static const char short_spc220[] = "**mpi_query_thread %p";
static const char long_spc220[]  = "MPI_Query_thread(%p) failed";
...
static const char long_spc225[]  = "MPI_Register_Datarep(%s, %p, %p, %p, %p) failed";
...
static const char long_spc227[]  = "MPI_Request_get_status(%R, %p, %p) failed";
...
static const char long_spc241[]  = "MPI_Status_set_cancelled(%p, %d) failed";
static const char short_spc242[] = "**mpi_status_set_elements %p %D %d";
static const char long_spc242[]  = "MPI_Status_set_elements(%p, %D, %d) failed";
...
static const char long_spc248[]  = "MPI_Topo_test(%C, %p) failed";
static const char short_spc249[] = "**mpi_type_commit %p";
static const char long_spc249[]  = "MPI_Type_commit(%p) failed";
static const char short_spc250[] = "**mpi_type_contiguous %d %D %p";
static const char long_spc250[]  = "MPI_Type_contiguous(%d, %D, %p) failed";
static const char short_spc251[] = "**mpi_type_create_darray %d %d %d %p %p %p %p %d %D %p";
static const char long_spc251[]  = "MPI_Type_create_darray(%d, %d, %d, %p, %p, %p, %p, %d, %D, %p) failed";
static const char short_spc252[] = "**mpi_type_create_hindexed %d %p %p %D %p";
static const char long_spc252[]  = "MPI_Type_create_hindexed(%d, %p, %p, %D, %p) failed";
static const char short_spc253[] = "**mpi_type_create_hvector %d %d %d %D %p";
static const char long_spc253[]  = "MPI_Type_create_hvector(%d, %d, %d, %D, %p) failed";
static const char short_spc254[] = "**mpi_type_create_indexed_block %d %d %p %D %p";
static const char long_spc254[]  = "MPI_Type_create_indexed_block(%d, %d, %p, %D, %p) failed";
static const char short_spc255[] = "**mpi_type_create_keyval %p %p %p %p";
static const char long_spc255[]  = "MPI_Type_create_keyval(%p, %p, %p, %p) failed";
static const char short_spc256[] = "**mpi_type_create_resized %D %d %d %p";
static const char long_spc256[]  = "MPI_Type_create_resized(%D, %d, %d, %p) failed";
static const char short_spc257[] = "**mpi_type_create_struct %d %p %p %p %p";
static const char long_spc257[]  = "MPI_Type_create_struct(%d, %p, %p, %p, %p) failed";
static const char short_spc258[] = "**mpi_type_create_subarray %d %p %p %p %d %D %p";
static const char long_spc258[]  = "MPI_Type_create_subarray(%d, %p, %p, %p, %d, %D, %p) failed";
static const char short_spc259[] = "**mpi_type_delete_attr %D %d";
static const char long_spc259[]  = "MPI_Type_delete_atrr(%D, %d) failed";
static const char short_spc260[] = "**mpi_type_dup %D %p";
static const char long_spc260[]  = "MPI_Type_dup(%D, %p) failed";
static const char short_spc261[] = "**mpi_type_extent %D %p";
static const char long_spc261[]  = "MPI_Type_extent(%D, %p) failed";
static const char short_spc262[] = "**mpi_type_free %p";
static const char long_spc262[]  = "MPI_Type_free(%p) failed";
static const char short_spc263[] = "**mpi_type_free_keyval %p";
static const char long_spc263[]  = "MPI_Type_free_keyval(%p) failed";
static const char short_spc264[] = "**mpi_type_get_attr %D %d %p %p";
static const char long_spc264[]  = "MPI_Type_get_attr(%D, %d, %p, %p) failed";
static const char short_spc265[] = "**mpi_type_get_contents %D %d %d %d %p %p %p";
static const char long_spc265[]  = "MPI_Type_get_contents(%D, %d, %d, %d, %p, %p, %p) failed";
static const char short_spc266[] = "**mpi_type_get_envelope %D %p %p %p %p";
static const char long_spc266[]  = "MPI_Type_get_envelope(%D, %p, %p, %p, %p) failed";
static const char short_spc267[] = "**mpi_type_get_extent %D %p %p";
static const char long_spc267[]  = "MPI_Type_get_extent(%D, %p, %p) failed";
static const char short_spc268[] = "**mpi_type_get_name %D %p %p";
static const char long_spc268[]  = "MPI_Type_get_name(%D, %p, %p) failed";
static const char short_spc269[] = "**mpi_type_get_true_extent %D %p %p";
static const char long_spc269[]  = "MPI_Type_get_true_extent(%D, %p, %p) failed";
static const char short_spc270[] = "**mpi_type_hindexed %d %p %p %D %p";
static const char long_spc270[]  = "MPI_Type_hindexed(%d, %p, %p, %D, %p) failed";
static const char short_spc271[] = "**mpi_type_hvector %d %d %d %D %p";
static const char long_spc271[]  = "MPI_Type_hvector(%d, %d, %d, %D, %p) failed";
static const char short_spc272[] = "**mpi_type_indexed %d %p %p %D %p";
static const char long_spc272[]  = "MPI_Type_indexed(%d, %p, %p, %D, %p) failed";
static const char short_spc273[] = "**mpi_type_lb %D %p";
static const char long_spc273[]  = "MPI_Type_lb(%D, %p) failed";
static const char short_spc274[] = "**mpi_type_match_size %d %d %p";
static const char long_spc274[]  = "MPI_Type_match_size(%d, %d, %p) failed";
static const char short_spc275[] = "**mpi_type_set_attr %D %d %p";
static const char long_spc275[]  = "MPI_Type_set_attr(%D, %d, %p) failed";
static const char short_spc276[] = "**mpi_type_set_name %D %s";
static const char long_spc276[]  = "MPI_Type_set_name(%D, %s) failed";
...
static const char long_spc278[]  = "MPI_Type_struct(%d, %p, %p, %p, %p) failed";
static const char short_spc279[] = "**mpi_type_ub %D %p";
static const char long_spc279[]  = "MPI_Type_ub(%D, %p) failed";
static const char short_spc280[] = "**mpi_type_vector %d %d %d %D %p";
static const char long_spc280[]  = "MPI_Type_vector(%d, %d, %d, %D, %p) failed";
...
static const char long_spc282[]  = "MPI_Unpack_external(%s, %p, %d, %p, %p, %d, %D) failed";
...
static const char long_spc288[]  = "MPI_Win_call_errhandler(%W, %d) failed";
...
static const char long_spc290[]  = "MPI_Win_create(%p, %d, %d, %I, %C, %p) failed";
static const char short_spc291[] = "**mpi_win_create_errhandler %p %p";
static const char long_spc291[]  = "MPI_Win_create_errhandler(%p, %p) failed";
static const char short_spc292[] = "**mpi_win_create_keyval %p %p %p %p";
static const char long_spc292[]  = "MPI_Win_create_keyval(%p, %p, %p, %p) failed";
static const char short_spc293[] = "**mpi_win_delete_attr %W %d";
static const char long_spc293[]  = "MPI_Win_delete_attr(%W, %d) failed";
...
static const char long_spc295[]  = "MPI_Win_free(%p) failed";
static const char short_spc296[] = "**mpi_win_free_keyval %p";
static const char long_spc296[]  = "MPI_Win_free_keyval(%p) failed";
static const char short_spc297[] = "**mpi_win_get_attr %W %d %p %p";
static const char long_spc297[]  = "MPI_Win_get_attr(%W, %d, %p, %p) failed";
static const char short_spc298[] = "**mpi_win_get_errhandler %W %p";
static const char long_spc298[]  = "MPI_Win_get_errhandler(%W, %p) failed";
static const char short_spc299[] = "**mpi_win_get_group %W %p";
static const char long_spc299[]  = "MPI_Win_get_group(%W, %p) failed";
static const char short_spc300[] = "**mpi_win_get_name %W %p %p";
static const char long_spc300[]  = "MPI_Win_get_name(%W, %p, %p) failed";
static const char short_spc301[] = "**mpi_win_lock %d %d %d %W";
static const char long_spc301[]  = "MPI_Win_lock(%d, %d, %d, %W) failed";
static const char short_spc302[] = "**mpi_win_post %G %d %W";
static const char long_spc302[]  = "MPI_Win_post(%G, %d, %W) failed";
static const char short_spc303[] = "**mpi_win_set_attr %W %d %p";
static const char long_spc303[]  = "MPI_Win_set_attr(%W, %d, %p) failed";
...
static const char long_spc305[]  = "MPI_Win_set_name(%W, %s) failed";
...
static const char long_spc307[]  = "MPI_Win_test(%W, %p) failed";
static const char short_spc308[] = "**mpi_win_unlock %d %W";
static const char long_spc308[]  = "MPI_Win_unlock(%d, %W) failed";
...
static const char short_spc321[] = "**nomem %s %d";
static const char long_spc321[]  = "Out of memory (unable to allocate a '%s' of size %d)";
static const char short_spc322[] = "**nomem %s";
static const char long_spc322[]  = "Out of memory (unable to allocate a '%s')";
...
static const char short_spc393[] = "**sock|poll|badhandle %d %d %d %d";
static const char long_spc393[]  = "sock contains an invalid file descriptor (set=%d,sock=%d,fd=%d:%d)";
static const char short_spc394[] = "**sock|poll|badhandle %d %d %d";
static const char long_spc394[]  = "sock contains an invalid file descriptor (set=%d,sock=%d,fd=%d)";
...
static const char short_spc420[] = "**truncate %d %d %d %d";
static const char long_spc420[]  = "Message from rank %d and tag %d truncated; %d bytes received but buffer size is %d";
static const char short_spc421[] = "**truncate %d %d";
static const char long_spc421[]  = "Message truncated; %d bytes received but buffer size is %d";
...
648,43,112,125,649,103,554,570,168,508,
652,122,9,658,654,513,201,200,199,563,
142,143,149,111,119,147,148,141,178,179,
185,184,206,487,8,503,153,152,539,155,
156,573,642,120,154,661,28,240,234,566,
569,568,567,20};
#endif
