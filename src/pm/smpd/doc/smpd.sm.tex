...
State [reading delegate yes/no],[label="reading delegate yes/no"]
        Event [data read]
                if impersonate success
                        Change_State([writing impersonate success],[label="success"])
                else impersonate fail
                        Change_State([writing impersonate failure],[label="fail"])
State [writing impersonate success],[label="writing impersonate success"]
        Event [data written]
                Change_State([writing reconnect request])
State [writing impersonate failure],[label="writing impersonate failure"]
        Event [data written]
