...
{ 
    ...
    if (rank == 0) {
        ...
        blklens = (int *) malloc(nlevels * sizeof(int));
...
*/
        ...
        MPI_Type_indexed(nlevels, blklens, get_idx, MPI_INT, &get_type);
        MPI_Type_indexed(nlevels, blklens, acc_idx, MPI_INT, &acc_type);
