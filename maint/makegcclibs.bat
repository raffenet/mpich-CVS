...
dlltool --dllname mpich2fg.dll --def mpich2gccf.def --output-lib ..\lib\libmpich2fg.a
dlltool --dllname mpich2fgd.dll --def mpich2gccfd.def --output-lib ..\lib\libmpich2fgd.a
del mpich2gcc.def
del mpich2gccd.def
del mpich2gccf.def
del mpich2gccfd.def
